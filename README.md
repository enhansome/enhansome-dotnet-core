...
Inspired by [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,136 | 🐛 106 | 📅 2026-09-02, [awesome-dotnet](https://github.com/quozd/awesome-dotnet) ⭐ 21,588 | 🐛 147 | 📅 2026-03-26,  [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,733 | 🐛 25 | 📅 2026-09-02, [frontend-dev-bookmarks](https://github.com/dypsilon/frontend-dev-bookmarks) ⭐ 47,481 | 🐛 133 | 📅 2024-05-21.
...
* [.NET Core SDK](https://www.microsoft.com/net/core) - .NET Core SDK is a general purpose development platform maintained by Microsoft and the .NET community on [GitHub](https://github.com/dotnet/core) ⭐ 22,035 | 🐛 356 | 🌐 PowerShell | 📅 2026-09-08.
...
* [Clean Code .NET/.NET Core](https://github.com/thangchung/clean-code-dotnet) ⭐ 7,734 | 🐛 46 | 🌐 C# | 📅 2026-02-27 - Clean Code concepts adapted for .NET / .NET Core.
...
* [OpenAPI Generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,732 | 🐛 5,750 | 🌐 Java | 📅 2026-09-07 - OpenAPI Generator allows generation of API client libraries (e.g. C#, TypeScript, etc), server stubs (ASP.NET Core, NancyFx, etc), documentation and configuration automatically given an OpenAPI Spec (v2, v3).
* [Restsharp](https://github.com/restsharp/RestSharp) ⭐ 9,826 | 🐛 37 | 🌐 C# | 📅 2026-09-07 - Simple REST and HTTP API Client for .NET
* [NSwag](https://github.com/RSuter/NSwag) ⭐ 7,364 | 🐛 2,055 | 🌐 C# | 📅 2026-09-07 - The Swagger/OpenAPI toolchain for .NET, Web API and TypeScript. <http://NSwag.org>.
* [Swashbuckle](https://github.com/domaindrivendev/Swashbuckle.AspNetCore) ⭐ 5,499 | 🐛 177 | 🌐 C# | 📅 2026-09-08 - Seamlessly adds a swagger to WebApi projects.
...
* [Flurl](https://github.com/tmenier/Flurl) ⭐ 4,404 | 🐛 64 | 🌐 C# | 📅 2025-01-01 - Fluent URL builder and testable HTTP for .NET <https://flurl.dev>.
...
* [JSON API .NET Core](https://github.com/Research-Institute/json-api-dotnet-core) ⭐ 715 | 🐛 16 | 🌐 C# | 📅 2026-09-05 - Framework for building json:api compliant APIs with the goal of eliminating RESTful boilerplate.
...
* GraphQL
  ...
  * [graphql-dotnetcore](https://github.com/mkmarek/graphql-dotnetcore) ⚠️ Archived - GraphQL for .NET Core based on <https://github.com/graphql/graphql-js> ⭐ 20,345 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-08.
...
* [grpc](https://github.com/grpc/grpc/tree/master/src/csharp) ⭐ 45,306 | 🐛 1,354 | 🌐 C++ | 📅 2026-09-08 - Remote Procedure Calls (RPCs) provide a useful abstraction for building distributed applications and services. The libraries in this repository provide a concrete implementation of the gRPC protocol, layered over HTTP/2. These libraries enable communication between clients and servers using any combination of the supported languages.
* [ASP.NET MVC](https://github.com/dotnet/aspnetcore/tree/master/src/Mvc) ⭐ 38,432 | 🐛 4,140 | 🌐 C# | 📅 2026-09-08 - Model view controller framework for building dynamic web sites with clean separation of concerns, including the merged MVC, Web API, and Web Pages w/ Razor.
* [Abp vNext](https://github.com/abpframework/abp) ⭐ 14,424 | 🐛 312 | 🌐 C# | 📅 2026-09-08 - Abp vNext is the next generation of the open source [ASP.NET Boilerplate](https://github.com/aspnetboilerplate/aspnetboilerplate) ⭐ 12,001 | 🐛 64 | 🌐 C# | 📅 2026-08-20 framework. It's a complete architecture and strong infrastructure to create modern web applications!
...
* [orleans](https://github.com/dotnet/orleans) ⭐ 10,859 | 🐛 661 | 🌐 C# | 📅 2026-09-07 - Framework that provides a straight-forward approach to building distributed high-scale computing applications, without the need to learn and apply complex concurrency or other scaling patterns.
...
* [ServiceStack](https://github.com/ServiceStack/ServiceStack) ⭐ 5,496 | 🐛 35 | 🌐 C# | 📅 2026-09-08 - Thoughtfully architected, obscenely fast, thoroughly enjoyable web services for all <https://servicestack.net>.
* [akka.net](https://github.com/akkadotnet/akka.net) ⭐ 5,081 | 🐛 445 | 🌐 C# | 📅 2026-09-07 - Toolkit and runtime for building highly concurrent, distributed, and fault tolerant event-driven applications on .NET & Mono.
...
* [ExcelDataReader](https://github.com/ExcelDataReader/ExcelDataReader) ⭐ 4,416 | 🐛 34 | 🌐 C# | 📅 2026-08-30 - Lightweight and fast library written in C# for reading Microsoft Excel files.
...
* [Carter](https://github.com/CarterCommunity/Carter) ⭐ 2,450 | 🐛 5 | 🌐 C# | 📅 2026-07-04 - Carter is a library that allows Nancy-esque routing for use with ASP.Net Core.
...
* [Finbuckle.MultiTenant](https://github.com/Finbuckle/Finbuckle.MultiTenant) ⭐ 1,619 | 🐛 34 | 🌐 C# | 📅 2026-08-20 - Finbuckle.MultiTenant is a .NET Standard library for multitenant support designed for ASP.NET 2.0+. It provides functionality for tenant resolution, per-tenant app configuration, and per-tenant data isolation.
...
* [X.PagedList](https://github.com/dncuug/X.PagedList) ⭐ 927 | 🐛 0 | 🌐 C# | 📅 2026-09-06 - Library for easily paging through any IEnumerable/IQueryable in ASP.NET/ASP.NET Core.
...
* [dotvvm](https://github.com/riganti/dotvvm) ⭐ 805 | 🐛 165 | 🌐 C# | 📅 2026-09-07 - Open source MVVM framework for Web Apps.
...
* [Halibut](https://github.com/OctopusDeploy/Halibut) ⭐ 24 | 🐛 51 | 🌐 C# | 📅 2026-09-08 - A secure communication stack for .NET using JSON-RPC over SSL.
...
* [CleanArchitecture (SPA)](https://github.com/JasonGT/CleanArchitecture) ⭐ 20,531 | 🐛 20 | 🌐 C# | 📅 2026-09-07 - Solution template for creating a Single Page App (SPA) with Angular 8 and ASP.NET Core 3 following the principles of Clean Architecture
* [CleanArchitecture](https://github.com/ardalis/CleanArchitecture) ⭐ 18,460 | 🐛 41 | 🌐 C# | 📅 2026-08-23 - A starting point for Clean Architecture with ASP.NET Core. Clean Architecture is just the latest in a series of names for the same loosely-coupled, dependency-inverted architecture. You will also find it named hexagonal, ports-and-adapters, or onion architecture.
* [.NET Boxed](https://github.com/Dotnet-Boxed/Templates) ⭐ 3,484 | 🐛 51 | 🌐 C# | 📅 2026-09-07 - Project templates with batteries included, providing the minimum amount of code required to get you going. Includes ASP.NET Core API and GraphQL Templates.
* [JavaScriptServices](https://github.com/aspnet/JavaScriptServices) ⚠️ Archived - Microsoft ASP.NET Core JavaScript Services.
* [Serenity](https://github.com/volkanceylan/Serenity) ⭐ 2,692 | 🐛 1 | 🌐 C# | 📅 2026-09-08 - Serenity is an ASP.NET MVC / TypeScript application platform designed to simplify and shorten development of data-centric business applications with a service based architecture.
* [kendo-ui-core](https://github.com/telerik/kendo-ui-core) ⭐ 2,585 | 🐛 687 | 🌐 JavaScript | 📅 2026-09-03 - An HTML5, jQuery-based widget library for building modern web apps. <http://www.telerik.com/kendo-ui>.
...
* [BTCPayServer](https://github.com/btcpayserver/btcpayserver) ⭐ 7,749 | 🐛 82 | 🌐 C# | 📅 2026-09-07 - A cross platform, self-hosted server compatible with Bitpay API.
...
* [Nethermind](https://github.com/NethermindEth/nethermind) ⭐ 1,592 | 🐛 388 | 🌐 C# | 📅 2026-09-08 - .NET Core Ethereum client
...
* [BotSharp](https://github.com/SciSharp/BotSharp) ⭐ 3,101 | 🐛 48 | 🌐 C# | 📅 2026-09-05 - The Open Source AI Chatbot Platform Builder in 100% C# Running in .NET Core with Machine Learning algorithm.
...
* [msbuild](https://github.com/Microsoft/msbuild) ⭐ 5,548 | 🐛 1,700 | 🌐 C# | 📅 2026-09-08 - The Microsoft Build Engine is a platform for building applications.
* [dotnet-docker](https://github.com/dotnet/dotnet-docker) ⭐ 4,873 | 🐛 131 | 🌐 Dockerfile | 📅 2026-09-04 - The base Docker images for working with .NET Core and the .NET Core Tools.
* [Opserver](https://github.com/opserver/Opserver) ⭐ 4,564 | 🐛 76 | 🌐 C# | 📅 2024-11-30 - Stack Exchange's Monitoring System.
* [cake-build](https://github.com/cake-build/cake) ⭐ 4,188 | 🐛 248 | 🌐 C# | 📅 2026-07-17 - Cross platform build automation system.
* [Nuke](https://github.com/nuke-build/nuke) ⭐ 3,751 | 🐛 121 | 🌐 C# | 📅 2025-12-02 - Cross-platform build automation system.
* [vsts-agent](https://github.com/Microsoft/vsts-agent/blob/master/README.md) ⭐ 1,914 | 🐛 227 | 🌐 C# | 📅 2026-09-08 - Visual Studio Team Services Build and Release Agent.
* [GitVersioning](https://github.com/AArnott/Nerdbank.GitVersioning) ⭐ 1,585 | 🐛 15 | 🌐 C# | 📅 2026-09-07 - Stamp your assemblies and NuGet packages with a version from a single, simple version.txt file and include git commit IDs for non-official builds.
...
* [Stack Exchange Redis](https://github.com/StackExchange/StackExchange.Redis) ⭐ 6,197 | 🐛 220 | 🌐 C# | 📅 2026-09-08 - High performance general purpose redis client for .NET languages (C# etc).
...
* [Foundatio](https://github.com/exceptionless/Foundatio) ⭐ 2,098 | 🐛 13 | 🌐 C# | 📅 2026-09-08 - Pluggable foundation blocks for building distributed apps.
...
* [Orchard Core CMS](https://github.com/OrchardCMS/OrchardCore) ⭐ 8,175 | 🐛 851 | 🌐 C# | 📅 2026-09-08 - Open Source Content Management System built with ASP.NET Core on top of a Modular and Extensible Application Framework.
* [Umbraco](https://github.com/umbraco/umbraco-cms) ⭐ 5,243 | 🐛 513 | 🌐 C# | 📅 2026-09-08 - An extensible and friendly Open source ASP.NET Core CMS
...
* [Blogifier.Core](https://github.com/blogifierdotnet/Blogifier.Core) ⭐ 1,296 | 🐛 29 | 🌐 C# | 📅 2026-03-16 - ASP.NET applications to provide common blogging functionality.
...
* [awesome-static-analysis](https://github.com/mre/awesome-static-analysis) ⭐ 14,769 | 🐛 12 | 🌐 Rust | 📅 2026-09-08 - Curated list of static analysis tools, linters and code quality checkers for various programming languages.
* Code Analysis
...
* Metrics
  ...
  * [coverlet](https://github.com/tonerdo/coverlet) ⭐ 3,173 | 🐛 19 | 🌐 C# | 📅 2026-09-01 - Cross platform code coverage library for .NET Core.
  * [Audit.NET](https://github.com/thepirat000/Audit.NET) ⭐ 2,648 | 🐛 0 | 🌐 C# | 📅 2026-08-19 - Small framework to audit .NET object changes.
  ...
  * [Foundatio](https://github.com/exceptionless/Foundatio#metrics) ⭐ 2,098 | 🐛 13 | 🌐 C# | 📅 2026-09-08 - A common interface with in memory, redis, StatsD, and Metrics.NET implementations.
  ...
  * [Prometheus.Client](https://github.com/PrometheusClientNet/Prometheus.Client) ⭐ 142 | 🐛 1 | 🌐 C# | 📅 2026-08-22 - .NET Client for [Prometheus](https://prometheus.io).
    * [Prometheus.Client.MetricPusher](https://github.com/PrometheusClientNet/Prometheus.Client.MetricPusher) ⭐ 19 | 🐛 1 | 🌐 C# | 📅 2026-09-06 -  Push metrics to a PushGateaway for the Prometheus.Client.
    * [Prometheus.Client.MetricServer](https://github.com/PrometheusClientNet/Prometheus.Client.MetricServer) ⭐ 16 | 🐛 1 | 🌐 C# | 📅 2026-08-22 -  MetricServer for the Prometheus.Client.
    * [Prometheus.Client.HttpRequestDurations](https://github.com/PrometheusClientNet/Prometheus.Client.HttpRequestDurations) ⭐ 11 | 🐛 1 | 🌐 C# | 📅 2026-08-22 -  Metrics logging of request durations for the Prometheus.Client.
    * [Prometheus.Client.AspNetCore](https://github.com/PrometheusClientNet/Prometheus.Client.AspNetCore) ⭐ 10 | 🐛 1 | 🌐 C# | 📅 2026-08-22 -  Middleware for the Prometheus.Client.
...
* [roslyn](https://github.com/dotnet/roslyn) ⭐ 20,649 | 🐛 6,305 | 🌐 C# | 📅 2026-09-08 - The .NET Compiler Platform ("Roslyn") provides open-source C# and Visual Basic compilers with rich code analysis APIs.
* [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,151 | 🐛 159 | 🌐 F# | 📅 2026-09-08 - F# to JavaScript Compiler.
...
* [fparsec](https://github.com/stephan-tolksdorf/fparsec) ⭐ 560 | 🐛 30 | 🌐 F# | 📅 2023-11-13 - A parser combinatory library for F# and C#.
...
* [marten](https://github.com/JasperFx/marten) ⭐ 3,452 | 🐛 5 | 🌐 C# | 📅 2026-09-06 - Postgresql as a Document Database and Event Store for .NET Applications <http://jasperfx.github.io/marten>.
...
* [npgsql](https://github.com/npgsql/npgsql) ⭐ 3,725 | 🐛 224 | 🌐 C# | 📅 2026-08-28 - .NET data provider for PostgreSQL. It allows any program developed for .NET framework to access a PostgreSQL database server. It is implemented in 100% C# code. PostgreSQL versions since 9.1 are officially supported, others may work. <http://www.npgsql.org>
* [MongoDB.Driver](https://github.com/mongodb/mongo-csharp-driver) ⭐ 3,242 | 🐛 16 | 🌐 C# | 📅 2026-09-02 - .NET Driver for MongoDB.
* [cassandra-csharp-driver](https://github.com/datastax/csharp-driver) ⭐ 671 | 🐛 14 | 🌐 C# | 📅 2026-08-26 - DataStax C# Driver for Apache Cassandra.
...
* [couchbase-lite-net](https://github.com/couchbase/couchbase-lite-net) ⭐ 446 | 🐛 1 | 🌐 C# | 📅 2026-09-08 - A lightweight, document-oriented (NoSQL), syncable database engine for .NET.
...
* [ravendb](https://github.com/ayende/ravendb/tree/v4.0) ⭐ 296 | 🐛 22 | 🌐 C# | 📅 2026-09-08 - Linq enabled document database for .NET.
* [confluent-kafka-dotnet](https://github.com/confluentinc/confluent-kafka-dotnet) ⭐ 273 | 🐛 476 | 🌐 C# | 📅 2026-09-08 - Confluent's Apache Kafka .NET client.
...
* MySQL
  * [MySqlConnector](https://github.com/mysql-net/MySqlConnector) ⭐ 1,502 | 🐛 98 | 🌐 C# | 📅 2026-09-07 - Async MySQL Connector for .NET and .NET Core.
...
* [Polly](https://github.com/App-vNext/Polly) ⭐ 14,237 | 🐛 4 | 🌐 C# | 📅 2026-09-08 - .NET 3.5 / 4.0 / 4.5 / PCL library that allows developers to express transient exception and fault handling policies such as Retry, Retry Forever, Wait and Retry or Circuit Breaker in a fluent manner
...
* [nopCommerce](https://github.com/nopSolutions/nopCommerce) ⭐ 10,142 | 🐛 166 | 🌐 C# | 📅 2026-09-07 - Free open-source ecommerce shopping cart (ASP.NET MVC / ASP.NET Core MVC ) with a vast community and a market place full of new features, themes and plugins.
...
* [GrandNode](https://github.com/grandnode/grandnode) ⚠️ Archived - Multi-platform, free, open source ecommerce shopping cart based on ASP.NET Core 2.1 and MongoDB derived from [nopCommerce](https://github.com/nopSolutions/nopCommerce) ⭐ 10,142 | 🐛 166 | 🌐 C# | 📅 2026-09-07.
...
* [Sentry](https://github.com/getsentry/sentry-dotnet) ⭐ 770 | 🐛 317 | 🌐 C# | 📅 2026-09-08 - .NET SDK for Sentry, an Open-source error tracking that helps developers monitor and fix crashes in real time.
...
* [ReactiveUI](https://github.com/reactiveui/ReactiveUI) ⭐ 8,536 | 🐛 4 | 🌐 C# | 📅 2026-09-05 - A MVVM framework that integrates with the Reactive Extensions for .NET to create elegant, testable User Interfaces that run on any mobile or desktop platform.
...
* [DynamicData](https://github.com/RolandPheasant/DynamicData) ⭐ 1,901 | 🐛 56 | 🌐 C# | 📅 2026-09-06 - Reactive collections based on Rx.NET.
...
* [ImageSharp](https://github.com/SixLabors/ImageSharp) ⭐ 8,034 | 🐛 21 | 🌐 C# | 📅 2026-09-05 - Cross-platform library for processing of image files written in C#.
* [QRCoder](https://github.com/codebude/QRCoder) ⭐ 5,158 | 🐛 29 | 🌐 C# | 📅 2026-08-23 - A pure C# Open Source QR Code implementation.
* [Magick.NET](https://github.com/dlemstra/Magick.NET) ⭐ 3,976 | 🐛 47 | 🌐 C# | 📅 2026-09-05 - The .NET library for ImageMagick.
...
* [LibVLCSharp](https://github.com/videolan/libvlcsharp) ⭐ 1,809 | 🐛 5 | 🌐 C# | 📅 2026-08-31: .NET/Mono bindings for libvlc, the multimedia framework powering the VLC applications made by VideoLAN.
...
* [Avalonia](https://github.com/AvaloniaUI/Avalonia) ⭐ 31,460 | 🐛 1,889 | 🌐 C# | 📅 2026-09-08 - A multi-platform .NET UI framework (formerly known as Perspex).
...
* [AvaloniaEdit](https://github.com/AvaloniaUI/AvaloniaEdit/) ⭐ 1,129 | 🐛 91 | 🌐 C# | 📅 2026-08-28 - The Avalonia-based text editor component forked from [AvalonEdit](https://github.com/icsharpcode/AvalonEdit) ⭐ 2,079 | 🐛 117 | 🌐 C# | 📅 2025-12-04
...
* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 191,485 | 🐛 20,684 | 🌐 TypeScript | 📅 2026-09-08 - New type of tool that combines the simplicity of a code editor with what developers need for their core edit-build-debug cycle. Code provides comprehensive editing and debugging support, an extensibility model, and lightweight integration with existing tools.
...
* [Lamar](https://github.com/JasperFx/lamar) ⭐ 607 | 🐛 35 | 🌐 C# | 📅 2026-05-29 - Fast Inversion of Control Tool and Sundry Items of Roslyn Chicanery.
...
* [serilog](https://github.com/serilog/serilog) ⭐ 8,036 | 🐛 19 | 🌐 C# | 📅 2026-07-31 - Simple .NET logging with fully-structured events.
  ...
  * [Serilog.Exceptions](https://github.com/RehanSaeed/Serilog.Exceptions) ⭐ 537 | 🐛 32 | 🌐 C# | 📅 2026-08-30 - Serilog.Exceptions is an add-on to [Serilog](https://serilog.net/) to log exception details and custom properties that are not output in Exception.ToString().
...
* [NLog](https://github.com/NLog/NLog) ⭐ 6,545 | 🐛 50 | 🌐 C# | 📅 2026-09-06 - Advanced .NET, Silverlight and Xamarin Logging with support for structured and non structured logging.
  ...
  * [NLog for ASP.NET and ASP.NET Core](https://github.com/NLog/NLog.Web) ⭐ 328 | 🐛 8 | 🌐 C# | 📅 2026-09-06 - NLog integration for ASP.NET & ASP.NET Core 1-3
...
* [Foundatio](https://github.com/exceptionless/Foundatio#logging) ⭐ 2,098 | 🐛 13 | 🌐 C# | 📅 2026-09-08 - A fluent logging api that can be used to log messages throughout your application.
...
* [WaveFunctionCollapse](https://github.com/mxgmn/WaveFunctionCollapse) ⭐ 25,311 | 🐛 9 | 🌐 C# | 📅 2026-03-22 - itmap & tilemap generation from a single example with the help of ideas from quantum mechanics.
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,358 | 🐛 783 | 🌐 C# | 📅 2026-09-08 - Cross-platform open-source machine learning framework which makes machine learning accessible to .NET developers <http://dot.net/ml>.
...
* [MailKit](https://github.com/jstedfast/MailKit) ⭐ 6,857 | 🐛 9 | 🌐 C# | 📅 2026-08-19 - Cross-platform .NET library for IMAP, POP3, and SMTP.
...
* [SmtpServer](https://github.com/cosullivan/SmtpServer) ⭐ 819 | 🐛 37 | 🌐 C# | 📅 2026-04-18 - Library to create your own SMTP server.
...
* [Humanizer](https://github.com/Humanizr/Humanizer) ⭐ 9,867 | 🐛 15 | 🌐 C# | 📅 2026-09-04 - Humanizer meets all your .NET needs for manipulating and displaying strings, enums, dates, times, timespans, numbers and quantities.
* [AngleSharp](https://github.com/AngleSharp/AngleSharp) ⭐ 5,530 | 🐛 6 | 🌐 C# | 📅 2026-09-05 - The ultimate angle brackets parser library. It parses HTML5, MathML, SVG and CSS to construct a DOM based on the official W3C specification. Comparable to beautifulsoup4 of python.
* [markdig](https://github.com/lunet-io/markdig) ⭐ 5,321 | 🐛 119 | 🌐 C# | 📅 2026-08-18 - Fast, powerfull, CommonMark compliant, extensible Markdown processor for .NET.
...
* [Dotnet outdated](https://github.com/dotnet-outdated/dotnet-outdated) ⭐ 1,694 | 🐛 122 | 🌐 C# | 📅 2026-08-17 - A .NET Core global tool to display and update outdated NuGet packages in a project
...
* [FastExpressionCompiler](https://github.com/dadhi/FastExpressionCompiler) ⭐ 1,374 | 🐛 24 | 🌐 C# | 📅 2026-08-19 - Fast ExpressionTree compiler to delegate.
* [Otp.NET](https://github.com/kspearrin/Otp.NET) ⭐ 1,320 | 🐛 20 | 🌐 C# | 📅 2025-12-01 - An implementation TOTP RFC 6238 and HOTP RFC 4226 in C#.
...
* [PdfReport.Core](https://github.com/VahidN/PdfReport.Core) ⭐ 372 | 🐛 7 | 🌐 C# | 📅 2026-09-03 - PdfReport.Core is a code first reporting engine, which is built on top of the iTextSharp.LGPLv2.Core and EPPlus.Core libraries.
...
* Validation
  * [FluentValidation](https://github.com/JeremySkinner/FluentValidation) ⭐ 9,752 | 🐛 4 | 🌐 C# | 📅 2026-08-12 - Small validation library for .NET that uses a fluent interface and lambda expressions for building validation rules.
...
* [EPPlus](https://github.com/EPPlusSoftware/EPPlus) ⭐ 2,035 | 🐛 95 | 🌐 C# | 📅 2026-09-08 - Create advanced Excel spreadsheets using .NET.
...
* [Dapper](https://github.com/StackExchange/Dapper) ⭐ 18,381 | 🐛 547 | 🌐 C# | 📅 2026-08-20 - Simple object mapper for .NET.
  ...
  * [Dapper-FluentMap](https://github.com/henkmollema/Dapper-FluentMap) ⭐ 443 | 🐛 0 | 🌐 C# | 📅 2026-09-08 - Provides a simple API to fluently map POCO properties to database columns when using Dapper.
* [Entity Framework Core](https://github.com/aspnet/EntityFramework) ⭐ 14,788 | 🐛 2,381 | 🌐 C# | 📅 2026-09-08 - Familiar developer experience to previous versions of EF, including LINQ, POCO, and Code First support.
  ...
  * [EntityFramework-Plus](https://github.com/zzzprojects/EntityFramework-Plus) ⭐ 2,341 | 🐛 138 | 🌐 C# | 📅 2026-08-31 - Entity Framework Utilities | Bulk Operations | Batch Delete | Batch Update | Query Cache | Query Filter | Query Future | Query Include | Audit.
  * [Npgsql.EntityFrameworkCore.PostgreSQL](https://github.com/npgsql/Npgsql.EntityFrameworkCore.PostgreSQL) ⭐ 1,837 | 🐛 296 | 🌐 C# | 📅 2026-09-08 - Entity Framework Core provider for PostgreSQL.
...
* [nhibernate-core](https://github.com/nhibernate/nhibernate-core) ⭐ 2,174 | 🐛 665 | 🌐 C# | 📅 2026-09-07 - NHibernate Object Relational Mapper.
...
* [EventStore](https://github.com/EventStore/EventStore) ⭐ 5,848 | 🐛 151 | 🌐 C# | 📅 2026-09-08 - The open-source, functional database with Complex Event Processing in JavaScript.
...
* [NServiceBus](https://github.com/particular/nservicebus) ⭐ 2,169 | 🐛 288 | 🌐 C# | 📅 2026-09-08 - NServiceBus is part of the [Particular Service Platform](https://particular.net/service-platform), which contains tools to build, monitor, and debug distributed systems.
* [Foundatio](https://github.com/exceptionless/Foundatio#queues) ⭐ 2,098 | 🐛 13 | 🌐 C# | 📅 2026-09-08 - A common interface with in memory, redis and azure implementations.
...
* [OpenCQRS](https://github.com/OpenCQRS/OpenCQRS) ⭐ 28 | 🐛 14 | 🌐 C# | 📅 2026-09-08 - .NET Core library for DDD, CQRS and Event Sourcing with Azure Service Bus integration. Supported database providers for the Command and the Event stores are: DocumentDB, MongoDB, SQL Server, MySQL, PostgreSQL and SQLite.
...
* [quartznet](https://github.com/quartznet/quartznet/) ⭐ 7,076 | 🐛 12 | 🌐 C# | 📅 2026-09-07 - Quartz Enterprise Scheduler .NET <http://www.quartz-scheduler.net>.
* [stateless](https://github.com/dotnet-state-machine/stateless) ⭐ 6,256 | 🐛 81 | 🌐 C# | 📅 2026-04-04 - Simple library for creating state machines in C# code.
...
* [octokit.net](https://github.com/octokit/octokit.net) ⭐ 2,858 | 🐛 40 | 🌐 C# | 📅 2026-08-17 - GitHub API client library for .NET.
...
* [google-cloud-dotnet](https://github.com/GoogleCloudPlatform/google-cloud-dotnet) ⭐ 1,094 | 🐛 21 | 🌐 C# | 📅 2026-09-07 - Google Cloud Client Libraries for .NET.
...
* [AWS SDK](https://github.com/aws/aws-sdk-net) ⭐ 139 | 🐛 32 | 🌐 C# | 📅 2026-09-04 - The Amazon Web Services (AWS) .NET Core SDK components. Each AWS service has its own NuGet package.
...
* Blockchain clients
  * [Binance.Net](https://github.com/JKorf/Binance.Net) ⭐ 1,172 | 🐛 12 | 🌐 C# | 📅 2026-09-04 - .Net API wrapper for the Binance web API.
...
* [OwaspHeaders](https://github.com/GaProgMan/OwaspHeaders.Core) ⭐ 314 | 🐛 19 | 🌐 C# | 📅 2026-09-07 - .NET Core middleware for injecting the Owasp recommended HTTP Headers for increased security.
...
* [Elasticsearch.Net & NEST](https://github.com/elastic/elasticsearch-net) ⭐ 3,647 | 🐛 74 | 🌐 C# | 📅 2026-09-08 - Repository for both NEST and Elasticsearch.NET, the two official elasticsearch .NET clients.
...
* [Schema.NET](https://github.com/RehanSaeed/Schema.NET) ⭐ 688 | 🐛 67 | 🌐 C# | 📅 2026-09-03 - Schema.org objects turned into strongly typed C# POCO classes for use in .NET. All classes can be serialized into JSON/JSON-LD and XML, typically used to represent structured data in the head section of html page.
...
* [fluid](https://github.com/sebastienros/fluid) ⭐ 1,776 | 🐛 31 | 🌐 C# | 📅 2026-09-07 - Open-source .NET template engine that is as close as possible to the Liquid template language.
...
* [shouldly](https://github.com/shouldly/shouldly) ⭐ 3,410 | 🐛 94 | 🌐 C# | 📅 2026-09-07 - Should testing for .NET - the way Asserting *Should* be! <http://shouldly.readthedocs.org/en/latest>
...
* [Atata](https://github.com/atata-framework/atata) ⭐ 502 | 🐛 10 | 🌐 C# | 📅 2026-09-07 - Web UI test automation full-featured framework based on Selenium WebDriver. <https://atata.io>
...
* [ShareX](https://github.com/ShareX/ShareX) ⭐ 39,492 | 🐛 648 | 🌐 C# | 📅 2026-09-08 - Free and open source program that lets you capture or record any area of your screen and share it with a single press of a key. It also allows uploading images, text or other types of files to over 80 supported destinations you can choose from. <https://getsharex.com>

* [scoop](https://github.com/lukesampson/scoop) ⭐ 24,641 | 🐛 539 | 🌐 PowerShell | 📅 2026-09-08 - A command-line installer for Windows.

* [mRemoteNG](https://github.com/mRemoteNG/mRemoteNG) ⭐ 11,087 | 🐛 861 | 🌐 C# | 📅 2026-09-05 - The next generation of mRemote, open source, tabbed, multi-protocol, remote connections manager

* [gitignore.io](https://github.com/joeblau/gitignore.io) ⭐ 8,745 | 🐛 68 | 🌐 Swift | 📅 2024-12-23 - Create useful .gitignore files for your project <https://www.gitignore.io>.
...
* [docfx](https://github.com/dotnet/docfx) ⭐ 4,450 | 🐛 452 | 🌐 C# | 📅 2026-09-08 - Tools for building and publishing API documentation for .NET projects <http://dotnet.github.io/docfx>

* [SharpZipLib](https://github.com/icsharpcode/SharpZipLib) ⭐ 3,931 | 🐛 118 | 🌐 C# | 📅 2024-09-03 - #ziplib is a Zip, GZip, Tar and BZip2 library written entirely in C# for the .NET platform.

* [System.CommandLine](https://github.com/dotnet/command-line-api) ⭐ 3,673 | 🐛 483 | 🌐 C# | 📅 2026-09-08 - System.CommandLine, a set of libraries for command line parsing, invocation, and rendering of terminal output.
...
* [sourcelink](https://github.com/dotnet/sourcelink) ⭐ 1,350 | 🐛 146 | 🌐 C# | 📅 2026-09-08 - SourceLink is a language- and source-control agnostic system for providing first-class source debugging experiences for binaries.
...
* [redux.NET](https://github.com/GuillaumeSalles/redux.NET) ⭐ 708 | 🐛 29 | 🌐 C# | 📅 2021-07-28 - Predictable state container for .NET apps. Inspired by <https://github.com/reactjs/redux> ⭐ 61,502 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-07.
* WebAssembly
...
* [workflow-core](https://github.com/danielgerlag/workflow-core) ⭐ 5,921 | 🐛 140 | 🌐 C# | 📅 2026-09-08 - Lightweight workflow engine for .NET Standard.
...
* [bitwarden-core](https://github.com/bitwarden/core) ⭐ 20,095 | 🐛 225 | 🌐 C# | 📅 2026-09-08 - The core infrastructure backend (API, database, etc) <https://bitwarden.com>.
...
* Microservices & Service Mesh
  * [eShop](https://github.com/dotnet/eShop) ⭐ 10,845 | 🐛 124 | 🌐 C# | 📅 2026-08-31 - A reference .NET application implementing an eCommerce site.
...
* Monoliths
  * [MusicStore](https://github.com/dotnet/aspnetcore/tree/master/src/MusicStore) ⭐ 38,432 | 🐛 4,140 | 🌐 C# | 📅 2026-09-08 - Sample MusicStore application that uses MVC and Entity Framework.
...
* [awesome-copilot](https://github.com/github/awesome-copilot) ⭐ 38,766 | 🐛 34 | 🌐 JavaScript | 📅 2026-09-08
* Stack Overflow
