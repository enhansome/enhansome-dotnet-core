...
Inspired by [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,430 | 🐛 106 | 📅 2026-09-02, [awesome-dotnet](https://github.com/quozd/awesome-dotnet) ⭐ 21,591 | 🐛 148 | 📅 2026-03-26,  [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,747 | 🐛 25 | 📅 2026-09-02, [frontend-dev-bookmarks](https://github.com/dypsilon/frontend-dev-bookmarks) ⭐ 47,489 | 🐛 133 | 📅 2024-05-21.

Contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/thangchung/awesome-dotnet-core/blob/master/contributing.md) ⭐ 21,373 | 🐛 213 | 🌐 C# | 📅 2026-02-27 pages first. We accept proprietary and commercial software too.

Thanks to all [contributors](https://github.com/thangchung/awesome-dotnet-core/graphs/contributors) ⭐ 21,373 | 🐛 213 | 🌐 C# | 📅 2026-02-27, you're awesome and wouldn't be possible without you! The goal is to build a categorized community-driven collection of very well-known resources.
...
* [.NET Core SDK](https://www.microsoft.com/net/core) - .NET Core SDK is a general purpose development platform maintained by Microsoft and the .NET community on [GitHub](https://github.com/dotnet/core) ⭐ 22,034 | 🐛 355 | 🌐 PowerShell | 📅 2026-09-09.
...
* [OpenAPI Generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,734 | 🐛 5,755 | 🌐 Java | 📅 2026-09-09 - OpenAPI Generator allows generation of API client libraries (e.g. C#, TypeScript, etc), server stubs (ASP.NET Core, NancyFx, etc), documentation and configuration automatically given an OpenAPI Spec (v2, v3).
* [Restsharp](https://github.com/restsharp/RestSharp) ⭐ 9,826 | 🐛 37 | 🌐 C# | 📅 2026-09-07 - Simple REST and HTTP API Client for .NET
* [NSwag](https://github.com/RSuter/NSwag) ⭐ 7,363 | 🐛 2,055 | 🌐 C# | 📅 2026-09-07 - The Swagger/OpenAPI toolchain for .NET, Web API and TypeScript. <http://NSwag.org>.
* [Swashbuckle](https://github.com/domaindrivendev/Swashbuckle.AspNetCore) ⭐ 5,499 | 🐛 177 | 🌐 C# | 📅 2026-09-09 - Seamlessly adds a swagger to WebApi projects.
...
* [autorest](https://github.com/Azure/autorest) ⭐ 4,799 | 🐛 24 | 🌐 TypeSpec | 📅 2026-08-31 - Swagger (OpenAPI) Specification code generator featuring C# and Razor templates. Supports C#, Java, Node.js, TypeScript, Python and Ruby. `4.5.x or above`
...
* [JSON API .NET Core](https://github.com/Research-Institute/json-api-dotnet-core) ⭐ 716 | 🐛 16 | 🌐 C# | 📅 2026-09-09 - Framework for building json:api compliant APIs with the goal of eliminating RESTful boilerplate.
...
* GraphQL
  ...
  * [graphql-dotnetcore](https://github.com/mkmarek/graphql-dotnetcore) ⚠️ Archived - GraphQL for .NET Core based on <https://github.com/graphql/graphql-js> ⭐ 20,341 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-08.
...
* [grpc](https://github.com/grpc/grpc/tree/master/src/csharp) ⭐ 45,303 | 🐛 1,351 | 🌐 C++ | 📅 2026-09-09 - Remote Procedure Calls (RPCs) provide a useful abstraction for building distributed applications and services. The libraries in this repository provide a concrete implementation of the gRPC protocol, layered over HTTP/2. These libraries enable communication between clients and servers using any combination of the supported languages.
* [ASP.NET MVC](https://github.com/dotnet/aspnetcore/tree/master/src/Mvc) ⭐ 38,431 | 🐛 4,176 | 🌐 C# | 📅 2026-09-09 - Model view controller framework for building dynamic web sites with clean separation of concerns, including the merged MVC, Web API, and Web Pages w/ Razor.
* [Abp vNext](https://github.com/abpframework/abp) ⭐ 14,426 | 🐛 313 | 🌐 C# | 📅 2026-09-09 - Abp vNext is the next generation of the open source [ASP.NET Boilerplate](https://github.com/aspnetboilerplate/aspnetboilerplate) ⭐ 12,001 | 🐛 64 | 🌐 C# | 📅 2026-08-20 framework. It's a complete architecture and strong infrastructure to create modern web applications!
...
* [orleans](https://github.com/dotnet/orleans) ⭐ 10,861 | 🐛 648 | 🌐 C# | 📅 2026-09-09 - Framework that provides a straight-forward approach to building distributed high-scale computing applications, without the need to learn and apply complex concurrency or other scaling patterns.
...
* [ElectronNET](https://github.com/ElectronNET/Electron.NET) ⭐ 7,596 | 🐛 9 | 🌐 C# | 📅 2026-09-07 - Build cross platform desktop apps with ASP.NET NET Core.
...
* [opencvsharp](https://github.com/shimat/opencvsharp) ⭐ 6,092 | 🐛 6 | 🌐 C# | 📅 2026-09-07 - .NET Framework wrapper for OpenCV.
* [ServiceStack](https://github.com/ServiceStack/ServiceStack) ⭐ 5,496 | 🐛 35 | 🌐 C# | 📅 2026-09-09 - Thoughtfully architected, obscenely fast, thoroughly enjoyable web services for all <https://servicestack.net>.
* [akka.net](https://github.com/akkadotnet/akka.net) ⭐ 5,082 | 🐛 456 | 🌐 C# | 📅 2026-09-09 - Toolkit and runtime for building highly concurrent, distributed, and fault tolerant event-driven applications on .NET & Mono.
...
* [DotnetSpider](https://github.com/dotnetcore/DotnetSpider) ⭐ 4,137 | 🐛 6 | 🌐 C# | 📅 2026-04-03 - DotnetSpider, a .NET Standard web crawling library similar to WebMagic and Scrapy. It is a lightweight ,efficient and fast high-level web crawling & scraping framework for .NET.
...
* [Carter](https://github.com/CarterCommunity/Carter) ⭐ 2,453 | 🐛 5 | 🌐 C# | 📅 2026-07-04 - Carter is a library that allows Nancy-esque routing for use with ASP.Net Core.
...
* [Finbuckle.MultiTenant](https://github.com/Finbuckle/Finbuckle.MultiTenant) ⭐ 1,619 | 🐛 37 | 🌐 C# | 📅 2026-09-08 - Finbuckle.MultiTenant is a .NET Standard library for multitenant support designed for ASP.NET 2.0+. It provides functionality for tenant resolution, per-tenant app configuration, and per-tenant data isolation.
...
* [dotvvm](https://github.com/riganti/dotvvm) ⭐ 806 | 🐛 165 | 🌐 C# | 📅 2026-09-07 - Open source MVVM framework for Web Apps.
...
* [Halibut](https://github.com/OctopusDeploy/Halibut) ⭐ 24 | 🐛 51 | 🌐 C# | 📅 2026-09-09 - A secure communication stack for .NET using JSON-RPC over SSL.
...
* [CleanArchitecture (SPA)](https://github.com/JasonGT/CleanArchitecture) ⭐ 20,534 | 🐛 20 | 🌐 C# | 📅 2026-09-07 - Solution template for creating a Single Page App (SPA) with Angular 8 and ASP.NET Core 3 following the principles of Clean Architecture
* [CleanArchitecture](https://github.com/ardalis/CleanArchitecture) ⭐ 18,464 | 🐛 42 | 🌐 C# | 📅 2026-08-23 - A starting point for Clean Architecture with ASP.NET Core. Clean Architecture is just the latest in a series of names for the same loosely-coupled, dependency-inverted architecture. You will also find it named hexagonal, ports-and-adapters, or onion architecture.
...
* [Serenity](https://github.com/volkanceylan/Serenity) ⭐ 2,692 | 🐛 0 | 🌐 C# | 📅 2026-09-09 - Serenity is an ASP.NET MVC / TypeScript application platform designed to simplify and shorten development of data-centric business applications with a service based architecture.
* [kendo-ui-core](https://github.com/telerik/kendo-ui-core) ⭐ 2,584 | 🐛 686 | 🌐 JavaScript | 📅 2026-09-09 - An HTML5, jQuery-based widget library for building modern web apps. <http://www.telerik.com/kendo-ui>.
...
* [ASP.NET-MVC-Template](https://github.com/NikolayIT/ASP.NET-MVC-Template) ⭐ 1,187 | 🐛 8 | 🌐 C# | 📅 2026-08-24 - A ready-to-use templates for ASP.NET MVC 5 and ASP.NET Core with repositories, services, models mapping and DI and StyleCop warnings fixed.
...
* [openiddict](https://github.com/openiddict/openiddict-core) ⭐ 5,242 | 🐛 6 | 🌐 C# | 📅 2026-09-06 - Easy-to-use OpenID Connect server for ASP.NET Core.
...
* [Auth0](https://github.com/auth0/auth0.net) ⭐ 361 | 🐛 6 | 🌐 C# | 📅 2026-09-04 - Hosted, enterprise-grade platform for modern identity.
...
* [BTCPayServer](https://github.com/btcpayserver/btcpayserver) ⭐ 7,751 | 🐛 83 | 🌐 C# | 📅 2026-09-07 - A cross platform, self-hosted server compatible with Bitpay API.
* [NEO](https://github.com/neo-project/neo) ⭐ 3,534 | 🐛 264 | 🌐 C# | 📅 2026-09-05 - Open Network For Smart Economy.
* [WalletWasabi](https://github.com/zkSNACKs/WalletWasabi) ⭐ 2,605 | 🐛 280 | 🌐 C# | 📅 2026-09-07 - Privacy focused, ZeroLink compliant Bitcoin wallet.
* [NBitcoin](https://github.com/MetacoSA/NBitcoin) ⭐ 1,939 | 🐛 113 | 🌐 C# | 📅 2026-09-08 - Comprehensive Bitcoin library for the .NET framework.
* [Nethermind](https://github.com/NethermindEth/nethermind) ⭐ 1,592 | 🐛 368 | 🌐 C# | 📅 2026-09-09 - .NET Core Ethereum client
...
* [NBXplorer](https://github.com/dgarage/NBXplorer) ⭐ 368 | 🐛 43 | 🌐 C# | 📅 2026-09-06 - A Bitcoin and Altcoin lightweight block explorer.
...
* [Telegram.Bot](https://github.com/TelegramBots/Telegram.Bot) ⭐ 3,645 | 🐛 0 | 🌐 C# | 📅 2026-08-28 - C# Telegram Bot API library.
* [BotSharp](https://github.com/SciSharp/BotSharp) ⭐ 3,099 | 🐛 47 | 🌐 C# | 📅 2026-09-09 - The Open Source AI Chatbot Platform Builder in 100% C# Running in .NET Core with Machine Learning algorithm.
...
* [msbuild](https://github.com/Microsoft/msbuild) ⭐ 5,548 | 🐛 1,704 | 🌐 C# | 📅 2026-09-09 - The Microsoft Build Engine is a platform for building applications.
* [dotnet-docker](https://github.com/dotnet/dotnet-docker) ⭐ 4,874 | 🐛 132 | 🌐 Dockerfile | 📅 2026-09-09 - The base Docker images for working with .NET Core and the .NET Core Tools.
* [Opserver](https://github.com/opserver/Opserver) ⭐ 4,564 | 🐛 76 | 🌐 C# | 📅 2024-11-30 - Stack Exchange's Monitoring System.
* [cake-build](https://github.com/cake-build/cake) ⭐ 4,189 | 🐛 248 | 🌐 C# | 📅 2026-07-17 - Cross platform build automation system.
* [Nuke](https://github.com/nuke-build/nuke) ⭐ 3,751 | 🐛 121 | 🌐 C# | 📅 2025-12-02 - Cross-platform build automation system.
* [vsts-agent](https://github.com/Microsoft/vsts-agent/blob/master/README.md) ⭐ 1,913 | 🐛 229 | 🌐 C# | 📅 2026-09-09 - Visual Studio Team Services Build and Release Agent.
* [GitVersioning](https://github.com/AArnott/Nerdbank.GitVersioning) ⭐ 1,585 | 🐛 16 | 🌐 C# | 📅 2026-09-09 - Stamp your assemblies and NuGet packages with a version from a single, simple version.txt file and include git commit IDs for non-official builds.
...
* [Faster](https://github.com/Microsoft/FASTER/tree/master/cs) ⭐ 6,638 | 🐛 36 | 🌐 C# | 📅 2026-08-19 - Fast key-value store from Microsoft Research.
* [Stack Exchange Redis](https://github.com/StackExchange/StackExchange.Redis) ⭐ 6,197 | 🐛 220 | 🌐 C# | 📅 2026-09-09 - High performance general purpose redis client for .NET languages (C# etc).
* [CacheManager](https://github.com/MichaCo/CacheManager) ⭐ 2,419 | 🐛 13 | 🌐 C# | 📅 2026-02-18 - Open source caching abstraction layer for .NET written in C#. It supports various cache providers and implements many advanced features. <http://cachemanager.michaco.net>
* [Foundatio](https://github.com/exceptionless/Foundatio) ⭐ 2,098 | 🐛 13 | 🌐 C# | 📅 2026-09-09 - Pluggable foundation blocks for building distributed apps.
...
* [Orchard Core CMS](https://github.com/OrchardCMS/OrchardCore) ⭐ 8,177 | 🐛 850 | 🌐 C# | 📅 2026-09-08 - Open Source Content Management System built with ASP.NET Core on top of a Modular and Extensible Application Framework.
* [Umbraco](https://github.com/umbraco/umbraco-cms) ⭐ 5,243 | 🐛 519 | 🌐 C# | 📅 2026-09-09 - An extensible and friendly Open source ASP.NET Core CMS
...
* [awesome-static-analysis](https://github.com/mre/awesome-static-analysis) ⭐ 14,769 | 🐛 11 | 🌐 Rust | 📅 2026-09-09 - Curated list of static analysis tools, linters and code quality checkers for various programming languages.
* Code Analysis
  * [StyleCopAnalyzers](https://github.com/DotNetAnalyzers/StyleCopAnalyzers) ⭐ 2,852 | 🐛 456 | 🌐 C# | 📅 2025-12-31 - StyleCop rules using the .NET Compiler Platform.
  ...
  * [DevSkim](https://github.com/Microsoft/DevSkim) ⭐ 1,005 | 🐛 76 | 🌐 C# | 📅 2026-09-03 - A set of IDE plugins and rules that provide security "linting" capabilities.
...
* Metrics
  ...
  * [coverlet](https://github.com/tonerdo/coverlet) ⭐ 3,173 | 🐛 15 | 🌐 C# | 📅 2026-09-09 - Cross platform code coverage library for .NET Core.
  * [Audit.NET](https://github.com/thepirat000/Audit.NET) ⭐ 2,648 | 🐛 1 | 🌐 C# | 📅 2026-08-19 - Small framework to audit .NET object changes.
  ...
  * [Foundatio](https://github.com/exceptionless/Foundatio#metrics) ⭐ 2,098 | 🐛 13 | 🌐 C# | 📅 2026-09-09 - A common interface with in memory, redis, StatsD, and Metrics.NET implementations.
  ...
  * [MiniCover](https://github.com/lucaslorentz/minicover) ⭐ 215 | 🐛 5 | 🌐 C# | 📅 2026-08-27 - Minimalist Code Coverage Tool for .NET Core.
  * [Prometheus.Client](https://github.com/PrometheusClientNet/Prometheus.Client) ⭐ 142 | 🐛 1 | 🌐 C# | 📅 2026-09-08 - .NET Client for [Prometheus](https://prometheus.io).
    ...
    * [Prometheus.Client.MetricServer](https://github.com/PrometheusClientNet/Prometheus.Client.MetricServer) ⭐ 16 | 🐛 1 | 🌐 C# | 📅 2026-09-08 -  MetricServer for the Prometheus.Client.
    * [Prometheus.Client.HttpRequestDurations](https://github.com/PrometheusClientNet/Prometheus.Client.HttpRequestDurations) ⭐ 11 | 🐛 1 | 🌐 C# | 📅 2026-09-08 -  Metrics logging of request durations for the Prometheus.Client.
    * [Prometheus.Client.AspNetCore](https://github.com/PrometheusClientNet/Prometheus.Client.AspNetCore) ⭐ 10 | 🐛 1 | 🌐 C# | 📅 2026-09-08 -  Middleware for the Prometheus.Client.
...
* [sharpcompress](https://github.com/adamhathcock/sharpcompress) ⭐ 2,580 | 🐛 294 | 🌐 C# | 📅 2026-08-27 - Fully managed C# library to deal with many compression types and formats.
...
* [roslyn](https://github.com/dotnet/roslyn) ⭐ 20,652 | 🐛 6,310 | 🌐 C# | 📅 2026-09-09 - The .NET Compiler Platform ("Roslyn") provides open-source C# and Visual Basic compilers with rich code analysis APIs.
* [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,151 | 🐛 165 | 🌐 F# | 📅 2026-09-09 - F# to JavaScript Compiler.
...
* [LiteDB](https://github.com/mbdavid/LiteDB) ⭐ 9,462 | 🐛 759 | 🌐 C# | 📅 2026-08-21 - .NET NoSQL Document Store in a single data file - <http://www.litedb.org>.
* [marten](https://github.com/JasperFx/marten) ⭐ 3,452 | 🐛 5 | 🌐 C# | 📅 2026-09-09 - Postgresql as a Document Database and Event Store for .NET Applications <http://jasperfx.github.io/marten>.
...
* [npgsql](https://github.com/npgsql/npgsql) ⭐ 3,725 | 🐛 225 | 🌐 C# | 📅 2026-09-08 - .NET data provider for PostgreSQL. It allows any program developed for .NET framework to access a PostgreSQL database server. It is implemented in 100% C# code. PostgreSQL versions since 9.1 are officially supported, others may work. <http://www.npgsql.org>
* [MongoDB.Driver](https://github.com/mongodb/mongo-csharp-driver) ⭐ 3,242 | 🐛 18 | 🌐 C# | 📅 2026-09-02 - .NET Driver for MongoDB.
...
* [couchbase-lite-net](https://github.com/couchbase/couchbase-lite-net) ⭐ 446 | 🐛 1 | 🌐 C# | 📅 2026-09-09 - A lightweight, document-oriented (NoSQL), syncable database engine for .NET.
...
* [ravendb](https://github.com/ayende/ravendb/tree/v4.0) ⭐ 296 | 🐛 22 | 🌐 C# | 📅 2026-09-09 - Linq enabled document database for .NET.
* [confluent-kafka-dotnet](https://github.com/confluentinc/confluent-kafka-dotnet) ⭐ 274 | 🐛 476 | 🌐 C# | 📅 2026-09-09 - Confluent's Apache Kafka .NET client.
...
* MySQL
  * [MySqlConnector](https://github.com/mysql-net/MySqlConnector) ⭐ 1,502 | 🐛 96 | 🌐 C# | 📅 2026-09-09 - Async MySQL Connector for .NET and .NET Core.
...
* Neo4j
  ...
  * [neo4j-dotnet-driver](https://github.com/neo4j/neo4j-dotnet-driver) ⭐ 247 | 🐛 2 | 🌐 C# | 📅 2026-09-07 - Neo4j Bolt driver for .NET.
...
* [EFCorePowerTools](https://github.com/ErikEJ/EFCorePowerTools) ⭐ 2,515 | 🐛 5 | 🌐 C# | 📅 2026-09-03 - Entity Framework Core Power Tools - reverse engineering, migrations and model visualization for EF Core.
...
* [monitor-table-change-with-sqltabledependency](https://github.com/christiandelbianco/monitor-table-change-with-sqltabledependency) ⭐ 666 | 🐛 60 | 🌐 C# | 📅 2024-01-16 - Get SQL Server notification on record table change.
...
* [Mongo.Migration](https://github.com/SRoddis/Mongo.Migration) ⭐ 184 | 🐛 34 | 🌐 C# | 📅 2026-03-18 - Mongo.Migration is designed for the [MongoDB C# Driver](https://github.com/mongodb/mongo-csharp-driver) ⭐ 3,242 | 🐛 18 | 🌐 C# | 📅 2026-09-02 to migrate your documents easily and on-the-fly. No more downtime for schema-migrations. Just write small and simple migrations. [Link](https://github.com/SRoddis/Mongo.Migration) ⭐ 184 | 🐛 34 | 🌐 C# | 📅 2026-03-18
...
* [FluentDateTime](https://github.com/FluentDateTime/FluentDateTime) ⭐ 698 | 🐛 1 | 🌐 C# | 📅 2026-09-03 - Allows you to write cleaner DateTime expressions and operation. Partially inspired by Ruby DateTime Extensions.
...
* [Ocelot](https://github.com/ThreeMammals/Ocelot) ⭐ 8,714 | 🐛 57 | 🌐 C# | 📅 2026-09-03 - API Gateway created using .NET Core
...
* [nopCommerce](https://github.com/nopSolutions/nopCommerce) ⭐ 10,141 | 🐛 166 | 🌐 C# | 📅 2026-09-08 - Free open-source ecommerce shopping cart (ASP.NET MVC / ASP.NET Core MVC ) with a vast community and a market place full of new features, themes and plugins.
...
* [GrandNode](https://github.com/grandnode/grandnode) ⚠️ Archived - Multi-platform, free, open source ecommerce shopping cart based on ASP.NET Core 2.1 and MongoDB derived from [nopCommerce](https://github.com/nopSolutions/nopCommerce) ⭐ 10,141 | 🐛 166 | 🌐 C# | 📅 2026-09-08.
...
* [Sentry](https://github.com/getsentry/sentry-dotnet) ⭐ 770 | 🐛 314 | 🌐 C# | 📅 2026-09-09 - .NET SDK for Sentry, an Open-source error tracking that helps developers monitor and fix crashes in real time.
...
* [ReactiveUI](https://github.com/reactiveui/ReactiveUI) ⭐ 8,536 | 🐛 5 | 🌐 C# | 📅 2026-09-08 - A MVVM framework that integrates with the Reactive Extensions for .NET to create elegant, testable User Interfaces that run on any mobile or desktop platform.
...
* [Giraffe](https://github.com/dustinmoris/Giraffe) ⭐ 2,253 | 🐛 45 | 🌐 F# | 📅 2026-09-08 - A native functional ASP.NET Core web framework for F# developers.
* [DynamicData](https://github.com/RolandPheasant/DynamicData) ⭐ 1,901 | 🐛 56 | 🌐 C# | 📅 2026-09-08 - Reactive collections based on Rx.NET.
...
* [ImageSharp](https://github.com/SixLabors/ImageSharp) ⭐ 8,033 | 🐛 21 | 🌐 C# | 📅 2026-09-05 - Cross-platform library for processing of image files written in C#.
* [QRCoder](https://github.com/codebude/QRCoder) ⭐ 5,157 | 🐛 29 | 🌐 C# | 📅 2026-08-23 - A pure C# Open Source QR Code implementation.
* [Magick.NET](https://github.com/dlemstra/Magick.NET) ⭐ 3,977 | 🐛 47 | 🌐 C# | 📅 2026-09-05 - The .NET library for ImageMagick.
...
* [Avalonia](https://github.com/AvaloniaUI/Avalonia) ⭐ 31,462 | 🐛 1,882 | 🌐 C# | 📅 2026-09-09 - A multi-platform .NET UI framework (formerly known as Perspex).
...
* [ShellProgressBar](https://github.com/Mpdreamz/shellprogressbar) ⭐ 1,478 | 🐛 35 | 🌐 C# | 📅 2024-07-16 - library to create progress bars in console programs
...
* [AvaloniaEdit](https://github.com/AvaloniaUI/AvaloniaEdit/) ⭐ 1,130 | 🐛 91 | 🌐 C# | 📅 2026-08-28 - The Avalonia-based text editor component forked from [AvalonEdit](https://github.com/icsharpcode/AvalonEdit) ⭐ 2,080 | 🐛 117 | 🌐 C# | 📅 2025-12-04
  [HandyControls](https://github.com/ghost1372/HandyControls) ⭐ 1,306 | 🐛 2 | 🌐 C# | 📅 2026-09-07 - Contains some simple and commonly used WPF controls.
...
* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 191,522 | 🐛 20,718 | 🌐 TypeScript | 📅 2026-09-09 - New type of tool that combines the simplicity of a code editor with what developers need for their core edit-build-debug cycle. Code provides comprehensive editing and debugging support, an extensibility model, and lightweight integration with existing tools.
...
* [DryIoc](https://github.com/dadhi/DryIoc) ⭐ 1,131 | 🐛 55 | 🌐 C# | 📅 2026-05-28 - Fast, small, full-featured IoC Container for .NET.
...
* [serilog](https://github.com/serilog/serilog) ⭐ 8,036 | 🐛 19 | 🌐 C# | 📅 2026-07-31 - Simple .NET logging with fully-structured events.
...
* [NLog](https://github.com/NLog/NLog) ⭐ 6,545 | 🐛 51 | 🌐 C# | 📅 2026-09-08 - Advanced .NET, Silverlight and Xamarin Logging with support for structured and non structured logging.
  * [NLog.Extensions.Logging](https://github.com/NLog/NLog.Extensions.Logging) ⭐ 403 | 🐛 2 | 🌐 C# | 📅 2026-08-16 - NLog Provider for Microsoft.Extensions.Logging for .NET Standard libraries and .NET Core applications
  * [NLog for ASP.NET and ASP.NET Core](https://github.com/NLog/NLog.Web) ⭐ 328 | 🐛 10 | 🌐 C# | 📅 2026-09-08 - NLog integration for ASP.NET & ASP.NET Core 1-3
...
* [Foundatio](https://github.com/exceptionless/Foundatio#logging) ⭐ 2,098 | 🐛 13 | 🌐 C# | 📅 2026-09-09 - A fluent logging api that can be used to log messages throughout your application.
...
* [WaveFunctionCollapse](https://github.com/mxgmn/WaveFunctionCollapse) ⭐ 25,310 | 🐛 9 | 🌐 C# | 📅 2026-03-22 - itmap & tilemap generation from a single example with the help of ideas from quantum mechanics.
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,358 | 🐛 752 | 🌐 C# | 📅 2026-09-09 - Cross-platform open-source machine learning framework which makes machine learning accessible to .NET developers <http://dot.net/ml>.
...
* [MailKit](https://github.com/jstedfast/MailKit) ⭐ 6,857 | 🐛 10 | 🌐 C# | 📅 2026-08-19 - Cross-platform .NET library for IMAP, POP3, and SMTP.
* [Papercut](https://github.com/ChangemakerStudios/Papercut) ⭐ 3,331 | 🐛 4 | 🌐 C# | 📅 2026-08-23 - Simple Desktop SMTP Server
...
* [MetadataExtractor](https://github.com/drewnoakes/metadata-extractor-dotnet) ⭐ 1,069 | 🐛 70 | 🌐 C# | 📅 2026-07-15 - Extracts metadata from media (images, video, audio) with a simple to use API.

### Misc

* [AutoMapper](https://github.com/AutoMapper/AutoMapper) ⭐ 10,189 | 🐛 12 | 🌐 C# | 📅 2026-09-04 - Convention-based object-object mapper in .NET.
...
* [AngleSharp](https://github.com/AngleSharp/AngleSharp) ⭐ 5,531 | 🐛 8 | 🌐 C# | 📅 2026-09-05 - The ultimate angle brackets parser library. It parses HTML5, MathML, SVG and CSS to construct a DOM based on the official W3C specification. Comparable to beautifulsoup4 of python.
* [markdig](https://github.com/lunet-io/markdig) ⭐ 5,320 | 🐛 119 | 🌐 C# | 📅 2026-08-18 - Fast, powerfull, CommonMark compliant, extensible Markdown processor for .NET.
...
* [PuppeteerSharp](https://github.com/kblok/puppeteer-sharp) ⭐ 3,917 | 🐛 11 | 🌐 C# | 📅 2026-09-05 - Puppeteer Sharp is a .NET port of the official Node.JS Puppeteer API.
...
* [FluentFTP](https://github.com/robinrodricks/FluentFTP/) ⭐ 3,396 | 🐛 22 | 🌐 C# | 📅 2026-09-08 - FTP and FTPS client, with extensive FTP commands, SSL/TLS connections, hashing/checksums and more.
...
* [Dotnet outdated](https://github.com/dotnet-outdated/dotnet-outdated) ⭐ 1,694 | 🐛 122 | 🌐 C# | 📅 2026-09-09 - A .NET Core global tool to display and update outdated NuGet packages in a project
...
* [FastExpressionCompiler](https://github.com/dadhi/FastExpressionCompiler) ⭐ 1,375 | 🐛 24 | 🌐 C# | 📅 2026-08-19 - Fast ExpressionTree compiler to delegate.
* [Otp.NET](https://github.com/kspearrin/Otp.NET) ⭐ 1,321 | 🐛 20 | 🌐 C# | 📅 2025-12-01 - An implementation TOTP RFC 6238 and HOTP RFC 4226 in C#.
...
* [PdfReport.Core](https://github.com/VahidN/PdfReport.Core) ⭐ 372 | 🐛 7 | 🌐 C# | 📅 2026-09-09 - PdfReport.Core is a code first reporting engine, which is built on top of the iTextSharp.LGPLv2.Core and EPPlus.Core libraries.
...
* [NuGet Trends](https://github.com/NuGetTrends/nuget-trends) ⭐ 188 | 🐛 38 | 🌐 C# | 📅 2026-08-19 - Website with statistics of NuGet packages download count.
...
* [SharpPcap](https://github.com/chmorgan/sharppcap) ⭐ 1,479 | 🐛 29 | 🌐 C# | 📅 2026-09-08 - Fully managed, cross platform (Windows, Mac, Linux) .NET library for capturing packets from live and file based devices.
...
* [Open-XML-SDK](https://github.com/OfficeDev/Open-XML-SDK) ⭐ 4,600 | 🐛 124 | 🌐 C# | 📅 2026-09-04 - The Open XML SDK provides tools for working with Office Word, Excel, and PowerPoint documents.
* [EPPlus](https://github.com/EPPlusSoftware/EPPlus) ⭐ 2,035 | 🐛 96 | 🌐 C# | 📅 2026-09-09 - Create advanced Excel spreadsheets using .NET.
...
* [Dapper](https://github.com/StackExchange/Dapper) ⭐ 18,381 | 🐛 547 | 🌐 C# | 📅 2026-08-20 - Simple object mapper for .NET.
  * [MicroOrm.Dapper.Repositories](https://github.com/phnx47/MicroOrm.Dapper.Repositories) ⭐ 705 | 🐛 2 | 🌐 C# | 📅 2026-09-08 - CRUD for Dapper.
  * [Dommel](https://github.com/henkmollema/Dommel) ⭐ 692 | 🐛 9 | 🌐 C# | 📅 2026-06-24 - Simple CRUD operations for Dapper.
  * [Dapper-FluentMap](https://github.com/henkmollema/Dapper-FluentMap) ⭐ 443 | 🐛 0 | 🌐 C# | 📅 2026-09-09 - Provides a simple API to fluently map POCO properties to database columns when using Dapper.
* [Entity Framework Core](https://github.com/aspnet/EntityFramework) ⭐ 14,789 | 🐛 2,381 | 🌐 C# | 📅 2026-09-09 - Familiar developer experience to previous versions of EF, including LINQ, POCO, and Code First support.
  ...
  * [Npgsql.EntityFrameworkCore.PostgreSQL](https://github.com/npgsql/Npgsql.EntityFrameworkCore.PostgreSQL) ⭐ 1,837 | 🐛 297 | 🌐 C# | 📅 2026-09-08 - Entity Framework Core provider for PostgreSQL.
...
* [nhibernate-core](https://github.com/nhibernate/nhibernate-core) ⭐ 2,174 | 🐛 666 | 🌐 C# | 📅 2026-09-09 - NHibernate Object Relational Mapper.
...
* [SmartSql](https://github.com/Ahoo-Wang/SmartSql) ⭐ 1,132 | 🐛 42 | 🌐 C# | 📅 2026-09-08 - SmartSql = MyBatis + Cache(Memory | Redis) + ZooKeeper + R/W Splitting +Dynamic Repository ....
* [NPoco](https://github.com/schotime/NPoco) ⭐ 880 | 🐛 45 | 🌐 C# | 📅 2026-09-05 - Simple microORM that maps the results of a query onto a POCO object. Project based on Schotime's branch of PetaPoco.
...
* [MQTTnet](https://github.com/chkr1011/MQTTnet) ⭐ 5,062 | 🐛 197 | 🌐 C# | 📅 2026-08-09 - MQTTnet is a high performance .NET library for MQTT based communication.
...
* [rabbitmq-dotnet-client](https://github.com/rabbitmq/rabbitmq-dotnet-client) ⭐ 2,282 | 🐛 80 | 🌐 C# | 📅 2026-09-08 - RabbitMQ .NET client <https://www.rabbitmq.com>.
* [NServiceBus](https://github.com/particular/nservicebus) ⭐ 2,169 | 🐛 291 | 🌐 C# | 📅 2026-09-09 - NServiceBus is part of the [Particular Service Platform](https://particular.net/service-platform), which contains tools to build, monitor, and debug distributed systems.
* [Foundatio](https://github.com/exceptionless/Foundatio#queues) ⭐ 2,098 | 🐛 13 | 🌐 C# | 📅 2026-09-09 - A common interface with in memory, redis and azure implementations.
...
* [Silverback](https://github.com/BEagle1984/silverback) ⭐ 284 | 🐛 13 | 🌐 C# | 📅 2026-08-26 - Framework to build event-driven applications (support for Kafka, RabbitMQ, MQTT).
...
* [OpenCQRS](https://github.com/OpenCQRS/OpenCQRS) ⭐ 28 | 🐛 14 | 🌐 C# | 📅 2026-09-09 - .NET Core library for DDD, CQRS and Event Sourcing with Azure Service Bus integration. Supported database providers for the Command and the Event stores are: DocumentDB, MongoDB, SQL Server, MySQL, PostgreSQL and SQLite.
...
* [FastReport](https://github.com/FastReports/FastReport) ⭐ 3,086 | 🐛 24 | 🌐 C# | 📅 2026-08-31 - The open source report generator for .NET Core 2.x/.Net Framework 4.x. FastReport can be used in MVC, Web API applications.
...
* [quartznet](https://github.com/quartznet/quartznet/) ⭐ 7,077 | 🐛 7 | 🌐 C# | 📅 2026-09-09 - Quartz Enterprise Scheduler .NET <http://www.quartz-scheduler.net>.
* [stateless](https://github.com/dotnet-state-machine/stateless) ⭐ 6,257 | 🐛 81 | 🌐 C# | 📅 2026-04-04 - Simple library for creating state machines in C# code.
* [Coravel](https://github.com/jamesmh/coravel) ⭐ 4,289 | 🐛 84 | 🌐 C# | 📅 2025-07-20 - .Net Core meets Laravel: Scheduling, Queuing, etc.
* [FluentScheduler](https://github.com/fluentscheduler/FluentScheduler) ⭐ 2,770 | 🐛 21 | 🌐 C# | 📅 2026-03-19 - Automated job scheduler with fluent interface.
...
* [google-cloud-dotnet](https://github.com/GoogleCloudPlatform/google-cloud-dotnet) ⭐ 1,094 | 🐛 18 | 🌐 C# | 📅 2026-09-08 - Google Cloud Client Libraries for .NET.
...
* [AWS SDK](https://github.com/aws/aws-sdk-net) ⭐ 139 | 🐛 36 | 🌐 C# | 📅 2026-09-08 - The Amazon Web Services (AWS) .NET Core SDK components. Each AWS service has its own NuGet package.
...
* Blockchain clients
  * [Binance.Net](https://github.com/JKorf/Binance.Net) ⭐ 1,172 | 🐛 12 | 🌐 C# | 📅 2026-09-09 - .Net API wrapper for the Binance web API.
...
* [Algolia.Search](https://github.com/algolia/algoliasearch-client-csharp) ⭐ 128 | 🐛 5 | 🌐 C# | 📅 2026-09-01 - Repository for the official Algolia .NET client.
...
* [Newtonsoft.Json](https://github.com/JamesNK/Newtonsoft.Json) ⭐ 11,314 | 🐛 826 | 🌐 C# | 📅 2026-08-13 - Popular high-performance JSON framework for .NET.
...
* [TinyCsvParser](https://github.com/bytefish/TinyCsvParser) ⭐ 406 | 🐛 0 | 🌐 C# | 📅 2026-08-25 - Easy to use, easy to extend and high-performance library for CSV parsing with .NET.
...
* MessagePack
  * [MessagePack-CSharp](https://github.com/neuecc/MessagePack-CSharp) ⭐ 6,773 | 🐛 146 | 🌐 C# | 📅 2026-09-07 - Extremely Fast MessagePack Serializer for C#(.NET, .NET Core, Unity, Xamarin).
...
* [fluid](https://github.com/sebastienros/fluid) ⭐ 1,777 | 🐛 31 | 🌐 C# | 📅 2026-09-07 - Open-source .NET template engine that is as close as possible to the Liquid template language.
...
* [moq.netcore](https://github.com/Moq/moq4) ⭐ 6,400 | 🐛 22 | 🌐 C# | 📅 2026-08-27 - Most popular and friendly mocking framework for .NET.
* [xUnit.net](https://github.com/xunit/xunit) ⭐ 4,603 | 🐛 21 | 🌐 C# | 📅 2026-09-08 - A free, open source, community-focused unit testing tool for the .NET Framework.
* [FluentAssertions](https://github.com/fluentassertions/fluentassertions) ⭐ 3,814 | 🐛 65 | 🌐 C# | 📅 2026-09-08 - Set of .NET extension methods that allow you to more naturally specify the expected outcome of a TDD or BDD-style test.
* [shouldly](https://github.com/shouldly/shouldly) ⭐ 3,409 | 🐛 94 | 🌐 C# | 📅 2026-09-07 - Should testing for .NET - the way Asserting *Should* be! <http://shouldly.readthedocs.org/en/latest>
* [NSubstitute](https://github.com/nsubstitute/NSubstitute) ⭐ 2,973 | 🐛 111 | 🌐 C# | 📅 2026-08-24 - A friendly substitute for .NET mocking frameworks.
* [FakeItEasy](https://github.com/FakeItEasy/FakeItEasy) ⭐ 1,847 | 🐛 4 | 🌐 C# | 📅 2026-09-07 - The easy mocking library for .NET.
...
* [Atata](https://github.com/atata-framework/atata) ⭐ 502 | 🐛 10 | 🌐 C# | 📅 2026-09-09 - Web UI test automation full-featured framework based on Selenium WebDriver. <https://atata.io>
...
* [ShareX](https://github.com/ShareX/ShareX) ⭐ 39,501 | 🐛 647 | 🌐 C# | 📅 2026-09-08 - Free and open source program that lets you capture or record any area of your screen and share it with a single press of a key. It also allows uploading images, text or other types of files to over 80 supported destinations you can choose from. <https://getsharex.com>

* [scoop](https://github.com/lukesampson/scoop) ⭐ 24,645 | 🐛 527 | 🌐 PowerShell | 📅 2026-09-09 - A command-line installer for Windows.

* [mRemoteNG](https://github.com/mRemoteNG/mRemoteNG) ⭐ 11,089 | 🐛 860 | 🌐 C# | 📅 2026-09-08 - The next generation of mRemote, open source, tabbed, multi-protocol, remote connections manager

* [gitignore.io](https://github.com/joeblau/gitignore.io) ⭐ 8,746 | 🐛 68 | 🌐 Swift | 📅 2024-12-23 - Create useful .gitignore files for your project <https://www.gitignore.io>.
...
* [docfx](https://github.com/dotnet/docfx) ⭐ 4,449 | 🐛 453 | 🌐 C# | 📅 2026-09-09 - Tools for building and publishing API documentation for .NET projects <http://dotnet.github.io/docfx>
...
* [System.CommandLine](https://github.com/dotnet/command-line-api) ⭐ 3,673 | 🐛 483 | 🌐 C# | 📅 2026-09-09 - System.CommandLine, a set of libraries for command line parsing, invocation, and rendering of terminal output.
...
* [ReactJS.NET](https://github.com/reactjs/React.NET) ⭐ 2,322 | 🐛 113 | 🌐 C# | 📅 2026-03-02 - .NET library for JSX compilation and server-side rendering of React components.
* [redux.NET](https://github.com/GuillaumeSalles/redux.NET) ⭐ 708 | 🐛 29 | 🌐 C# | 📅 2021-07-28 - Predictable state container for .NET apps. Inspired by <https://github.com/reactjs/redux> ⭐ 61,494 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-08.
* WebAssembly
  * [Blazor](https://github.com/SteveSanderson/Blazor) ⭐ 1,677 | 🐛 7 | 🌐 C# | 📅 2018-02-23 - UI framework running .NET in the browser via WebAssembly.
    * [Awesome Blazor](https://github.com/AdrienTorris/awesome-blazor) ⭐ 9,374 | 🐛 97 | 📅 2026-09-03 - Collection of awesome resources (samples, components, articles, videos and others) about Blazor.
...
* [workflow-core](https://github.com/danielgerlag/workflow-core) ⭐ 5,921 | 🐛 141 | 🌐 C# | 📅 2026-09-08 - Lightweight workflow engine for .NET Standard.
...
* [Wexflow](https://github.com/aelassas/Wexflow) ⭐ 841 | 🐛 0 | 🌐 C# | 📅 2026-08-24 - A high performance, extensible, modular and cross-platform workflow engine.
...
* [bitwarden-core](https://github.com/bitwarden/core) ⭐ 20,103 | 🐛 228 | 🌐 C# | 📅 2026-09-09 - The core infrastructure backend (API, database, etc) <https://bitwarden.com>.
...
* [ASP.NET Core Starter Kit](https://github.com/kriasoft/aspnet-starter-kit) ⭐ 1,166 | 🐛 45 | 🌐 JavaScript | 📅 2022-11-22 - Opinionated boilerplate for web development based on .NET Core, Kestrel, GraphQL on the backend and Babel, Webpack, React and Redux on the frontend. This boilerplate comes in both C# and F# flavors.
...
* Microservices & Service Mesh
  * [eShop](https://github.com/dotnet/eShop) ⭐ 10,848 | 🐛 124 | 🌐 C# | 📅 2026-08-31 - A reference .NET application implementing an eCommerce site.
...
* Monoliths
  * [MusicStore](https://github.com/dotnet/aspnetcore/tree/master/src/MusicStore) ⭐ 38,431 | 🐛 4,176 | 🌐 C# | 📅 2026-09-09 - Sample MusicStore application that uses MVC and Entity Framework.
  ...
  * [Practical ASP.NET Core](https://github.com/dodyg/practical-aspnetcore) ⭐ 10,407 | 🐛 177 | 🌐 C# | 📅 2026-09-03 - A daily updated micro samples of ASP.NET Core features and facilities.
  ...
  * [Clean Architecture Manga](https://github.com/ivanpaulovich/clean-architecture-manga) ⭐ 4,367 | 🐛 45 | 🌐 C# | 📅 2026-06-22 - Clean Architecture sample with .NET Core 3.0 and C# 8. Use cases as central organising structure, completely testable, decoupled from frameworks.
...
* [awesome-copilot](https://github.com/github/awesome-copilot) ⭐ 38,799 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-09
* Stack Overflow
