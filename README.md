...
* [.NET Core SDK](https://www.microsoft.com/net/core) - .NET Core SDK is a general purpose development platform maintained by Microsoft and the .NET community on [GitHub](https://github.com/dotnet/core) ⭐ 22,027 | 🐛 351 | 🌐 PowerShell | 📅 2026-08-12.
...
* [Clean Code .NET/.NET Core](https://github.com/thangchung/clean-code-dotnet) ⭐ 7,717 | 🐛 46 | 🌐 C# | 📅 2026-02-27 - Clean Code concepts adapted for .NET / .NET Core.
...
* [OpenAPI Generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,666 | 🐛 5,710 | 🌐 Java | 📅 2026-08-13 - OpenAPI Generator allows generation of API client libraries (e.g. C#, TypeScript, etc), server stubs (ASP.NET Core, NancyFx, etc), documentation and configuration automatically given an OpenAPI Spec (v2, v3).
* [Restsharp](https://github.com/restsharp/RestSharp) ⭐ 9,830 | 🐛 38 | 🌐 C# | 📅 2026-06-02 - Simple REST and HTTP API Client for .NET
* [NSwag](https://github.com/RSuter/NSwag) ⭐ 7,356 | 🐛 2,053 | 🌐 C# | 📅 2026-06-21 - The Swagger/OpenAPI toolchain for .NET, Web API and TypeScript. <http://NSwag.org>.
* [Swashbuckle](https://github.com/domaindrivendev/Swashbuckle.AspNetCore) ⭐ 5,497 | 🐛 173 | 🌐 C# | 📅 2026-08-12 - Seamlessly adds a swagger to WebApi projects.
...
* [aspnet-api-versioning](https://github.com/Microsoft/aspnet-api-versioning) ⭐ 3,203 | 🐛 7 | 🌐 C# | 📅 2026-08-12 - set of libraries which add service API versioning to ASP.NET Web API, OData with ASP.NET Web API, and ASP.NET Core.
...
* [RestEase](https://github.com/canton7/RestEase) ⭐ 1,117 | 🐛 15 | 🌐 C# | 📅 2023-12-10 - Easy-to-use typesafe REST API client library, which is simple and customisable.
...
* [JSON API .NET Core](https://github.com/Research-Institute/json-api-dotnet-core) ⭐ 715 | 🐛 20 | 🌐 C# | 📅 2026-08-13 - Framework for building json:api compliant APIs with the goal of eliminating RESTful boilerplate.
...
* [halcyon](https://github.com/visualeyes/halcyon) ⭐ 82 | 🐛 15 | 🌐 C# | 📅 2018-10-07 - HAL implementation for ASP.NET.
...
* GraphQL
  ...
  * [graphql-dotnet-server](https://github.com/graphql-dotnet/server) ⭐ 603 | 🐛 23 | 🌐 C# | 📅 2026-08-03 - GraphQL for .NET - Subscription Transport WebSockets.
  ...
  * [graphql-dotnetcore](https://github.com/mkmarek/graphql-dotnetcore) ⚠️ Archived - GraphQL for .NET Core based on <https://github.com/graphql/graphql-js> ⭐ 20,344 | 🐛 95 | 🌐 TypeScript | 📅 2026-07-27.
...
* [grpc](https://github.com/grpc/grpc/tree/master/src/csharp) ⭐ 45,281 | 🐛 1,384 | 🌐 C++ | 📅 2026-08-13 - Remote Procedure Calls (RPCs) provide a useful abstraction for building distributed applications and services. The libraries in this repository provide a concrete implementation of the gRPC protocol, layered over HTTP/2. These libraries enable communication between clients and servers using any combination of the supported languages.
* [ASP.NET MVC](https://github.com/dotnet/aspnetcore/tree/master/src/Mvc) ⭐ 38,370 | 🐛 4,103 | 🌐 C# | 📅 2026-08-13 - Model view controller framework for building dynamic web sites with clean separation of concerns, including the merged MVC, Web API, and Web Pages w/ Razor.
* [Abp vNext](https://github.com/abpframework/abp) ⭐ 14,399 | 🐛 319 | 🌐 C# | 📅 2026-08-13 - Abp vNext is the next generation of the open source [ASP.NET Boilerplate](https://github.com/aspnetboilerplate/aspnetboilerplate) ⭐ 11,999 | 🐛 63 | 🌐 C# | 📅 2026-07-28 framework. It's a complete architecture and strong infrastructure to create modern web applications!
...
* [orleans](https://github.com/dotnet/orleans) ⭐ 10,827 | 🐛 708 | 🌐 C# | 📅 2026-08-12 - Framework that provides a straight-forward approach to building distributed high-scale computing applications, without the need to learn and apply complex concurrency or other scaling patterns.
...
* [ElectronNET](https://github.com/ElectronNET/Electron.NET) ⭐ 7,602 | 🐛 19 | 🌐 C# | 📅 2026-08-11 - Build cross platform desktop apps with ASP.NET NET Core.
* [CAP](https://github.com/dotnetcore/CAP) ⭐ 7,103 | 🐛 7 | 🌐 C# | 📅 2026-08-01 - An EventBus with local persistent message functionality for system integration in SOA or Microservice architecture.
...
* [opencvsharp](https://github.com/shimat/opencvsharp) ⭐ 6,061 | 🐛 8 | 🌐 C# | 📅 2026-08-10 - .NET Framework wrapper for OpenCV.
* [ServiceStack](https://github.com/ServiceStack/ServiceStack) ⭐ 5,500 | 🐛 35 | 🌐 C# | 📅 2026-08-13 - Thoughtfully architected, obscenely fast, thoroughly enjoyable web services for all <https://servicestack.net>.
* [akka.net](https://github.com/akkadotnet/akka.net) ⭐ 5,076 | 🐛 458 | 🌐 C# | 📅 2026-08-11 - Toolkit and runtime for building highly concurrent, distributed, and fault tolerant event-driven applications on .NET & Mono.
...
* [DotNetty](https://github.com/Azure/DotNetty) ⭐ 4,250 | 🐛 174 | 🌐 C# | 📅 2026-01-12 - Port of netty, event-driven asynchronous network application framework.
...
* [Finbuckle.MultiTenant](https://github.com/Finbuckle/Finbuckle.MultiTenant) ⭐ 1,616 | 🐛 31 | 🌐 C# | 📅 2026-08-12 - Finbuckle.MultiTenant is a .NET Standard library for multitenant support designed for ASP.NET 2.0+. It provides functionality for tenant resolution, per-tenant app configuration, and per-tenant data isolation.
...
* [X.PagedList](https://github.com/dncuug/X.PagedList) ⭐ 926 | 🐛 0 | 🌐 C# | 📅 2026-08-03 - Library for easily paging through any IEnumerable/IQueryable in ASP.NET/ASP.NET Core.
...
* [dotvvm](https://github.com/riganti/dotvvm) ⭐ 806 | 🐛 160 | 🌐 C# | 📅 2026-08-12 - Open source MVVM framework for Web Apps.
...
* [Strathweb.TypedRouting.AspNetCore](https://github.com/filipw/Strathweb.TypedRouting.AspNetCore) ⭐ 76 | 🐛 9 | 🌐 C# | 📅 2019-01-22 - A library enabling strongly typed routing in ASP.NET Core MVC projects.
...
* [Halibut](https://github.com/OctopusDeploy/Halibut) ⭐ 24 | 🐛 51 | 🌐 C# | 📅 2026-08-11 - A secure communication stack for .NET using JSON-RPC over SSL.
...
* [CleanArchitecture (SPA)](https://github.com/JasonGT/CleanArchitecture) ⭐ 20,450 | 🐛 22 | 🌐 C# | 📅 2026-08-13 - Solution template for creating a Single Page App (SPA) with Angular 8 and ASP.NET Core 3 following the principles of Clean Architecture
* [CleanArchitecture](https://github.com/ardalis/CleanArchitecture) ⭐ 18,395 | 🐛 34 | 🌐 C# | 📅 2026-08-12 - A starting point for Clean Architecture with ASP.NET Core. Clean Architecture is just the latest in a series of names for the same loosely-coupled, dependency-inverted architecture. You will also find it named hexagonal, ports-and-adapters, or onion architecture.
* [.NET Boxed](https://github.com/Dotnet-Boxed/Templates) ⭐ 3,483 | 🐛 51 | 🌐 C# | 📅 2026-08-11 - Project templates with batteries included, providing the minimum amount of code required to get you going. Includes ASP.NET Core API and GraphQL Templates.
* [JavaScriptServices](https://github.com/aspnet/JavaScriptServices) ⚠️ Archived - Microsoft ASP.NET Core JavaScript Services.
* [Serenity](https://github.com/volkanceylan/Serenity) ⭐ 2,693 | 🐛 5 | 🌐 C# | 📅 2026-08-12 - Serenity is an ASP.NET MVC / TypeScript application platform designed to simplify and shorten development of data-centric business applications with a service based architecture.
* [kendo-ui-core](https://github.com/telerik/kendo-ui-core) ⭐ 2,584 | 🐛 705 | 🌐 JavaScript | 📅 2026-08-13 - An HTML5, jQuery-based widget library for building modern web apps. <http://www.telerik.com/kendo-ui>.
...
* [QuickApp](https://github.com/emonney/QuickApp) ⭐ 1,352 | 🐛 11 | 🌐 TypeScript | 📅 2026-01-03 - ASP.NET Core / Angular4 startup project template with complete login, user and role management.
...
* [openiddict](https://github.com/openiddict/openiddict-core) ⭐ 5,222 | 🐛 6 | 🌐 C# | 📅 2026-08-01 - Easy-to-use OpenID Connect server for ASP.NET Core.
...
* [Casbin.NET](https://github.com/casbin-net/Casbin.NET) ⭐ 1,330 | 🐛 9 | 🌐 C# | 📅 2026-06-16 - Authorization library that supports access control models like ACL, RBAC, ABAC in C#
...
* [Auth0](https://github.com/auth0/auth0.net) ⭐ 361 | 🐛 11 | 🌐 C# | 📅 2026-08-12 - Hosted, enterprise-grade platform for modern identity.
...
* [BTCPayServer](https://github.com/btcpayserver/btcpayserver) ⭐ 7,704 | 🐛 78 | 🌐 C# | 📅 2026-08-07 - A cross platform, self-hosted server compatible with Bitpay API.
* [NEO](https://github.com/neo-project/neo) ⭐ 3,535 | 🐛 258 | 🌐 C# | 📅 2026-08-09 - Open Network For Smart Economy.
* [WalletWasabi](https://github.com/zkSNACKs/WalletWasabi) ⭐ 2,599 | 🐛 339 | 🌐 C# | 📅 2026-08-10 - Privacy focused, ZeroLink compliant Bitcoin wallet.
* [NBitcoin](https://github.com/MetacoSA/NBitcoin) ⭐ 1,941 | 🐛 116 | 🌐 C# | 📅 2026-08-12 - Comprehensive Bitcoin library for the .NET framework.
* [Nethermind](https://github.com/NethermindEth/nethermind) ⭐ 1,586 | 🐛 398 | 🌐 C# | 📅 2026-08-13 - .NET Core Ethereum client
...
* [NBXplorer](https://github.com/dgarage/NBXplorer) ⭐ 369 | 🐛 47 | 🌐 C# | 📅 2026-08-12 - A Bitcoin and Altcoin lightweight block explorer.
...
* [Telegram.Bot](https://github.com/TelegramBots/Telegram.Bot) ⭐ 3,645 | 🐛 0 | 🌐 C# | 📅 2026-08-02 - C# Telegram Bot API library.
* [BotSharp](https://github.com/SciSharp/BotSharp) ⭐ 3,092 | 🐛 48 | 🌐 C# | 📅 2026-08-13 - The Open Source AI Chatbot Platform Builder in 100% C# Running in .NET Core with Machine Learning algorithm.
...
* [msbuild](https://github.com/Microsoft/msbuild) ⭐ 5,542 | 🐛 1,661 | 🌐 C# | 📅 2026-08-13 - The Microsoft Build Engine is a platform for building applications.
* [dotnet-docker](https://github.com/dotnet/dotnet-docker) ⭐ 4,863 | 🐛 130 | 🌐 Dockerfile | 📅 2026-08-13 - The base Docker images for working with .NET Core and the .NET Core Tools.
* [Opserver](https://github.com/opserver/Opserver) ⭐ 4,566 | 🐛 76 | 🌐 C# | 📅 2024-11-30 - Stack Exchange's Monitoring System.
* [cake-build](https://github.com/cake-build/cake) ⭐ 4,183 | 🐛 248 | 🌐 C# | 📅 2026-07-17 - Cross platform build automation system.
* [Nuke](https://github.com/nuke-build/nuke) ⭐ 3,749 | 🐛 122 | 🌐 C# | 📅 2025-12-02 - Cross-platform build automation system.
* [vsts-agent](https://github.com/Microsoft/vsts-agent/blob/master/README.md) ⭐ 1,909 | 🐛 220 | 🌐 C# | 📅 2026-08-13 - Visual Studio Team Services Build and Release Agent.
* [GitVersioning](https://github.com/AArnott/Nerdbank.GitVersioning) ⭐ 1,580 | 🐛 18 | 🌐 C# | 📅 2026-08-13 - Stamp your assemblies and NuGet packages with a version from a single, simple version.txt file and include git commit IDs for non-official builds.
* [Colorful.Console](https://github.com/tomakita/Colorful.Console) ⭐ 1,331 | 🐛 34 | 🌐 C# | 📅 2024-06-06 - Style your C# console output!
...
* [GitInfo](https://github.com/kzu/GitInfo) ⭐ 652 | 🐛 2 | 🌐 Pascal | 📅 2026-07-22 - Git and SemVer Info from MSBuild, C# and VB.
...
* [Faster](https://github.com/Microsoft/FASTER/tree/master/cs) ⭐ 6,636 | 🐛 36 | 🌐 C# | 📅 2026-07-09 - Fast key-value store from Microsoft Research.
* [Stack Exchange Redis](https://github.com/StackExchange/StackExchange.Redis) ⭐ 6,194 | 🐛 221 | 🌐 C# | 📅 2026-08-10 - High performance general purpose redis client for .NET languages (C# etc).
...
* [Foundatio](https://github.com/exceptionless/Foundatio) ⭐ 2,096 | 🐛 18 | 🌐 C# | 📅 2026-08-11 - Pluggable foundation blocks for building distributed apps.
...
* [Orchard Core CMS](https://github.com/OrchardCMS/OrchardCore) ⭐ 8,152 | 🐛 849 | 🌐 C# | 📅 2026-08-12 - Open Source Content Management System built with ASP.NET Core on top of a Modular and Extensible Application Framework.
* [Umbraco](https://github.com/umbraco/umbraco-cms) ⭐ 5,223 | 🐛 469 | 🌐 C# | 📅 2026-08-13 - An extensible and friendly Open source ASP.NET Core CMS
* [ZKEACMS](https://github.com/SeriaWei/ZKEACMS.Core) ⭐ 2,836 | 🐛 5 | 🌐 C# | 📅 2026-08-09 - Visual design, build site onlie by drag and drop.
* [Squidex](https://github.com/Squidex/squidex) ⭐ 2,511 | 🐛 4 | 🌐 C# | 📅 2026-08-05 - Headless CMS, based on MongoDB, CQRS and Event Sourcing.
* [Piranha CMS](https://github.com/piranhacms/piranha.core) ⭐ 2,189 | 🐛 99 | 🌐 C# | 📅 2026-08-09 - A Lightweight & Unobtrusive Open Source CMS for ASP.NET Core and Entity Framework Core.
...
* [dasblog-core](https://github.com/poppastring/dasblog-core) ⭐ 480 | 🐛 15 | 🌐 C# | 📅 2026-08-05 - The original DasBlog reimagined with ASP.NET Core
...
* [Swastika I/O Core CMS](https://github.com/Swastika-IO/Swastika-IO-Core) ⭐ 134 | 🐛 19 | 🌐 C# | 📅 2022-09-14 - Open source ASP.NET Core 2.x CMS. It currently supports MS SQL and planned to implement MSSQL, SQLite in the near future. It has many built-in features out of the box like multilanguage support, theme, template...
...
* [awesome-static-analysis](https://github.com/mre/awesome-static-analysis) ⭐ 14,730 | 🐛 25 | 🌐 Rust | 📅 2026-06-10 - Curated list of static analysis tools, linters and code quality checkers for various programming languages.
* Code Analysis
  * [StyleCopAnalyzers](https://github.com/DotNetAnalyzers/StyleCopAnalyzers) ⭐ 2,855 | 🐛 450 | 🌐 C# | 📅 2025-12-31 - StyleCop rules using the .NET Compiler Platform.
  * [roslyn-analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,672 | 🐛 1,064 | 📅 2026-08-10 - .NET Compiler Platform ("Roslyn") Analyzers.
  ...
  * [DevSkim](https://github.com/Microsoft/DevSkim) ⭐ 1,002 | 🐛 75 | 🌐 C# | 📅 2026-08-12 - A set of IDE plugins and rules that provide security "linting" capabilities.
...
* Metrics
  ...
  * [coverlet](https://github.com/tonerdo/coverlet) ⭐ 3,172 | 🐛 10 | 🌐 C# | 📅 2026-08-08 - Cross platform code coverage library for .NET Core.
  * [Audit.NET](https://github.com/thepirat000/Audit.NET) ⭐ 2,640 | 🐛 5 | 🌐 C# | 📅 2026-06-12 - Small framework to audit .NET object changes.
  ...
  * [Foundatio](https://github.com/exceptionless/Foundatio#metrics) ⭐ 2,096 | 🐛 18 | 🌐 C# | 📅 2026-08-11 - A common interface with in memory, redis, StatsD, and Metrics.NET implementations.
  ...
  * [Prometheus.Client](https://github.com/PrometheusClientNet/Prometheus.Client) ⭐ 142 | 🐛 1 | 🌐 C# | 📅 2026-08-12 - .NET Client for [Prometheus](https://prometheus.io).
    * [Prometheus.Client.MetricPusher](https://github.com/PrometheusClientNet/Prometheus.Client.MetricPusher) ⭐ 19 | 🐛 1 | 🌐 C# | 📅 2026-08-12 -  Push metrics to a PushGateaway for the Prometheus.Client.
    * [Prometheus.Client.MetricServer](https://github.com/PrometheusClientNet/Prometheus.Client.MetricServer) ⭐ 16 | 🐛 1 | 🌐 C# | 📅 2026-08-12 -  MetricServer for the Prometheus.Client.
    * [Prometheus.Client.HttpRequestDurations](https://github.com/PrometheusClientNet/Prometheus.Client.HttpRequestDurations) ⭐ 11 | 🐛 1 | 🌐 C# | 📅 2026-08-12 -  Metrics logging of request durations for the Prometheus.Client.
    * [Prometheus.Client.AspNetCore](https://github.com/PrometheusClientNet/Prometheus.Client.AspNetCore) ⭐ 10 | 🐛 1 | 🌐 C# | 📅 2026-08-12 -  Middleware for the Prometheus.Client.
...
* [sharpcompress](https://github.com/adamhathcock/sharpcompress) ⭐ 2,577 | 🐛 294 | 🌐 C# | 📅 2026-08-07 - Fully managed C# library to deal with many compression types and formats.
* [lz4net](https://github.com/MiloszKrajewski/K4os.Compression.LZ4) ⭐ 811 | 🐛 17 | 🌐 C# | 📅 2026-03-28 - Ultra fast compression algorithm for all .NET platforms.

### Compilers, Transpilers and Languages

* [roslyn](https://github.com/dotnet/roslyn) ⭐ 20,608 | 🐛 6,285 | 🌐 C# | 📅 2026-08-13 - The .NET Compiler Platform ("Roslyn") provides open-source C# and Visual Basic compilers with rich code analysis APIs.
* [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,143 | 🐛 169 | 🌐 F# | 📅 2026-08-12 - F# to JavaScript Compiler.
* [peachpie](https://github.com/peachpiecompiler/peachpie) ⭐ 2,486 | 🐛 90 | 🌐 C# | 📅 2026-06-09 - Open-source PHP compiler to .NET.
* [Sprache](https://github.com/sprache/Sprache) ⭐ 2,471 | 🐛 22 | 🌐 C# | 📅 2024-04-18 - Tiny C# Monadic Parser Framework.
...
* [fparsec](https://github.com/stephan-tolksdorf/fparsec) ⭐ 557 | 🐛 30 | 🌐 F# | 📅 2023-11-13 - A parser combinatory library for F# and C#.
...
* [BCrypt.Net](https://github.com/BcryptNet/bcrypt.net) ⭐ 996 | 🐛 5 | 🌐 C# | 📅 2026-07-09 - Bringing updates to the original bcrypt package.
...
* [LiteDB](https://github.com/mbdavid/LiteDB) ⭐ 9,451 | 🐛 752 | 🌐 C# | 📅 2026-08-11 - .NET NoSQL Document Store in a single data file - <http://www.litedb.org>.
* [marten](https://github.com/JasperFx/marten) ⭐ 3,440 | 🐛 2 | 🌐 C# | 📅 2026-08-11 - Postgresql as a Document Database and Event Store for .NET Applications <http://jasperfx.github.io/marten>.
* [yessql](https://github.com/sebastienros/yessql) ⭐ 1,357 | 🐛 149 | 🌐 C# | 📅 2026-08-10 - .NET document database working on any RDBMS.
* [DBreeze](https://github.com/hhblaze/DBreeze) ⭐ 577 | 🐛 1 | 🌐 C# | 📅 2026-07-11 - C# .NET MONO NOSQL (key value store embedded) ACID multi-paradigm database management system.
...
* [npgsql](https://github.com/npgsql/npgsql) ⭐ 3,722 | 🐛 224 | 🌐 C# | 📅 2026-08-12 - .NET data provider for PostgreSQL. It allows any program developed for .NET framework to access a PostgreSQL database server. It is implemented in 100% C# code. PostgreSQL versions since 9.1 are officially supported, others may work. <http://www.npgsql.org>
* [MongoDB.Driver](https://github.com/mongodb/mongo-csharp-driver) ⭐ 3,241 | 🐛 14 | 🌐 C# | 📅 2026-08-12 - .NET Driver for MongoDB.
* [cassandra-csharp-driver](https://github.com/datastax/csharp-driver) ⭐ 669 | 🐛 14 | 🌐 C# | 📅 2026-04-02 - DataStax C# Driver for Apache Cassandra.
...
* [ravendb](https://github.com/ayende/ravendb/tree/v4.0) ⭐ 296 | 🐛 20 | 🌐 C# | 📅 2026-08-12 - Linq enabled document database for .NET.
* [confluent-kafka-dotnet](https://github.com/confluentinc/confluent-kafka-dotnet) ⭐ 268 | 🐛 476 | 🌐 C# | 📅 2026-08-13 - Confluent's Apache Kafka .NET client.
...
* Neo4j
  ...
  * [neo4j-dotnet-driver](https://github.com/neo4j/neo4j-dotnet-driver) ⭐ 247 | 🐛 4 | 🌐 C# | 📅 2026-07-24 - Neo4j Bolt driver for .NET.

### Database Tools and Utilities

* [fluentmigrator](https://github.com/fluentmigrator/fluentmigrator) ⭐ 3,506 | 🐛 208 | 🌐 C# | 📅 2026-08-12 - Migration framework for .NET much like Ruby on Rails Migrations.
...
* [EFCorePowerTools](https://github.com/ErikEJ/EFCorePowerTools) ⭐ 2,507 | 🐛 3 | 🌐 C# | 📅 2026-08-12 - Entity Framework Core Power Tools - reverse engineering, migrations and model visualization for EF Core.
...
* [Evolve](https://github.com/lecaillon/Evolve) ⭐ 906 | 🐛 46 | 🌐 C# | 📅 2025-09-30 - Simple database migration tool that uses plain SQL scripts. Inspired by Flyway.
...
* [Mongo.Migration](https://github.com/SRoddis/Mongo.Migration) ⭐ 183 | 🐛 34 | 🌐 C# | 📅 2026-03-18 - Mongo.Migration is designed for the [MongoDB C# Driver](https://github.com/mongodb/mongo-csharp-driver) ⭐ 3,241 | 🐛 14 | 🌐 C# | 📅 2026-08-12 to migrate your documents easily and on-the-fly. No more downtime for schema-migrations. Just write small and simple migrations. [Link](https://github.com/SRoddis/Mongo.Migration) ⭐ 183 | 🐛 34 | 🌐 C# | 📅 2026-03-18
...
* [nodatime](https://github.com/nodatime/nodatime) ⭐ 2,994 | 🐛 34 | 🌐 C# | 📅 2026-07-16 - Better date and time API for .NET <http://nodatime.org>.
...
* [Polly](https://github.com/App-vNext/Polly) ⭐ 14,225 | 🐛 5 | 🌐 C# | 📅 2026-08-12 - .NET 3.5 / 4.0 / 4.5 / PCL library that allows developers to express transient exception and fault handling policies such as Retry, Retry Forever, Wait and Retry or Circuit Breaker in a fluent manner
* [Ocelot](https://github.com/ThreeMammals/Ocelot) ⭐ 8,714 | 🐛 60 | 🌐 C# | 📅 2026-08-12 - API Gateway created using .NET Core
* [AspNetCore.Diagnostics.HealthChecks](https://github.com/xabaril/AspNetCore.Diagnostics.HealthChecks) ⭐ 4,371 | 🐛 379 | 🌐 C# | 📅 2026-06-22 - Enterprise HealthChecks for ASP.NET Core Diagnostics Package
...
* [nopCommerce](https://github.com/nopSolutions/nopCommerce) ⭐ 10,121 | 🐛 164 | 🌐 C# | 📅 2026-08-12 - Free open-source ecommerce shopping cart (ASP.NET MVC / ASP.NET Core MVC ) with a vast community and a market place full of new features, themes and plugins.
...
* [GrandNode](https://github.com/grandnode/grandnode) ⚠️ Archived - Multi-platform, free, open source ecommerce shopping cart based on ASP.NET Core 2.1 and MongoDB derived from [nopCommerce](https://github.com/nopSolutions/nopCommerce) ⭐ 10,121 | 🐛 164 | 🌐 C# | 📅 2026-08-12.
...
* [Sentry](https://github.com/getsentry/sentry-dotnet) ⭐ 771 | 🐛 321 | 🌐 C# | 📅 2026-08-13 - .NET SDK for Sentry, an Open-source error tracking that helps developers monitor and fix crashes in real time.
...
* [ReactiveUI](https://github.com/reactiveui/ReactiveUI) ⭐ 8,529 | 🐛 4 | 🌐 C# | 📅 2026-08-13 - A MVVM framework that integrates with the Reactive Extensions for .NET to create elegant, testable User Interfaces that run on any mobile or desktop platform.
* [Rx.NET](https://github.com/Reactive-Extensions/Rx.NET) ⭐ 7,186 | 🐛 180 | 🌐 C# | 📅 2026-07-17 - The [Reactive Extensions](http://reactivex.io) for .NET.
* [language-ext](https://github.com/louthy/language-ext) ⭐ 7,078 | 🐛 15 | 🌐 C# | 📅 2026-07-29 - C# functional language extensions and 'Erlang like' concurrency system.
...
* [Giraffe](https://github.com/dustinmoris/Giraffe) ⭐ 2,250 | 🐛 46 | 🌐 F# | 📅 2026-08-12 - A native functional ASP.NET Core web framework for F# developers.
* [DynamicData](https://github.com/RolandPheasant/DynamicData) ⭐ 1,896 | 🐛 54 | 🌐 C# | 📅 2026-08-08 - Reactive collections based on Rx.NET.
...
* [sodium](https://github.com/SodiumFRP/sodium/tree/master/) ⭐ 851 | 🐛 28 | 🌐 C# | 📅 2026-03-27 - Functional Reactive Programming (FRP) Library. `4.x.x or above`
...
* [ImageSharp](https://github.com/SixLabors/ImageSharp) ⭐ 8,026 | 🐛 18 | 🌐 C# | 📅 2026-08-11 - Cross-platform library for processing of image files written in C#.
* [QRCoder](https://github.com/codebude/QRCoder) ⭐ 5,153 | 🐛 28 | 🌐 C# | 📅 2026-07-23 - A pure C# Open Source QR Code implementation.
* [Magick.NET](https://github.com/dlemstra/Magick.NET) ⭐ 3,970 | 🐛 53 | 🌐 C# | 📅 2026-08-13 - The .NET library for ImageMagick.
* [ZXing.Net](https://github.com/micjahn/ZXing.Net/) ⭐ 3,084 | 🐛 77 | 🌐 C# | 📅 2026-07-06 - .Net port of the original java-based barcode reader and generator library zxing.
* [veldrid](https://github.com/mellinoe/veldrid) ⭐ 2,695 | 🐛 159 | 🌐 C# | 📅 2026-03-17 - A low-level, hardware-accelerated 3D graphics library for .NET.
...
* [LibVLCSharp](https://github.com/videolan/libvlcsharp) ⭐ 1,804 | 🐛 5 | 🌐 C# | 📅 2026-08-05: .NET/Mono bindings for libvlc, the multimedia framework powering the VLC applications made by VideoLAN.
* [MagicScaler](https://github.com/saucecontrol/PhotoSauce) ⭐ 733 | 🐛 22 | 🌐 C# | 📅 2025-04-10 - MagicScaler high-performance, high-quality image processing pipeline for .NET
...
* [Avalonia](https://github.com/AvaloniaUI/Avalonia) ⭐ 31,313 | 🐛 1,923 | 🌐 C# | 📅 2026-08-13 - A multi-platform .NET UI framework (formerly known as Perspex).
...
* [AvaloniaEdit](https://github.com/AvaloniaUI/AvaloniaEdit/) ⭐ 1,122 | 🐛 88 | 🌐 C# | 📅 2026-06-05 - The Avalonia-based text editor component forked from [AvalonEdit](https://github.com/icsharpcode/AvalonEdit) ⭐ 2,077 | 🐛 114 | 🌐 C# | 📅 2025-12-04
  [HandyControls](https://github.com/ghost1372/HandyControls) ⭐ 1,303 | 🐛 11 | 🌐 C# | 📅 2026-05-28 - Contains some simple and commonly used WPF controls.
...
* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 188,650 | 🐛 19,818 | 🌐 TypeScript | 📅 2026-08-13 - New type of tool that combines the simplicity of a code editor with what developers need for their core edit-build-debug cycle. Code provides comprehensive editing and debugging support, an extensibility model, and lightweight integration with existing tools.
...
* [Westwind.Globalization](https://github.com/RickStrahl/Westwind.Globalization) ⭐ 550 | 🐛 73 | 🌐 C# | 📅 2023-03-19 - Database driven resource localization for .NET applications.
...
* [DryIoc](https://github.com/dadhi/DryIoc) ⭐ 1,128 | 🐛 55 | 🌐 C# | 📅 2026-05-28 - Fast, small, full-featured IoC Container for .NET.
...
* [serilog](https://github.com/serilog/serilog) ⭐ 8,033 | 🐛 17 | 🌐 C# | 📅 2026-07-31 - Simple .NET logging with fully-structured events.
  * [serilog-aspnetcore](https://github.com/serilog/serilog-aspnetcore) ⭐ 1,428 | 🐛 23 | 🌐 C# | 📅 2025-11-28 - Serilog integration for ASP.NET Core 2+.
...
* [NLog](https://github.com/NLog/NLog) ⭐ 6,544 | 🐛 55 | 🌐 C# | 📅 2026-08-12 - Advanced .NET, Silverlight and Xamarin Logging with support for structured and non structured logging.
  * [NLog.Extensions.Logging](https://github.com/NLog/NLog.Extensions.Logging) ⭐ 401 | 🐛 2 | 🌐 C# | 📅 2026-08-12 - NLog Provider for Microsoft.Extensions.Logging for .NET Standard libraries and .NET Core applications
  * [NLog for ASP.NET and ASP.NET Core](https://github.com/NLog/NLog.Web) ⭐ 329 | 🐛 10 | 🌐 C# | 📅 2026-08-12 - NLog integration for ASP.NET & ASP.NET Core 1-3
...
* [Foundatio](https://github.com/exceptionless/Foundatio#logging) ⭐ 2,096 | 🐛 18 | 🌐 C# | 📅 2026-08-11 - A fluent logging api that can be used to log messages throughout your application.
* [log4net](https://github.com/apache/logging-log4net) ⭐ 933 | 🐛 7 | 🌐 C# | 📅 2026-08-06 - log4net is a port of the excellent Apache log4j™ framework to the Microsoft® .NET runtime.
...
* [common-logging](https://github.com/net-commons/common-logging) ⭐ 650 | 🐛 62 | 🌐 C# | 📅 2021-09-23 - Portable logging abstraction for .NET.
* [Exceptionless](https://github.com/exceptionless/Exceptionless.Net) ⭐ 572 | 🐛 13 | 🌐 C# | 📅 2026-08-13 - Exceptionless .NET Client
...
* [WaveFunctionCollapse](https://github.com/mxgmn/WaveFunctionCollapse) ⭐ 25,256 | 🐛 9 | 🌐 C# | 📅 2026-03-22 - itmap & tilemap generation from a single example with the help of ideas from quantum mechanics.
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,346 | 🐛 1,010 | 🌐 C# | 📅 2026-08-12 - Cross-platform open-source machine learning framework which makes machine learning accessible to .NET developers <http://dot.net/ml>.
...
* [MailKit](https://github.com/jstedfast/MailKit) ⭐ 6,839 | 🐛 11 | 🌐 C# | 📅 2026-06-12 - Cross-platform .NET library for IMAP, POP3, and SMTP.
* [Papercut](https://github.com/ChangemakerStudios/Papercut) ⭐ 3,324 | 🐛 13 | 🌐 C# | 📅 2026-08-12 - Simple Desktop SMTP Server
* [FluentEmail](https://github.com/lukencode/FluentEmail) ⭐ 3,214 | 🐛 130 | 🌐 C# | 📅 2024-03-30 - All in one email sender for .NET and .NET Core
* [MimeKit](https://github.com/jstedfast/MimeKit) ⭐ 1,998 | 🐛 15 | 🌐 C# | 📅 2026-08-03 - Cross-platform .NET MIME creation and parser library with support for S/MIME, PGP, DKIM, TNEF and Unix mbox spools.
...
* [UnitsNet](https://github.com/angularsen/UnitsNet) ⭐ 2,965 | 🐛 19 | 🌐 C# | 📅 2026-08-02 - Units.NET gives you all the common units of measurement and the conversions between them.
...
* [AutoMapper](https://github.com/AutoMapper/AutoMapper) ⭐ 10,197 | 🐛 4 | 🌐 C# | 📅 2026-07-02 - Convention-based object-object mapper in .NET.
* [Humanizer](https://github.com/Humanizr/Humanizer) ⭐ 9,804 | 🐛 6 | 🌐 C# | 📅 2026-08-12 - Humanizer meets all your .NET needs for manipulating and displaying strings, enums, dates, times, timespans, numbers and quantities.
* [AngleSharp](https://github.com/AngleSharp/AngleSharp) ⭐ 5,527 | 🐛 8 | 🌐 C# | 📅 2026-08-08 - The ultimate angle brackets parser library. It parses HTML5, MathML, SVG and CSS to construct a DOM based on the official W3C specification. Comparable to beautifulsoup4 of python.
* [markdig](https://github.com/lunet-io/markdig) ⭐ 5,300 | 🐛 115 | 🌐 C# | 📅 2026-06-18 - Fast, powerfull, CommonMark compliant, extensible Markdown processor for .NET.
...
* [PuppeteerSharp](https://github.com/kblok/puppeteer-sharp) ⭐ 3,913 | 🐛 12 | 🌐 C# | 📅 2026-08-11 - Puppeteer Sharp is a .NET port of the official Node.JS Puppeteer API.
...
* [FluentFTP](https://github.com/robinrodricks/FluentFTP/) ⭐ 3,390 | 🐛 21 | 🌐 C# | 📅 2026-05-27 - FTP and FTPS client, with extensive FTP commands, SSL/TLS connections, hashing/checksums and more.
...
* [Vanara](https://github.com/dahall/Vanara) ⭐ 2,089 | 🐛 7 | 🌐 C# | 📅 2026-08-12 - A set of .NET libraries for Windows implementing PInvoke calls to many native Windows APIs with supporting wrappers.
...
* [Downloader](https://github.com/bezzad/Downloader) ⭐ 1,697 | 🐛 0 | 🌐 C# | 📅 2026-08-09 - Downloader is a modern, fluent, asynchronous, testable and portable library for .NET. This is a multipart downloader with asynchronous progress events.
* [Dotnet outdated](https://github.com/dotnet-outdated/dotnet-outdated) ⭐ 1,690 | 🐛 118 | 🌐 C# | 📅 2026-08-12 - A .NET Core global tool to display and update outdated NuGet packages in a project
* [Scientist](https://github.com/github/Scientist.net) ⭐ 1,486 | 🐛 12 | 🌐 C# | 📅 2025-11-26 - .NET library for carefully refactoring critical paths. It's a port of GitHub's Ruby Scientist library.
...
* [FastExpressionCompiler](https://github.com/dadhi/FastExpressionCompiler) ⭐ 1,372 | 🐛 23 | 🌐 C# | 📅 2026-08-12 - Fast ExpressionTree compiler to delegate.
* [Otp.NET](https://github.com/kspearrin/Otp.NET) ⭐ 1,315 | 🐛 20 | 🌐 C# | 📅 2025-12-01 - An implementation TOTP RFC 6238 and HOTP RFC 4226 in C#.
...
* [Bullseye](https://github.com/adamralph/bullseye/) ⭐ 955 | 🐛 13 | 🌐 C# | 📅 2026-07-21 - A .NET package for describing and running targets and their dependencies.
...
* [dotnet-env](https://github.com/tonerdo/dotnet-env) ⭐ 558 | 🐛 1 | 🌐 C# | 📅 2026-04-26 - A .NET library to load environment variables from .env files.
...
* [ReverseMarkdown](https://github.com/mysticmind/reversemarkdown-net) ⭐ 396 | 🐛 0 | 🌐 HTML | 📅 2026-07-28 - Html to Markdown converter library.
...
* [PdfReport.Core](https://github.com/VahidN/PdfReport.Core) ⭐ 372 | 🐛 7 | 🌐 C# | 📅 2026-08-12 - PdfReport.Core is a code first reporting engine, which is built on top of the iTextSharp.LGPLv2.Core and EPPlus.Core libraries.
...
* [NuGet Trends](https://github.com/NuGetTrends/nuget-trends) ⭐ 187 | 🐛 35 | 🌐 C# | 📅 2026-03-16 - Website with statistics of NuGet packages download count.
...
* [Open-XML-SDK](https://github.com/OfficeDev/Open-XML-SDK) ⭐ 4,577 | 🐛 123 | 🌐 C# | 📅 2026-08-12 - The Open XML SDK provides tools for working with Office Word, Excel, and PowerPoint documents.
* [EPPlus](https://github.com/EPPlusSoftware/EPPlus) ⭐ 2,029 | 🐛 91 | 🌐 C# | 📅 2026-08-12 - Create advanced Excel spreadsheets using .NET.
...
* [CosmosOS](https://github.com/CosmosOS/Cosmos) ⭐ 3,180 | 🐛 138 | 🌐 C# | 📅 2026-08-08 - Cosmos is an operating system "construction kit". Build your own OS using managed languages such as C#, VB.NET, and more!

### ORM

* [Dapper](https://github.com/StackExchange/Dapper) ⭐ 18,365 | 🐛 547 | 🌐 C# | 📅 2026-05-16 - Simple object mapper for .NET.
  * [MicroOrm.Dapper.Repositories](https://github.com/phnx47/MicroOrm.Dapper.Repositories) ⭐ 705 | 🐛 2 | 🌐 C# | 📅 2026-08-11 - CRUD for Dapper.
  * [Dommel](https://github.com/henkmollema/Dommel) ⭐ 691 | 🐛 9 | 🌐 C# | 📅 2026-06-24 - Simple CRUD operations for Dapper.
...
* [Entity Framework Core](https://github.com/aspnet/EntityFramework) ⭐ 14,769 | 🐛 2,364 | 🌐 C# | 📅 2026-08-13 - Familiar developer experience to previous versions of EF, including LINQ, POCO, and Code First support.
  * [EFCore.BulkExtensions](https://github.com/borisdj/EFCore.BulkExtensions) ⭐ 3,999 | 🐛 127 | 🌐 C# | 📅 2026-08-01 - EntityFrameworkCore Bulk Batch Extensions for Insert Update Delete Read (CRUD) ops
  ...
  * [EntityFramework-Plus](https://github.com/zzzprojects/EntityFramework-Plus) ⭐ 2,340 | 🐛 138 | 🌐 C# | 📅 2026-07-14 - Entity Framework Utilities | Bulk Operations | Batch Delete | Batch Update | Query Cache | Query Filter | Query Future | Query Include | Audit.
  * [Npgsql.EntityFrameworkCore.PostgreSQL](https://github.com/npgsql/Npgsql.EntityFrameworkCore.PostgreSQL) ⭐ 1,838 | 🐛 293 | 🌐 C# | 📅 2026-07-23 - Entity Framework Core provider for PostgreSQL.
  ...
  * [EntityFramework.Exceptions](https://github.com/Giorgi/EntityFramework.Exceptions) ⭐ 1,733 | 🐛 2 | 🌐 C# | 📅 2026-03-29 - Use typed Exceptions for EntityFrameworkCore when your SQL query violates database constraints in SqlServer, MySql, or PostgreSQL.
  ...
  * [EntityFramework.VersionedProperties](https://github.com/NickStrupat/EntityFramework.VersionedProperties) ⭐ 43 | 🐛 1 | 🌐 C# | 📅 2021-08-06 - Classes which auto-magically keep an audit history of the changes to the specified property.
...
* [querybuilder](https://github.com/sqlkata/querybuilder) ⭐ 3,375 | 🐛 179 | 🌐 C# | 📅 2026-04-10 - SqlKata Query Builder is a powerful Sql Query Builder written in C#.
* [nhibernate-core](https://github.com/nhibernate/nhibernate-core) ⭐ 2,172 | 🐛 676 | 🌐 C# | 📅 2026-08-13 - NHibernate Object Relational Mapper.
* [PetaPoco](https://github.com/CollaboratingPlatypus/PetaPoco) ⭐ 2,140 | 🐛 111 | 🌐 C# | 📅 2025-11-30 - A tiny ORM-ish thing for your POCO's.
...
* [SmartSql](https://github.com/Ahoo-Wang/SmartSql) ⭐ 1,131 | 🐛 41 | 🌐 C# | 📅 2026-08-09 - SmartSql = MyBatis + Cache(Memory | Redis) + ZooKeeper + R/W Splitting +Dynamic Repository ....
...
* [SqlKata](https://github.com/sqlkata/querybuilder) ⭐ 3,375 | 🐛 179 | 🌐 C# | 📅 2026-04-10 - Elegant Sql Query Builder, that supports complex queries, joins, sub queries, nested where conditions, vendor engine targets and more
...
* [MQTTnet](https://github.com/chkr1011/MQTTnet) ⭐ 5,052 | 🐛 190 | 🌐 C# | 📅 2026-08-09 - MQTTnet is a high performance .NET library for MQTT based communication.
...
* [rabbitmq-dotnet-client](https://github.com/rabbitmq/rabbitmq-dotnet-client) ⭐ 2,277 | 🐛 58 | 🌐 C# | 📅 2026-08-13 - RabbitMQ .NET client <https://www.rabbitmq.com>.
* [NServiceBus](https://github.com/particular/nservicebus) ⭐ 2,167 | 🐛 290 | 🌐 C# | 📅 2026-08-13 - NServiceBus is part of the [Particular Service Platform](https://particular.net/service-platform), which contains tools to build, monitor, and debug distributed systems.
* [Foundatio](https://github.com/exceptionless/Foundatio#queues) ⭐ 2,096 | 🐛 18 | 🌐 C# | 📅 2026-08-11 - A common interface with in memory, redis and azure implementations.
* [RawRabbit](https://github.com/pardahlman/RawRabbit) ⭐ 741 | 🐛 56 | 🌐 C# | 📅 2022-12-07 - Modern .NET framework for communication over RabbitMq.
...
* [Silverback](https://github.com/BEagle1984/silverback) ⭐ 284 | 🐛 13 | 🌐 C# | 📅 2026-08-11 - Framework to build event-driven applications (support for Kafka, RabbitMQ, MQTT).
...
* [FastReport](https://github.com/FastReports/FastReport) ⭐ 3,083 | 🐛 24 | 🌐 C# | 📅 2026-06-11 - The open source report generator for .NET Core 2.x/.Net Framework 4.x. FastReport can be used in MVC, Web API applications.

### Scheduler and Job

* [HangfireIO](https://github.com/HangfireIO/Hangfire) ⭐ 10,117 | 🐛 943 | 🌐 C# | 📅 2026-07-20 - Easy way to perform fire-and-forget, delayed and recurring tasks inside ASP.NET apps <http://hangfire.io>.
* [quartznet](https://github.com/quartznet/quartznet/) ⭐ 7,069 | 🐛 23 | 🌐 C# | 📅 2026-08-11 - Quartz Enterprise Scheduler .NET <http://www.quartz-scheduler.net>.
* [stateless](https://github.com/dotnet-state-machine/stateless) ⭐ 6,237 | 🐛 81 | 🌐 C# | 📅 2026-04-04 - Simple library for creating state machines in C# code.
* [Coravel](https://github.com/jamesmh/coravel) ⭐ 4,283 | 🐛 84 | 🌐 C# | 📅 2025-07-20 - .Net Core meets Laravel: Scheduling, Queuing, etc.
...
* [octokit.net](https://github.com/octokit/octokit.net) ⭐ 2,856 | 🐛 43 | 🌐 C# | 📅 2026-08-10 - GitHub API client library for .NET.
...
* [google-cloud-dotnet](https://github.com/GoogleCloudPlatform/google-cloud-dotnet) ⭐ 1,090 | 🐛 19 | 🌐 C# | 📅 2026-08-13 - Google Cloud Client Libraries for .NET.
...
* [firebase-admin-dotnet](https://github.com/firebase/firebase-admin-dotnet) ⭐ 408 | 🐛 64 | 🌐 C# | 📅 2026-07-29 - Firebase Admin .NET SDK
* [AWS SDK](https://github.com/aws/aws-sdk-net) ⭐ 131 | 🐛 38 | 🌐 C# | 📅 2026-08-12 - The Amazon Web Services (AWS) .NET Core SDK components. Each AWS service has its own NuGet package.
...
* [statsd-csharp-client](https://github.com/Pereingo/statsd-csharp-client) ⚠️ Archived - .NET Standard compatible C# client to interface with Etsy's excellent [statsd](https://github.com/etsy/statsd) ⭐ 18,069 | 🐛 90 | 🌐 JavaScript | 📅 2025-05-20 server.
...
* Blockchain clients
  * [Binance.Net](https://github.com/JKorf/Binance.Net) ⭐ 1,174 | 🐛 13 | 🌐 C# | 📅 2026-08-11 - .Net API wrapper for the Binance web API.
  * [Bittrex.Net](https://github.com/JKorf/Bittrex.Net) ⚠️ Archived - C# .Net wrapper for the Bittrex web API including all features easily accessible and usable.

### Security

* [Jwt.Net](https://github.com/jwt-dotnet/jwt) ⭐ 2,194 | 🐛 10 | 🌐 C# | 📅 2026-08-12 - Jwt.Net, a JWT (JSON Web Token) implementation for .NET.
* [HtmlSanitizer](https://github.com/mganss/HtmlSanitizer) ⭐ 1,707 | 🐛 24 | 🌐 C# | 📅 2026-08-12 - Cleans HTML to avoid XSS attacks.
...
* [SecurityHeaders](https://github.com/andrewlock/NetEscapades.AspNetCore.SecurityHeaders) ⭐ 854 | 🐛 3 | 🌐 C# | 📅 2026-07-22 - Small package to allow adding security headers to ASP.NET Core websites.
* [NWebsec](https://github.com/NWebsec/NWebsec) ⭐ 550 | 🐛 48 | 🌐 C# | 📅 2023-03-03 - Security libraries for ASP.NET <http://www.nwebsec.com>.
* [OwaspHeaders](https://github.com/GaProgMan/OwaspHeaders.Core) ⭐ 314 | 🐛 15 | 🌐 C# | 📅 2026-06-23 - .NET Core middleware for injecting the Owasp recommended HTTP Headers for increased security.
...
* [Elasticsearch.Net & NEST](https://github.com/elastic/elasticsearch-net) ⭐ 3,648 | 🐛 70 | 🌐 C# | 📅 2026-08-07 - Repository for both NEST and Elasticsearch.NET, the two official elasticsearch .NET clients.
...
* [ElasticsearchCRUD](https://github.com/damienbod/ElasticsearchCRUD) ⭐ 178 | 🐛 33 | 🌐 C# | 📅 2020-10-01 - Elasticsearch .NET API.
...
* [Algolia.Search](https://github.com/algolia/algoliasearch-client-csharp) ⭐ 128 | 🐛 5 | 🌐 C# | 📅 2026-08-11 - Repository for the official Algolia .NET client.
...
* [CsvHelper](https://github.com/JoshClose/CsvHelper) ⭐ 5,210 | 🐛 352 | 🌐 C# | 📅 2025-06-27 - Library to help reading and writing CSV files.
* [protobuf-net](https://github.com/mgravell/protobuf-net/) ⭐ 4,965 | 🐛 541 | 🌐 C# | 📅 2026-08-13 - Protocol Buffers library for idiomatic .NET.
* [YamlDotNet](https://github.com/aaubry/YamlDotNet) ⭐ 2,852 | 🐛 139 | 🌐 C# | 📅 2026-06-26 - .NET
...
* [Jil](https://github.com/kevin-montrose/Jil) ⭐ 2,141 | 🐛 54 | 🌐 C# | 📅 2024-04-17 - Fast .NET JSON (De)Serializer, Built On Sigil.
* [ServiceStack.Text](https://github.com/ServiceStack/ServiceStack.Text) ⚠️ Archived - JSON, JSV and CSV Text Serializers.
* [Schema.NET](https://github.com/RehanSaeed/Schema.NET) ⭐ 686 | 🐛 66 | 🌐 C# | 📅 2026-08-12 - Schema.org objects turned into strongly typed C# POCO classes for use in .NET. All classes can be serialized into JSON/JSON-LD and XML, typically used to represent structured data in the head section of html page.
...
* MessagePack
  * [MessagePack-CSharp](https://github.com/neuecc/MessagePack-CSharp) ⭐ 6,769 | 🐛 145 | 🌐 C# | 📅 2026-08-07 - Extremely Fast MessagePack Serializer for C#(.NET, .NET Core, Unity, Xamarin).
...
* [fluid](https://github.com/sebastienros/fluid) ⭐ 1,768 | 🐛 35 | 🌐 C# | 📅 2026-08-10 - Open-source .NET template engine that is as close as possible to the Liquid template language.
...
* [Bogus](https://github.com/bchavez/Bogus) ⭐ 9,726 | 🐛 91 | 🌐 C# | 📅 2025-12-22 - Simple and sane fake data generator for C#. Based on and ported from the famed faker.js.
* [moq.netcore](https://github.com/Moq/moq4) ⭐ 6,400 | 🐛 19 | 🌐 C# | 📅 2026-08-12 - Most popular and friendly mocking framework for .NET.
...
* [FluentAssertions](https://github.com/fluentassertions/fluentassertions) ⭐ 3,816 | 🐛 71 | 🌐 C# | 📅 2026-08-10 - Set of .NET extension methods that allow you to more naturally specify the expected outcome of a TDD or BDD-style test.
* [shouldly](https://github.com/shouldly/shouldly) ⭐ 3,404 | 🐛 92 | 🌐 C# | 📅 2026-08-12 - Should testing for .NET - the way Asserting *Should* be! <http://shouldly.readthedocs.org/en/latest>
* [NSubstitute](https://github.com/nsubstitute/NSubstitute) ⭐ 2,970 | 🐛 107 | 🌐 C# | 📅 2026-08-11 - A friendly substitute for .NET mocking frameworks.
* [FakeItEasy](https://github.com/FakeItEasy/FakeItEasy) ⭐ 1,844 | 🐛 5 | 🌐 C# | 📅 2026-08-09 - The easy mocking library for .NET.
...
* [LightBDD](https://github.com/LightBDD/LightBDD) ⭐ 474 | 🐛 24 | 🌐 C# | 📅 2026-06-27 - BDD framework allowing to create easy to read and maintain tests.
...
* [ShareX](https://github.com/ShareX/ShareX) ⭐ 39,107 | 🐛 665 | 🌐 C# | 📅 2026-08-12 - Free and open source program that lets you capture or record any area of your screen and share it with a single press of a key. It also allows uploading images, text or other types of files to over 80 supported destinations you can choose from. <https://getsharex.com>

* [scoop](https://github.com/lukesampson/scoop) ⭐ 24,540 | 🐛 536 | 🌐 PowerShell | 📅 2026-06-13 - A command-line installer for Windows.

* [mRemoteNG](https://github.com/mRemoteNG/mRemoteNG) ⭐ 11,045 | 🐛 863 | 🌐 C# | 📅 2026-08-12 - The next generation of mRemote, open source, tabbed, multi-protocol, remote connections manager
...
* [letsencrypt-win-simple](https://github.com/Lone-Coder/letsencrypt-win-simple) ⭐ 5,772 | 🐛 43 | 🌐 C# | 📅 2026-06-09 - A Simple ACME Client for Windows.

* [OctoLinker](https://github.com/OctoLinker/browser-extension) ⭐ 5,387 | 🐛 62 | 🌐 HTML | 📅 2023-10-02 - Navigate through `projects.json` files efficiently with the OctoLinker browser extension for GitHub.

* [docfx](https://github.com/dotnet/docfx) ⭐ 4,443 | 🐛 451 | 🌐 C# | 📅 2026-08-13 - Tools for building and publishing API documentation for .NET projects <http://dotnet.github.io/docfx>

* [SharpZipLib](https://github.com/icsharpcode/SharpZipLib) ⭐ 3,924 | 🐛 118 | 🌐 C# | 📅 2024-09-03 - #ziplib is a Zip, GZip, Tar and BZip2 library written entirely in C# for the .NET platform.

* [System.CommandLine](https://github.com/dotnet/command-line-api) ⭐ 3,672 | 🐛 484 | 🌐 C# | 📅 2026-08-13 - System.CommandLine, a set of libraries for command line parsing, invocation, and rendering of terminal output.

* [SharpLab](https://github.com/ashmind/SharpLab) ⭐ 2,972 | 🐛 488 | 🌐 C# | 📅 2024-11-18 - .NET code playground that shows intermediate steps and results of code compilation. <https://sharplab.io>

* [NuGetPackageExplorer](https://github.com/NuGetPackageExplorer/NuGetPackageExplorer) ⭐ 2,545 | 🐛 108 | 🌐 C# | 📅 2026-08-05 - Create, update and deploy Nuget Packages with a GUI.
...
* [sourcelink](https://github.com/dotnet/sourcelink) ⭐ 1,350 | 🐛 147 | 🌐 C# | 📅 2026-08-13 - SourceLink is a language- and source-control agnostic system for providing first-class source debugging experiences for binaries.
...
* [X.Web.RSS](https://github.com/dncuug/X.Web.RSS) ⭐ 28 | 🐛 0 | 🌐 C# | 📅 2026-07-20 – Simple RSS Feed generator for .NET and .NET Core
...
* [redux.NET](https://github.com/GuillaumeSalles/redux.NET) ⭐ 709 | 🐛 29 | 🌐 C# | 📅 2021-07-28 - Predictable state container for .NET apps. Inspired by <https://github.com/reactjs/redux> ⭐ 61,518 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-02.
* WebAssembly
  * [Blazor](https://github.com/SteveSanderson/Blazor) ⭐ 1,678 | 🐛 7 | 🌐 C# | 📅 2018-02-23 - UI framework running .NET in the browser via WebAssembly.
    * [Awesome Blazor](https://github.com/AdrienTorris/awesome-blazor) ⭐ 9,365 | 🐛 95 | 📅 2026-07-25 - Collection of awesome resources (samples, components, articles, videos and others) about Blazor.
    * [Blazor Redux](https://github.com/torhovland/blazor-redux) ⭐ 480 | 🐛 10 | 🌐 C# | 📅 2022-10-05 - Connecting a Redux state store with Blazor.
  * [Ooui](https://github.com/praeclarum/Ooui) ⭐ 1,622 | 🐛 110 | 🌐 C# | 📅 2022-12-07 - Small cross-platform UI library that brings the simplicity of native UI development to the web.

### Web Socket

* [SuperSocket](https://github.com/kerryjiang/SuperSocket) ⭐ 4,229 | 🐛 211 | 🌐 C# | 📅 2026-04-04 - Light weight, cross platform and extensible socket server application framework.
...
* [dotnet-win32-service](https://github.com/dasMulli/dotnet-win32-service) ⭐ 453 | 🐛 9 | 🌐 C# | 📅 2019-11-06 - Set up and run as Windows Service directly from .NET Core.

### Workflow

* [workflow-core](https://github.com/danielgerlag/workflow-core) ⭐ 5,910 | 🐛 218 | 🌐 C# | 📅 2026-07-15 - Lightweight workflow engine for .NET Standard.
* [WorkflowEngine.NET](https://github.com/optimajet/WorkflowEngine.NET) ⭐ 988 | 🐛 68 | 🌐 C# | 📅 2026-07-16 - Component that adds workflow in your application.
...
* [ASP.NET Core Developer Roadmap](https://github.com/MoienTajik/AspNetCore-Developer-Roadmap) ⭐ 19,632 | 🐛 4 | 📅 2026-01-29 - Roadmap to becoming an ASP.NET Core developer in 2019.

## Starter Kits

* [bitwarden-core](https://github.com/bitwarden/core) ⭐ 19,828 | 🐛 220 | 🌐 C# | 📅 2026-08-13 - The core infrastructure backend (API, database, etc) <https://bitwarden.com>.
...
* Microservices & Service Mesh
  * [eShop](https://github.com/dotnet/eShop) ⭐ 10,772 | 🐛 183 | 🌐 C# | 📅 2026-08-07 - A reference .NET application implementing an eCommerce site.
  ...
  * [Practical.CleanArchitecture](https://github.com/phongnguyend/Practical.CleanArchitecture) ⭐ 2,455 | 🐛 41 | 🌐 C# | 📅 2026-08-04 - Full-stack .Net 8 Clean Architecture (Microservices, Modular Monolith, Monolith), Blazor, Angular 18, React 18, Vue 3, BFF with YARP, Domain-Driven Design, CQRS, SOLID, Asp.Net Core Identity Custom Storage, OpenID Connect, Entity Framework Core, OpenTelemetry, SignalR, Hosted Services, Health Checks, Rate Limiting, Cloud Services (Azure, AWS, GCP).
  ...
  * [clean-architecture-dotnet](https://github.com/thangchung/clean-architecture-dotnet) ⭐ 1,356 | 🐛 12 | 🌐 C# | 📅 2023-04-27 - Apply Minimal Clean Architecture with DDD-lite, CQRS-lite, and just enough Cloud-native patterns on eCommerce sample business domain
...
* Monoliths
  * [MusicStore](https://github.com/dotnet/aspnetcore/tree/master/src/MusicStore) ⭐ 38,370 | 🐛 4,103 | 🌐 C# | 📅 2026-08-13 - Sample MusicStore application that uses MVC and Entity Framework.
  ...
  * [Practical ASP.NET Core](https://github.com/dodyg/practical-aspnetcore) ⭐ 10,407 | 🐛 178 | 🌐 C# | 📅 2026-08-12 - A daily updated micro samples of ASP.NET Core features and facilities.
  ...
  * [Clean Architecture Manga](https://github.com/ivanpaulovich/clean-architecture-manga) ⭐ 4,354 | 🐛 45 | 🌐 C# | 📅 2026-06-22 - Clean Architecture sample with .NET Core 3.0 and C# 8. Use cases as central organising structure, completely testable, decoupled from frameworks.
...
* [awesome-copilot](https://github.com/github/awesome-copilot) ⭐ 37,773 | 🐛 39 | 🌐 Python | 📅 2026-08-13
* Stack Overflow
