...
Inspired by [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,304 | 🐛 106 | 📅 2026-09-02, [awesome-dotnet](https://github.com/quozd/awesome-dotnet) ⭐ 21,595 | 🐛 151 | 📅 2026-03-26,  [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,785 | 🐛 25 | 📅 2026-09-02, [frontend-dev-bookmarks](https://github.com/dypsilon/frontend-dev-bookmarks) ⭐ 47,500 | 🐛 134 | 📅 2024-05-21.

Contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/thangchung/awesome-dotnet-core/blob/master/contributing.md) ⭐ 21,377 | 🐛 214 | 🌐 C# | 📅 2026-02-27 pages first. We accept proprietary and commercial software too.

Thanks to all [contributors](https://github.com/thangchung/awesome-dotnet-core/graphs/contributors) ⭐ 21,377 | 🐛 214 | 🌐 C# | 📅 2026-02-27, you're awesome and wouldn't be possible without you! The goal is to build a categorized community-driven collection of very well-known resources.
...
* [.NET Core SDK](https://www.microsoft.com/net/core) - .NET Core SDK is a general purpose development platform maintained by Microsoft and the .NET community on [GitHub](https://github.com/dotnet/core) ⭐ 22,031 | 🐛 354 | 🌐 PowerShell | 📅 2026-09-11.
...
* [Clean Code .NET/.NET Core](https://github.com/thangchung/clean-code-dotnet) ⭐ 7,735 | 🐛 46 | 🌐 C# | 📅 2026-02-27 - Clean Code concepts adapted for .NET / .NET Core.
...
* [OpenAPI Generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,738 | 🐛 5,756 | 🌐 Java | 📅 2026-09-11 - OpenAPI Generator allows generation of API client libraries (e.g. C#, TypeScript, etc), server stubs (ASP.NET Core, NancyFx, etc), documentation and configuration automatically given an OpenAPI Spec (v2, v3).
* [Restsharp](https://github.com/restsharp/RestSharp) ⭐ 9,825 | 🐛 37 | 🌐 C# | 📅 2026-09-07 - Simple REST and HTTP API Client for .NET
* [NSwag](https://github.com/RSuter/NSwag) ⭐ 7,365 | 🐛 2,056 | 🌐 C# | 📅 2026-09-07 - The Swagger/OpenAPI toolchain for .NET, Web API and TypeScript. <http://NSwag.org>.
...
* [aspnet-api-versioning](https://github.com/Microsoft/aspnet-api-versioning) ⭐ 3,206 | 🐛 6 | 🌐 C# | 📅 2026-09-07 - set of libraries which add service API versioning to ASP.NET Web API, OData with ASP.NET Web API, and ASP.NET Core.
...
* [grpc](https://github.com/grpc/grpc/tree/master/src/csharp) ⭐ 45,306 | 🐛 1,339 | 🌐 C++ | 📅 2026-09-12 - Remote Procedure Calls (RPCs) provide a useful abstraction for building distributed applications and services. The libraries in this repository provide a concrete implementation of the gRPC protocol, layered over HTTP/2. These libraries enable communication between clients and servers using any combination of the supported languages.
* [ASP.NET MVC](https://github.com/dotnet/aspnetcore/tree/master/src/Mvc) ⭐ 38,436 | 🐛 4,163 | 🌐 C# | 📅 2026-09-12 - Model view controller framework for building dynamic web sites with clean separation of concerns, including the merged MVC, Web API, and Web Pages w/ Razor.
* [Abp vNext](https://github.com/abpframework/abp) ⭐ 14,429 | 🐛 312 | 🌐 C# | 📅 2026-09-11 - Abp vNext is the next generation of the open source [ASP.NET Boilerplate](https://github.com/aspnetboilerplate/aspnetboilerplate) ⭐ 12,003 | 🐛 62 | 🌐 C# | 📅 2026-09-11 framework. It's a complete architecture and strong infrastructure to create modern web applications!
...
* [orleans](https://github.com/dotnet/orleans) ⭐ 10,861 | 🐛 633 | 🌐 C# | 📅 2026-09-11 - Framework that provides a straight-forward approach to building distributed high-scale computing applications, without the need to learn and apply complex concurrency or other scaling patterns.
...
* [opencvsharp](https://github.com/shimat/opencvsharp) ⭐ 6,097 | 🐛 6 | 🌐 C# | 📅 2026-09-07 - .NET Framework wrapper for OpenCV.
...
* [akka.net](https://github.com/akkadotnet/akka.net) ⭐ 5,082 | 🐛 449 | 🌐 C# | 📅 2026-09-12 - Toolkit and runtime for building highly concurrent, distributed, and fault tolerant event-driven applications on .NET & Mono.
...
* [Finbuckle.MultiTenant](https://github.com/Finbuckle/Finbuckle.MultiTenant) ⭐ 1,620 | 🐛 34 | 🌐 C# | 📅 2026-09-10 - Finbuckle.MultiTenant is a .NET Standard library for multitenant support designed for ASP.NET 2.0+. It provides functionality for tenant resolution, per-tenant app configuration, and per-tenant data isolation.
...
* [dotvvm](https://github.com/riganti/dotvvm) ⭐ 807 | 🐛 166 | 🌐 C# | 📅 2026-09-11 - Open source MVVM framework for Web Apps.
...
* [Halibut](https://github.com/OctopusDeploy/Halibut) ⭐ 24 | 🐛 51 | 🌐 C# | 📅 2026-09-11 - A secure communication stack for .NET using JSON-RPC over SSL.
...
* [CleanArchitecture (SPA)](https://github.com/JasonGT/CleanArchitecture) ⭐ 20,545 | 🐛 20 | 🌐 C# | 📅 2026-09-07 - Solution template for creating a Single Page App (SPA) with Angular 8 and ASP.NET Core 3 following the principles of Clean Architecture
* [CleanArchitecture](https://github.com/ardalis/CleanArchitecture) ⭐ 18,472 | 🐛 42 | 🌐 C# | 📅 2026-08-23 - A starting point for Clean Architecture with ASP.NET Core. Clean Architecture is just the latest in a series of names for the same loosely-coupled, dependency-inverted architecture. You will also find it named hexagonal, ports-and-adapters, or onion architecture.
* [.NET Boxed](https://github.com/Dotnet-Boxed/Templates) ⭐ 3,485 | 🐛 51 | 🌐 C# | 📅 2026-09-09 - Project templates with batteries included, providing the minimum amount of code required to get you going. Includes ASP.NET Core API and GraphQL Templates.
* [JavaScriptServices](https://github.com/aspnet/JavaScriptServices) ⚠️ Archived - Microsoft ASP.NET Core JavaScript Services.
* [Serenity](https://github.com/volkanceylan/Serenity) ⭐ 2,691 | 🐛 0 | 🌐 C# | 📅 2026-09-12 - Serenity is an ASP.NET MVC / TypeScript application platform designed to simplify and shorten development of data-centric business applications with a service based architecture.
...
* [NEO](https://github.com/neo-project/neo) ⭐ 3,534 | 🐛 263 | 🌐 C# | 📅 2026-09-11 - Open Network For Smart Economy.
* [WalletWasabi](https://github.com/zkSNACKs/WalletWasabi) ⭐ 2,609 | 🐛 328 | 🌐 C# | 📅 2026-09-12 - Privacy focused, ZeroLink compliant Bitcoin wallet.
* [NBitcoin](https://github.com/MetacoSA/NBitcoin) ⭐ 1,939 | 🐛 113 | 🌐 C# | 📅 2026-09-08 - Comprehensive Bitcoin library for the .NET framework.
* [Nethermind](https://github.com/NethermindEth/nethermind) ⭐ 1,594 | 🐛 349 | 🌐 C# | 📅 2026-09-12 - .NET Core Ethereum client
...
* [BotSharp](https://github.com/SciSharp/BotSharp) ⭐ 3,100 | 🐛 49 | 🌐 C# | 📅 2026-09-11 - The Open Source AI Chatbot Platform Builder in 100% C# Running in .NET Core with Machine Learning algorithm.
...
* [msbuild](https://github.com/Microsoft/msbuild) ⭐ 5,548 | 🐛 1,711 | 🌐 C# | 📅 2026-09-11 - The Microsoft Build Engine is a platform for building applications.
...
* [cake-build](https://github.com/cake-build/cake) ⭐ 4,191 | 🐛 249 | 🌐 C# | 📅 2026-09-12 - Cross platform build automation system.
* [Nuke](https://github.com/nuke-build/nuke) ⭐ 3,752 | 🐛 121 | 🌐 C# | 📅 2025-12-02 - Cross-platform build automation system.
* [vsts-agent](https://github.com/Microsoft/vsts-agent/blob/master/README.md) ⭐ 1,914 | 🐛 227 | 🌐 C# | 📅 2026-09-11 - Visual Studio Team Services Build and Release Agent.
* [GitVersioning](https://github.com/AArnott/Nerdbank.GitVersioning) ⭐ 1,587 | 🐛 13 | 🌐 C# | 📅 2026-09-11 - Stamp your assemblies and NuGet packages with a version from a single, simple version.txt file and include git commit IDs for non-official builds.
...
* [Smidge](https://github.com/Shazwazza/Smidge/) ⭐ 372 | 🐛 32 | 🌐 C# | 📅 2026-07-15 - Lightweight runtime CSS/JavaScript file minification, combination, compression & management library for ASP.NET Core.
...
* [Stack Exchange Redis](https://github.com/StackExchange/StackExchange.Redis) ⭐ 6,198 | 🐛 216 | 🌐 C# | 📅 2026-09-11 - High performance general purpose redis client for .NET languages (C# etc).
...
* [Foundatio](https://github.com/exceptionless/Foundatio) ⭐ 2,098 | 🐛 13 | 🌐 C# | 📅 2026-09-11 - Pluggable foundation blocks for building distributed apps.
...
* [Orchard Core CMS](https://github.com/OrchardCMS/OrchardCore) ⭐ 8,180 | 🐛 856 | 🌐 C# | 📅 2026-09-11 - Open Source Content Management System built with ASP.NET Core on top of a Modular and Extensible Application Framework.
* [Umbraco](https://github.com/umbraco/umbraco-cms) ⭐ 5,245 | 🐛 532 | 🌐 C# | 📅 2026-09-11 - An extensible and friendly Open source ASP.NET Core CMS
...
* [dasblog-core](https://github.com/poppastring/dasblog-core) ⭐ 481 | 🐛 13 | 🌐 C# | 📅 2026-09-07 - The original DasBlog reimagined with ASP.NET Core
...
* [awesome-static-analysis](https://github.com/mre/awesome-static-analysis) ⭐ 14,781 | 🐛 11 | 🌐 Rust | 📅 2026-09-11 - Curated list of static analysis tools, linters and code quality checkers for various programming languages.
* Code Analysis
  ...
  * [roslyn-analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,671 | 🐛 1,059 | 📅 2026-09-07 - .NET Compiler Platform ("Roslyn") Analyzers.
...
* Metrics
  ...
  * [Foundatio](https://github.com/exceptionless/Foundatio#metrics) ⭐ 2,098 | 🐛 13 | 🌐 C# | 📅 2026-09-11 - A common interface with in memory, redis, StatsD, and Metrics.NET implementations.
  ...
  * [Prometheus.Client](https://github.com/PrometheusClientNet/Prometheus.Client) ⭐ 142 | 🐛 1 | 🌐 C# | 📅 2026-09-09 - .NET Client for [Prometheus](https://prometheus.io).
    * [Prometheus.Client.MetricPusher](https://github.com/PrometheusClientNet/Prometheus.Client.MetricPusher) ⭐ 19 | 🐛 1 | 🌐 C# | 📅 2026-09-09 -  Push metrics to a PushGateaway for the Prometheus.Client.
    * [Prometheus.Client.MetricServer](https://github.com/PrometheusClientNet/Prometheus.Client.MetricServer) ⭐ 16 | 🐛 1 | 🌐 C# | 📅 2026-09-09 -  MetricServer for the Prometheus.Client.
    * [Prometheus.Client.HttpRequestDurations](https://github.com/PrometheusClientNet/Prometheus.Client.HttpRequestDurations) ⭐ 11 | 🐛 1 | 🌐 C# | 📅 2026-09-09 -  Metrics logging of request durations for the Prometheus.Client.
    * [Prometheus.Client.AspNetCore](https://github.com/PrometheusClientNet/Prometheus.Client.AspNetCore) ⭐ 10 | 🐛 1 | 🌐 C# | 📅 2026-09-09 -  Middleware for the Prometheus.Client.
...
* [roslyn](https://github.com/dotnet/roslyn) ⭐ 20,656 | 🐛 6,291 | 🌐 C# | 📅 2026-09-12 - The .NET Compiler Platform ("Roslyn") provides open-source C# and Visual Basic compilers with rich code analysis APIs.
* [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,151 | 🐛 158 | 🌐 F# | 📅 2026-09-12 - F# to JavaScript Compiler.
...
* [LiteDB](https://github.com/mbdavid/LiteDB) ⭐ 9,464 | 🐛 760 | 🌐 C# | 📅 2026-08-21 - .NET NoSQL Document Store in a single data file - <http://www.litedb.org>.
* [marten](https://github.com/JasperFx/marten) ⭐ 3,452 | 🐛 11 | 🌐 C# | 📅 2026-09-12 - Postgresql as a Document Database and Event Store for .NET Applications <http://jasperfx.github.io/marten>.
* [yessql](https://github.com/sebastienros/yessql) ⭐ 1,361 | 🐛 150 | 🌐 C# | 📅 2026-09-07 - .NET document database working on any RDBMS.
* [DBreeze](https://github.com/hhblaze/DBreeze) ⭐ 578 | 🐛 1 | 🌐 C# | 📅 2026-08-28 - C# .NET MONO NOSQL (key value store embedded) ACID multi-paradigm database management system.
...
* [ravendb](https://github.com/ayende/ravendb/tree/v4.0) ⭐ 296 | 🐛 24 | 🌐 C# | 📅 2026-09-11 - Linq enabled document database for .NET.
* [confluent-kafka-dotnet](https://github.com/confluentinc/confluent-kafka-dotnet) ⭐ 274 | 🐛 476 | 🌐 C# | 📅 2026-09-12 - Confluent's Apache Kafka .NET client.
...
* [FluentDateTime](https://github.com/FluentDateTime/FluentDateTime) ⭐ 698 | 🐛 1 | 🌐 C# | 📅 2026-09-10 - Allows you to write cleaner DateTime expressions and operation. Partially inspired by Ruby DateTime Extensions.
...
* [Ocelot](https://github.com/ThreeMammals/Ocelot) ⭐ 8,714 | 🐛 57 | 🌐 C# | 📅 2026-09-11 - API Gateway created using .NET Core
...
* [nopCommerce](https://github.com/nopSolutions/nopCommerce) ⭐ 10,145 | 🐛 168 | 🌐 C# | 📅 2026-09-11 - Free open-source ecommerce shopping cart (ASP.NET MVC / ASP.NET Core MVC ) with a vast community and a market place full of new features, themes and plugins.
...
* [GrandNode](https://github.com/grandnode/grandnode) ⚠️ Archived - Multi-platform, free, open source ecommerce shopping cart based on ASP.NET Core 2.1 and MongoDB derived from [nopCommerce](https://github.com/nopSolutions/nopCommerce) ⭐ 10,145 | 🐛 168 | 🌐 C# | 📅 2026-09-11.
...
* [ReactiveUI](https://github.com/reactiveui/ReactiveUI) ⭐ 8,539 | 🐛 10 | 🌐 C# | 📅 2026-09-12 - A MVVM framework that integrates with the Reactive Extensions for .NET to create elegant, testable User Interfaces that run on any mobile or desktop platform.
* [Rx.NET](https://github.com/Reactive-Extensions/Rx.NET) ⭐ 7,191 | 🐛 180 | 🌐 C# | 📅 2026-09-08 - The [Reactive Extensions](http://reactivex.io) for .NET.
...
* [Avalonia](https://github.com/AvaloniaUI/Avalonia) ⭐ 31,489 | 🐛 1,871 | 🌐 C# | 📅 2026-09-12 - A multi-platform .NET UI framework (formerly known as Perspex).
...
* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 192,034 | 🐛 20,962 | 🌐 TypeScript | 📅 2026-09-12 - New type of tool that combines the simplicity of a code editor with what developers need for their core edit-build-debug cycle. Code provides comprehensive editing and debugging support, an extensibility model, and lightweight integration with existing tools.
...
* [serilog](https://github.com/serilog/serilog) ⭐ 8,036 | 🐛 20 | 🌐 C# | 📅 2026-07-31 - Simple .NET logging with fully-structured events.
...
* [NLog](https://github.com/NLog/NLog) ⭐ 6,544 | 🐛 50 | 🌐 C# | 📅 2026-09-10 - Advanced .NET, Silverlight and Xamarin Logging with support for structured and non structured logging.
...
* [Foundatio](https://github.com/exceptionless/Foundatio#logging) ⭐ 2,098 | 🐛 13 | 🌐 C# | 📅 2026-09-11 - A fluent logging api that can be used to log messages throughout your application.
* [log4net](https://github.com/apache/logging-log4net) ⭐ 934 | 🐛 5 | 🌐 C# | 📅 2026-09-11 - log4net is a port of the excellent Apache log4j™ framework to the Microsoft® .NET runtime.
...
* [Humanizer](https://github.com/Humanizr/Humanizer) ⭐ 9,872 | 🐛 15 | 🌐 C# | 📅 2026-09-11 - Humanizer meets all your .NET needs for manipulating and displaying strings, enums, dates, times, timespans, numbers and quantities.
* [AngleSharp](https://github.com/AngleSharp/AngleSharp) ⭐ 5,532 | 🐛 7 | 🌐 C# | 📅 2026-09-12 - The ultimate angle brackets parser library. It parses HTML5, MathML, SVG and CSS to construct a DOM based on the official W3C specification. Comparable to beautifulsoup4 of python.
* [markdig](https://github.com/lunet-io/markdig) ⭐ 5,323 | 🐛 119 | 🌐 C# | 📅 2026-08-18 - Fast, powerfull, CommonMark compliant, extensible Markdown processor for .NET.
...
* [PuppeteerSharp](https://github.com/kblok/puppeteer-sharp) ⭐ 3,918 | 🐛 11 | 🌐 C# | 📅 2026-09-12 - Puppeteer Sharp is a .NET port of the official Node.JS Puppeteer API.
...
* [FluentFTP](https://github.com/robinrodricks/FluentFTP/) ⭐ 3,398 | 🐛 23 | 🌐 C# | 📅 2026-09-08 - FTP and FTPS client, with extensive FTP commands, SSL/TLS connections, hashing/checksums and more.
...
* [Downloader](https://github.com/bezzad/Downloader) ⭐ 1,705 | 🐛 0 | 🌐 C# | 📅 2026-09-06 - Downloader is a modern, fluent, asynchronous, testable and portable library for .NET. This is a multipart downloader with asynchronous progress events.
...
* [FluentDocker](https://github.com/mariotoffia/FluentDocker) ⭐ 1,391 | 🐛 5 | 🌐 C# | 📅 2026-07-19 - Commands, Services and Fluent API for docker, docker-compose & docker-machine, for win/mac/linux and native docker.
* [FastExpressionCompiler](https://github.com/dadhi/FastExpressionCompiler) ⭐ 1,375 | 🐛 24 | 🌐 C# | 📅 2026-09-09 - Fast ExpressionTree compiler to delegate.
...
* [CosmosOS](https://github.com/CosmosOS/Cosmos) ⭐ 3,191 | 🐛 137 | 🌐 C# | 📅 2026-09-04 - Cosmos is an operating system "construction kit". Build your own OS using managed languages such as C#, VB.NET, and more!

### ORM

* [Dapper](https://github.com/StackExchange/Dapper) ⭐ 18,384 | 🐛 548 | 🌐 C# | 📅 2026-09-12 - Simple object mapper for .NET.
  * [MicroOrm.Dapper.Repositories](https://github.com/phnx47/MicroOrm.Dapper.Repositories) ⭐ 705 | 🐛 2 | 🌐 C# | 📅 2026-09-11 - CRUD for Dapper.
...
* [Entity Framework Core](https://github.com/aspnet/EntityFramework) ⭐ 14,788 | 🐛 2,350 | 🌐 C# | 📅 2026-09-12 - Familiar developer experience to previous versions of EF, including LINQ, POCO, and Code First support.
...
* [SmartSql](https://github.com/Ahoo-Wang/SmartSql) ⭐ 1,133 | 🐛 42 | 🌐 C# | 📅 2026-09-08 - SmartSql = MyBatis + Cache(Memory | Redis) + ZooKeeper + R/W Splitting +Dynamic Repository ....
...
* [MQTTnet](https://github.com/chkr1011/MQTTnet) ⭐ 5,061 | 🐛 197 | 🌐 C# | 📅 2026-08-09 - MQTTnet is a high performance .NET library for MQTT based communication.
...
* [rabbitmq-dotnet-client](https://github.com/rabbitmq/rabbitmq-dotnet-client) ⭐ 2,281 | 🐛 80 | 🌐 C# | 📅 2026-09-09 - RabbitMQ .NET client <https://www.rabbitmq.com>.
* [NServiceBus](https://github.com/particular/nservicebus) ⭐ 2,169 | 🐛 290 | 🌐 C# | 📅 2026-09-11 - NServiceBus is part of the [Particular Service Platform](https://particular.net/service-platform), which contains tools to build, monitor, and debug distributed systems.
* [Foundatio](https://github.com/exceptionless/Foundatio#queues) ⭐ 2,098 | 🐛 13 | 🌐 C# | 📅 2026-09-11 - A common interface with in memory, redis and azure implementations.
...
* [Silverback](https://github.com/BEagle1984/silverback) ⭐ 284 | 🐛 14 | 🌐 C# | 📅 2026-09-11 - Framework to build event-driven applications (support for Kafka, RabbitMQ, MQTT).
...
* [OpenCQRS](https://github.com/OpenCQRS/OpenCQRS) ⭐ 28 | 🐛 14 | 🌐 C# | 📅 2026-09-12 - .NET Core library for DDD, CQRS and Event Sourcing with Azure Service Bus integration. Supported database providers for the Command and the Event stores are: DocumentDB, MongoDB, SQL Server, MySQL, PostgreSQL and SQLite.
...
* [HangfireIO](https://github.com/HangfireIO/Hangfire) ⭐ 10,137 | 🐛 942 | 🌐 C# | 📅 2026-08-28 - Easy way to perform fire-and-forget, delayed and recurring tasks inside ASP.NET apps <http://hangfire.io>.
* [quartznet](https://github.com/quartznet/quartznet/) ⭐ 7,079 | 🐛 14 | 🌐 C# | 📅 2026-09-11 - Quartz Enterprise Scheduler .NET <http://www.quartz-scheduler.net>.
...
* [google-cloud-dotnet](https://github.com/GoogleCloudPlatform/google-cloud-dotnet) ⭐ 1,094 | 🐛 16 | 🌐 C# | 📅 2026-09-11 - Google Cloud Client Libraries for .NET.
...
* [Newtonsoft.Json](https://github.com/JamesNK/Newtonsoft.Json) ⭐ 11,316 | 🐛 827 | 🌐 C# | 📅 2026-08-13 - Popular high-performance JSON framework for .NET.
...
* MessagePack
  * [MessagePack-CSharp](https://github.com/neuecc/MessagePack-CSharp) ⭐ 6,776 | 🐛 147 | 🌐 C# | 📅 2026-09-07 - Extremely Fast MessagePack Serializer for C#(.NET, .NET Core, Unity, Xamarin).
...
* [Atata](https://github.com/atata-framework/atata) ⭐ 502 | 🐛 9 | 🌐 C# | 📅 2026-09-10 - Web UI test automation full-featured framework based on Selenium WebDriver. <https://atata.io>
...
* [ShareX](https://github.com/ShareX/ShareX) ⭐ 39,543 | 🐛 647 | 🌐 C# | 📅 2026-09-12 - Free and open source program that lets you capture or record any area of your screen and share it with a single press of a key. It also allows uploading images, text or other types of files to over 80 supported destinations you can choose from. <https://getsharex.com>

* [scoop](https://github.com/lukesampson/scoop) ⭐ 24,654 | 🐛 527 | 🌐 PowerShell | 📅 2026-09-11 - A command-line installer for Windows.

* [mRemoteNG](https://github.com/mRemoteNG/mRemoteNG) ⭐ 11,093 | 🐛 857 | 🌐 C# | 📅 2026-09-11 - The next generation of mRemote, open source, tabbed, multi-protocol, remote connections manager
...
* [docfx](https://github.com/dotnet/docfx) ⭐ 4,449 | 🐛 451 | 🌐 C# | 📅 2026-09-10 - Tools for building and publishing API documentation for .NET projects <http://dotnet.github.io/docfx>
...
* [ASP.NET Core Developer Roadmap](https://github.com/MoienTajik/AspNetCore-Developer-Roadmap) ⭐ 19,639 | 🐛 3 | 📅 2026-01-29 - Roadmap to becoming an ASP.NET Core developer in 2019.

## Starter Kits

* [bitwarden-core](https://github.com/bitwarden/core) ⭐ 20,122 | 🐛 230 | 🌐 C# | 📅 2026-09-12 - The core infrastructure backend (API, database, etc) <https://bitwarden.com>.
...
* Microservices & Service Mesh
  * [eShop](https://github.com/dotnet/eShop) ⭐ 10,858 | 🐛 124 | 🌐 C# | 📅 2026-08-31 - A reference .NET application implementing an eCommerce site.
  ...
  * [Practical.CleanArchitecture](https://github.com/phongnguyend/Practical.CleanArchitecture) ⭐ 2,458 | 🐛 41 | 🌐 C# | 📅 2026-08-04 - Full-stack .Net 8 Clean Architecture (Microservices, Modular Monolith, Monolith), Blazor, Angular 18, React 18, Vue 3, BFF with YARP, Domain-Driven Design, CQRS, SOLID, Asp.Net Core Identity Custom Storage, OpenID Connect, Entity Framework Core, OpenTelemetry, SignalR, Hosted Services, Health Checks, Rate Limiting, Cloud Services (Azure, AWS, GCP).
...
* Monoliths
  * [MusicStore](https://github.com/dotnet/aspnetcore/tree/master/src/MusicStore) ⭐ 38,436 | 🐛 4,163 | 🌐 C# | 📅 2026-09-12 - Sample MusicStore application that uses MVC and Entity Framework.
  ...
  * [Practical ASP.NET Core](https://github.com/dodyg/practical-aspnetcore) ⭐ 10,408 | 🐛 177 | 🌐 C# | 📅 2026-09-10 - A daily updated micro samples of ASP.NET Core features and facilities.
...
* [awesome-copilot](https://github.com/github/awesome-copilot) ⭐ 38,927 | 🐛 59 | 🌐 JavaScript | 📅 2026-09-11
* Stack Overflow
