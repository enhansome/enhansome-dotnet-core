...
Inspired by [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,904 | 🐛 100 | 📅 2026-06-30, [awesome-dotnet](https://github.com/quozd/awesome-dotnet) ⭐ 21,554 | 🐛 137 | 📅 2026-03-26,  [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,525 | 🐛 26 | 📅 2026-05-03, [frontend-dev-bookmarks](https://github.com/dypsilon/frontend-dev-bookmarks) ⭐ 47,387 | 🐛 132 | 📅 2024-05-21.
...
* [.NET Core SDK](https://www.microsoft.com/net/core) - .NET Core SDK is a general purpose development platform maintained by Microsoft and the .NET community on [GitHub](https://github.com/dotnet/core) ⭐ 22,031 | 🐛 351 | 🌐 PowerShell | 📅 2026-08-15.
...
* [OpenAPI Generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,673 | 🐛 5,709 | 🌐 Java | 📅 2026-08-14 - OpenAPI Generator allows generation of API client libraries (e.g. C#, TypeScript, etc), server stubs (ASP.NET Core, NancyFx, etc), documentation and configuration automatically given an OpenAPI Spec (v2, v3).
...
* [Swashbuckle](https://github.com/domaindrivendev/Swashbuckle.AspNetCore) ⭐ 5,496 | 🐛 173 | 🌐 C# | 📅 2026-08-12 - Seamlessly adds a swagger to WebApi projects.
...
* GraphQL
  ...
  * [graphql-dotnetcore](https://github.com/mkmarek/graphql-dotnetcore) ⚠️ Archived - GraphQL for .NET Core based on <https://github.com/graphql/graphql-js> ⭐ 20,345 | 🐛 97 | 🌐 TypeScript | 📅 2026-08-13.
...
* [grpc](https://github.com/grpc/grpc/tree/master/src/csharp) ⭐ 45,285 | 🐛 1,376 | 🌐 C++ | 📅 2026-08-15 - Remote Procedure Calls (RPCs) provide a useful abstraction for building distributed applications and services. The libraries in this repository provide a concrete implementation of the gRPC protocol, layered over HTTP/2. These libraries enable communication between clients and servers using any combination of the supported languages.
* [ASP.NET MVC](https://github.com/dotnet/aspnetcore/tree/master/src/Mvc) ⭐ 38,373 | 🐛 4,122 | 🌐 C# | 📅 2026-08-15 - Model view controller framework for building dynamic web sites with clean separation of concerns, including the merged MVC, Web API, and Web Pages w/ Razor.
* [Abp vNext](https://github.com/abpframework/abp) ⭐ 14,400 | 🐛 322 | 🌐 C# | 📅 2026-08-15 - Abp vNext is the next generation of the open source [ASP.NET Boilerplate](https://github.com/aspnetboilerplate/aspnetboilerplate) ⭐ 12,000 | 🐛 63 | 🌐 C# | 📅 2026-07-28 framework. It's a complete architecture and strong infrastructure to create modern web applications!
...
* [orleans](https://github.com/dotnet/orleans) ⭐ 10,832 | 🐛 690 | 🌐 C# | 📅 2026-08-14 - Framework that provides a straight-forward approach to building distributed high-scale computing applications, without the need to learn and apply complex concurrency or other scaling patterns.
...
* [opencvsharp](https://github.com/shimat/opencvsharp) ⭐ 6,062 | 🐛 8 | 🌐 C# | 📅 2026-08-10 - .NET Framework wrapper for OpenCV.
* [ServiceStack](https://github.com/ServiceStack/ServiceStack) ⭐ 5,499 | 🐛 35 | 🌐 C# | 📅 2026-08-14 - Thoughtfully architected, obscenely fast, thoroughly enjoyable web services for all <https://servicestack.net>.
...
* [Finbuckle.MultiTenant](https://github.com/Finbuckle/Finbuckle.MultiTenant) ⭐ 1,617 | 🐛 33 | 🌐 C# | 📅 2026-08-14 - Finbuckle.MultiTenant is a .NET Standard library for multitenant support designed for ASP.NET 2.0+. It provides functionality for tenant resolution, per-tenant app configuration, and per-tenant data isolation.
...
* [dotvvm](https://github.com/riganti/dotvvm) ⭐ 806 | 🐛 165 | 🌐 C# | 📅 2026-08-14 - Open source MVVM framework for Web Apps.
...
* [Halibut](https://github.com/OctopusDeploy/Halibut) ⭐ 24 | 🐛 51 | 🌐 C# | 📅 2026-08-14 - A secure communication stack for .NET using JSON-RPC over SSL.
...
* [CleanArchitecture (SPA)](https://github.com/JasonGT/CleanArchitecture) ⭐ 20,459 | 🐛 19 | 🌐 C# | 📅 2026-08-14 - Solution template for creating a Single Page App (SPA) with Angular 8 and ASP.NET Core 3 following the principles of Clean Architecture
* [CleanArchitecture](https://github.com/ardalis/CleanArchitecture) ⭐ 18,403 | 🐛 37 | 🌐 C# | 📅 2026-08-14 - A starting point for Clean Architecture with ASP.NET Core. Clean Architecture is just the latest in a series of names for the same loosely-coupled, dependency-inverted architecture. You will also find it named hexagonal, ports-and-adapters, or onion architecture.
...
* [Serenity](https://github.com/volkanceylan/Serenity) ⭐ 2,694 | 🐛 0 | 🌐 C# | 📅 2026-08-14 - Serenity is an ASP.NET MVC / TypeScript application platform designed to simplify and shorten development of data-centric business applications with a service based architecture.
* [kendo-ui-core](https://github.com/telerik/kendo-ui-core) ⭐ 2,584 | 🐛 706 | 🌐 JavaScript | 📅 2026-08-14 - An HTML5, jQuery-based widget library for building modern web apps. <http://www.telerik.com/kendo-ui>.
...
* [openiddict](https://github.com/openiddict/openiddict-core) ⭐ 5,224 | 🐛 6 | 🌐 C# | 📅 2026-08-14 - Easy-to-use OpenID Connect server for ASP.NET Core.
...
* [BTCPayServer](https://github.com/btcpayserver/btcpayserver) ⭐ 7,710 | 🐛 81 | 🌐 C# | 📅 2026-08-07 - A cross platform, self-hosted server compatible with Bitpay API.
* [NEO](https://github.com/neo-project/neo) ⭐ 3,535 | 🐛 258 | 🌐 C# | 📅 2026-08-09 - Open Network For Smart Economy.
* [WalletWasabi](https://github.com/zkSNACKs/WalletWasabi) ⭐ 2,601 | 🐛 341 | 🌐 C# | 📅 2026-08-10 - Privacy focused, ZeroLink compliant Bitcoin wallet.
* [NBitcoin](https://github.com/MetacoSA/NBitcoin) ⭐ 1,941 | 🐛 116 | 🌐 C# | 📅 2026-08-12 - Comprehensive Bitcoin library for the .NET framework.
* [Nethermind](https://github.com/NethermindEth/nethermind) ⭐ 1,586 | 🐛 399 | 🌐 C# | 📅 2026-08-15 - .NET Core Ethereum client
...
* [msbuild](https://github.com/Microsoft/msbuild) ⭐ 5,542 | 🐛 1,664 | 🌐 C# | 📅 2026-08-14 - The Microsoft Build Engine is a platform for building applications.
* [dotnet-docker](https://github.com/dotnet/dotnet-docker) ⭐ 4,863 | 🐛 135 | 🌐 Dockerfile | 📅 2026-08-13 - The base Docker images for working with .NET Core and the .NET Core Tools.
...
* [vsts-agent](https://github.com/Microsoft/vsts-agent/blob/master/README.md) ⭐ 1,910 | 🐛 223 | 🌐 C# | 📅 2026-08-14 - Visual Studio Team Services Build and Release Agent.
* [GitVersioning](https://github.com/AArnott/Nerdbank.GitVersioning) ⭐ 1,579 | 🐛 20 | 🌐 C# | 📅 2026-08-15 - Stamp your assemblies and NuGet packages with a version from a single, simple version.txt file and include git commit IDs for non-official builds.
...
* [Stack Exchange Redis](https://github.com/StackExchange/StackExchange.Redis) ⭐ 6,192 | 🐛 218 | 🌐 C# | 📅 2026-08-14 - High performance general purpose redis client for .NET languages (C# etc).
...
* [Foundatio](https://github.com/exceptionless/Foundatio) ⭐ 2,096 | 🐛 14 | 🌐 C# | 📅 2026-08-14 - Pluggable foundation blocks for building distributed apps.
...
* [Orchard Core CMS](https://github.com/OrchardCMS/OrchardCore) ⭐ 8,156 | 🐛 852 | 🌐 C# | 📅 2026-08-15 - Open Source Content Management System built with ASP.NET Core on top of a Modular and Extensible Application Framework.
* [Umbraco](https://github.com/umbraco/umbraco-cms) ⭐ 5,224 | 🐛 483 | 🌐 C# | 📅 2026-08-14 - An extensible and friendly Open source ASP.NET Core CMS
...
* [awesome-static-analysis](https://github.com/mre/awesome-static-analysis) ⭐ 14,735 | 🐛 26 | 🌐 Rust | 📅 2026-06-10 - Curated list of static analysis tools, linters and code quality checkers for various programming languages.
* Code Analysis
  ...
  * [DevSkim](https://github.com/Microsoft/DevSkim) ⭐ 1,002 | 🐛 75 | 🌐 C# | 📅 2026-08-14 - A set of IDE plugins and rules that provide security "linting" capabilities.
...
* Metrics
  ...
  * [coverlet](https://github.com/tonerdo/coverlet) ⭐ 3,172 | 🐛 12 | 🌐 C# | 📅 2026-08-08 - Cross platform code coverage library for .NET Core.
  * [Audit.NET](https://github.com/thepirat000/Audit.NET) ⭐ 2,642 | 🐛 5 | 🌐 C# | 📅 2026-06-12 - Small framework to audit .NET object changes.
  ...
  * [Foundatio](https://github.com/exceptionless/Foundatio#metrics) ⭐ 2,096 | 🐛 14 | 🌐 C# | 📅 2026-08-14 - A common interface with in memory, redis, StatsD, and Metrics.NET implementations.
  ...
  * [Prometheus.Client](https://github.com/PrometheusClientNet/Prometheus.Client) ⭐ 142 | 🐛 2 | 🌐 C# | 📅 2026-08-15 - .NET Client for [Prometheus](https://prometheus.io).
    * [Prometheus.Client.MetricPusher](https://github.com/PrometheusClientNet/Prometheus.Client.MetricPusher) ⭐ 19 | 🐛 3 | 🌐 C# | 📅 2026-08-15 -  Push metrics to a PushGateaway for the Prometheus.Client.
...
* [roslyn](https://github.com/dotnet/roslyn) ⭐ 20,608 | 🐛 6,291 | 🌐 C# | 📅 2026-08-15 - The .NET Compiler Platform ("Roslyn") provides open-source C# and Visual Basic compilers with rich code analysis APIs.
* [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,143 | 🐛 169 | 🌐 F# | 📅 2026-08-14 - F# to JavaScript Compiler.
* [peachpie](https://github.com/peachpiecompiler/peachpie) ⭐ 2,486 | 🐛 90 | 🌐 C# | 📅 2026-06-09 - Open-source PHP compiler to .NET.
* [Sprache](https://github.com/sprache/Sprache) ⭐ 2,472 | 🐛 22 | 🌐 C# | 📅 2024-04-18 - Tiny C# Monadic Parser Framework.
...
* [LiteDB](https://github.com/mbdavid/LiteDB) ⭐ 9,454 | 🐛 753 | 🌐 C# | 📅 2026-08-11 - .NET NoSQL Document Store in a single data file - <http://www.litedb.org>.
* [marten](https://github.com/JasperFx/marten) ⭐ 3,442 | 🐛 6 | 🌐 C# | 📅 2026-08-11 - Postgresql as a Document Database and Event Store for .NET Applications <http://jasperfx.github.io/marten>.
...
* [npgsql](https://github.com/npgsql/npgsql) ⭐ 3,721 | 🐛 224 | 🌐 C# | 📅 2026-08-12 - .NET data provider for PostgreSQL. It allows any program developed for .NET framework to access a PostgreSQL database server. It is implemented in 100% C# code. PostgreSQL versions since 9.1 are officially supported, others may work. <http://www.npgsql.org>
* [MongoDB.Driver](https://github.com/mongodb/mongo-csharp-driver) ⭐ 3,241 | 🐛 14 | 🌐 C# | 📅 2026-08-14 - .NET Driver for MongoDB.
...
* [ravendb](https://github.com/ayende/ravendb/tree/v4.0) ⭐ 296 | 🐛 20 | 🌐 C# | 📅 2026-08-14 - Linq enabled document database for .NET.
* [confluent-kafka-dotnet](https://github.com/confluentinc/confluent-kafka-dotnet) ⭐ 268 | 🐛 476 | 🌐 C# | 📅 2026-08-15 - Confluent's Apache Kafka .NET client.
...
* [fluentmigrator](https://github.com/fluentmigrator/fluentmigrator) ⭐ 3,507 | 🐛 210 | 🌐 C# | 📅 2026-08-12 - Migration framework for .NET much like Ruby on Rails Migrations.
...
* [Mongo.Migration](https://github.com/SRoddis/Mongo.Migration) ⭐ 183 | 🐛 34 | 🌐 C# | 📅 2026-03-18 - Mongo.Migration is designed for the [MongoDB C# Driver](https://github.com/mongodb/mongo-csharp-driver) ⭐ 3,241 | 🐛 14 | 🌐 C# | 📅 2026-08-14 to migrate your documents easily and on-the-fly. No more downtime for schema-migrations. Just write small and simple migrations. [Link](https://github.com/SRoddis/Mongo.Migration) ⭐ 183 | 🐛 34 | 🌐 C# | 📅 2026-03-18
...
* [Ocelot](https://github.com/ThreeMammals/Ocelot) ⭐ 8,714 | 🐛 60 | 🌐 C# | 📅 2026-08-14 - API Gateway created using .NET Core
...
* [nopCommerce](https://github.com/nopSolutions/nopCommerce) ⭐ 10,122 | 🐛 164 | 🌐 C# | 📅 2026-08-14 - Free open-source ecommerce shopping cart (ASP.NET MVC / ASP.NET Core MVC ) with a vast community and a market place full of new features, themes and plugins.
* [SimplCommerce](https://github.com/simplcommerce/SimplCommerce) ⭐ 4,417 | 🐛 172 | 🌐 C# | 📅 2026-06-08 - Super simple ecommerce system built on .NET Core.
* [GrandNode](https://github.com/grandnode/grandnode) ⚠️ Archived - Multi-platform, free, open source ecommerce shopping cart based on ASP.NET Core 2.1 and MongoDB derived from [nopCommerce](https://github.com/nopSolutions/nopCommerce) ⭐ 10,122 | 🐛 164 | 🌐 C# | 📅 2026-08-14.
...
* [ReactiveUI](https://github.com/reactiveui/ReactiveUI) ⭐ 8,531 | 🐛 4 | 🌐 C# | 📅 2026-08-14 - A MVVM framework that integrates with the Reactive Extensions for .NET to create elegant, testable User Interfaces that run on any mobile or desktop platform.
...
* [ZXing.Net](https://github.com/micjahn/ZXing.Net/) ⭐ 3,084 | 🐛 78 | 🌐 C# | 📅 2026-07-06 - .Net port of the original java-based barcode reader and generator library zxing.
...
* [Avalonia](https://github.com/AvaloniaUI/Avalonia) ⭐ 31,319 | 🐛 1,933 | 🌐 C# | 📅 2026-08-14 - A multi-platform .NET UI framework (formerly known as Perspex).
...
* [AvaloniaEdit](https://github.com/AvaloniaUI/AvaloniaEdit/) ⭐ 1,121 | 🐛 89 | 🌐 C# | 📅 2026-06-05 - The Avalonia-based text editor component forked from [AvalonEdit](https://github.com/icsharpcode/AvalonEdit) ⭐ 2,075 | 🐛 114 | 🌐 C# | 📅 2025-12-04
...
* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 188,706 | 🐛 19,869 | 🌐 TypeScript | 📅 2026-08-15 - New type of tool that combines the simplicity of a code editor with what developers need for their core edit-build-debug cycle. Code provides comprehensive editing and debugging support, an extensibility model, and lightweight integration with existing tools.
...
* [SimpleInjector](https://github.com/simpleinjector/SimpleInjector) ⭐ 1,261 | 🐛 31 | 🌐 C# | 📅 2026-07-02 - Easy, flexible, and fast Dependency Injection library that promotes best practice to steer developers towards the pit of success.
...
* [serilog](https://github.com/serilog/serilog) ⭐ 8,029 | 🐛 17 | 🌐 C# | 📅 2026-07-31 - Simple .NET logging with fully-structured events.
  * [serilog-aspnetcore](https://github.com/serilog/serilog-aspnetcore) ⭐ 1,428 | 🐛 24 | 🌐 C# | 📅 2025-11-28 - Serilog integration for ASP.NET Core 2+.
...
* [NLog](https://github.com/NLog/NLog) ⭐ 6,545 | 🐛 57 | 🌐 C# | 📅 2026-08-14 - Advanced .NET, Silverlight and Xamarin Logging with support for structured and non structured logging.
  * [NLog.Extensions.Logging](https://github.com/NLog/NLog.Extensions.Logging) ⭐ 402 | 🐛 2 | 🌐 C# | 📅 2026-08-14 - NLog Provider for Microsoft.Extensions.Logging for .NET Standard libraries and .NET Core applications
  * [NLog for ASP.NET and ASP.NET Core](https://github.com/NLog/NLog.Web) ⭐ 329 | 🐛 10 | 🌐 C# | 📅 2026-08-14 - NLog integration for ASP.NET & ASP.NET Core 1-3
...
* [Foundatio](https://github.com/exceptionless/Foundatio#logging) ⭐ 2,096 | 🐛 14 | 🌐 C# | 📅 2026-08-14 - A fluent logging api that can be used to log messages throughout your application.
...
* [WaveFunctionCollapse](https://github.com/mxgmn/WaveFunctionCollapse) ⭐ 25,272 | 🐛 9 | 🌐 C# | 📅 2026-03-22 - itmap & tilemap generation from a single example with the help of ideas from quantum mechanics.
...
* [MailKit](https://github.com/jstedfast/MailKit) ⭐ 6,840 | 🐛 9 | 🌐 C# | 📅 2026-08-14 - Cross-platform .NET library for IMAP, POP3, and SMTP.
* [Papercut](https://github.com/ChangemakerStudios/Papercut) ⭐ 3,324 | 🐛 7 | 🌐 C# | 📅 2026-08-15 - Simple Desktop SMTP Server
* [FluentEmail](https://github.com/lukencode/FluentEmail) ⭐ 3,214 | 🐛 130 | 🌐 C# | 📅 2024-03-30 - All in one email sender for .NET and .NET Core
* [MimeKit](https://github.com/jstedfast/MimeKit) ⭐ 1,999 | 🐛 16 | 🌐 C# | 📅 2026-08-03 - Cross-platform .NET MIME creation and parser library with support for S/MIME, PGP, DKIM, TNEF and Unix mbox spools.
...
* [UnitsNet](https://github.com/angularsen/UnitsNet) ⭐ 2,966 | 🐛 19 | 🌐 C# | 📅 2026-08-02 - Units.NET gives you all the common units of measurement and the conversions between them.
...
* [AutoMapper](https://github.com/AutoMapper/AutoMapper) ⭐ 10,195 | 🐛 4 | 🌐 C# | 📅 2026-07-02 - Convention-based object-object mapper in .NET.
...
* [PuppeteerSharp](https://github.com/kblok/puppeteer-sharp) ⭐ 3,913 | 🐛 10 | 🌐 C# | 📅 2026-08-14 - Puppeteer Sharp is a .NET port of the official Node.JS Puppeteer API.
...
* [Vanara](https://github.com/dahall/Vanara) ⭐ 2,089 | 🐛 7 | 🌐 C# | 📅 2026-08-15 - A set of .NET libraries for Windows implementing PInvoke calls to many native Windows APIs with supporting wrappers.
...
* [Downloader](https://github.com/bezzad/Downloader) ⭐ 1,699 | 🐛 0 | 🌐 C# | 📅 2026-08-09 - Downloader is a modern, fluent, asynchronous, testable and portable library for .NET. This is a multipart downloader with asynchronous progress events.
...
* Validation
  * [FluentValidation](https://github.com/JeremySkinner/FluentValidation) ⭐ 9,754 | 🐛 3 | 🌐 C# | 📅 2026-08-12 - Small validation library for .NET that uses a fluent interface and lambda expressions for building validation rules.
...
* [Open-XML-SDK](https://github.com/OfficeDev/Open-XML-SDK) ⭐ 4,578 | 🐛 123 | 🌐 C# | 📅 2026-08-14 - The Open XML SDK provides tools for working with Office Word, Excel, and PowerPoint documents.
...
* [Dapper](https://github.com/StackExchange/Dapper) ⭐ 18,366 | 🐛 547 | 🌐 C# | 📅 2026-05-16 - Simple object mapper for .NET.
  * [MicroOrm.Dapper.Repositories](https://github.com/phnx47/MicroOrm.Dapper.Repositories) ⭐ 705 | 🐛 3 | 🌐 C# | 📅 2026-08-15 - CRUD for Dapper.
...
* [Entity Framework Core](https://github.com/aspnet/EntityFramework) ⭐ 14,770 | 🐛 2,366 | 🌐 C# | 📅 2026-08-15 - Familiar developer experience to previous versions of EF, including LINQ, POCO, and Code First support.
  * [EFCore.BulkExtensions](https://github.com/borisdj/EFCore.BulkExtensions) ⭐ 3,999 | 🐛 127 | 🌐 C# | 📅 2026-08-14 - EntityFrameworkCore Bulk Batch Extensions for Insert Update Delete Read (CRUD) ops
...
* [nhibernate-core](https://github.com/nhibernate/nhibernate-core) ⭐ 2,172 | 🐛 677 | 🌐 C# | 📅 2026-08-15 - NHibernate Object Relational Mapper.
...
* [NServiceBus](https://github.com/particular/nservicebus) ⭐ 2,168 | 🐛 289 | 🌐 C# | 📅 2026-08-14 - NServiceBus is part of the [Particular Service Platform](https://particular.net/service-platform), which contains tools to build, monitor, and debug distributed systems.
* [Foundatio](https://github.com/exceptionless/Foundatio#queues) ⭐ 2,096 | 🐛 14 | 🌐 C# | 📅 2026-08-14 - A common interface with in memory, redis and azure implementations.
...
* [HangfireIO](https://github.com/HangfireIO/Hangfire) ⭐ 10,116 | 🐛 943 | 🌐 C# | 📅 2026-07-20 - Easy way to perform fire-and-forget, delayed and recurring tasks inside ASP.NET apps <http://hangfire.io>.
* [quartznet](https://github.com/quartznet/quartznet/) ⭐ 7,067 | 🐛 23 | 🌐 C# | 📅 2026-08-11 - Quartz Enterprise Scheduler .NET <http://www.quartz-scheduler.net>.
...
* [AWS SDK](https://github.com/aws/aws-sdk-net) ⭐ 131 | 🐛 38 | 🌐 C# | 📅 2026-08-14 - The Amazon Web Services (AWS) .NET Core SDK components. Each AWS service has its own NuGet package.
...
* [statsd-csharp-client](https://github.com/Pereingo/statsd-csharp-client) ⚠️ Archived - .NET Standard compatible C# client to interface with Etsy's excellent [statsd](https://github.com/etsy/statsd) ⭐ 18,070 | 🐛 90 | 🌐 JavaScript | 📅 2025-05-20 server.
...
* [Elasticsearch.Net & NEST](https://github.com/elastic/elasticsearch-net) ⭐ 3,648 | 🐛 72 | 🌐 C# | 📅 2026-08-14 - Repository for both NEST and Elasticsearch.NET, the two official elasticsearch .NET clients.
...
* [Newtonsoft.Json](https://github.com/JamesNK/Newtonsoft.Json) ⭐ 11,309 | 🐛 826 | 🌐 C# | 📅 2026-08-13 - Popular high-performance JSON framework for .NET.
* [CsvHelper](https://github.com/JoshClose/CsvHelper) ⭐ 5,211 | 🐛 352 | 🌐 C# | 📅 2025-06-27 - Library to help reading and writing CSV files.
...
* MessagePack
  * [MessagePack-CSharp](https://github.com/neuecc/MessagePack-CSharp) ⭐ 6,770 | 🐛 146 | 🌐 C# | 📅 2026-08-14 - Extremely Fast MessagePack Serializer for C#(.NET, .NET Core, Unity, Xamarin).
...
* [Scriban](https://github.com/lunet-io/scriban) ⭐ 3,953 | 🐛 0 | 🌐 C# | 📅 2026-07-29 - A fast, powerful, safe and lightweight text templating language and engine for .NET.
...
* [Bogus](https://github.com/bchavez/Bogus) ⭐ 9,724 | 🐛 91 | 🌐 C# | 📅 2025-12-22 - Simple and sane fake data generator for C#. Based on and ported from the famed faker.js.
* [moq.netcore](https://github.com/Moq/moq4) ⭐ 6,401 | 🐛 20 | 🌐 C# | 📅 2026-08-14 - Most popular and friendly mocking framework for .NET.
...
* [shouldly](https://github.com/shouldly/shouldly) ⭐ 3,406 | 🐛 91 | 🌐 C# | 📅 2026-08-13 - Should testing for .NET - the way Asserting *Should* be! <http://shouldly.readthedocs.org/en/latest>
...
* [LightBDD](https://github.com/LightBDD/LightBDD) ⭐ 475 | 🐛 24 | 🌐 C# | 📅 2026-06-27 - BDD framework allowing to create easy to read and maintain tests.
...
* [ShareX](https://github.com/ShareX/ShareX) ⭐ 39,137 | 🐛 665 | 🌐 C# | 📅 2026-08-15 - Free and open source program that lets you capture or record any area of your screen and share it with a single press of a key. It also allows uploading images, text or other types of files to over 80 supported destinations you can choose from. <https://getsharex.com>

* [scoop](https://github.com/lukesampson/scoop) ⭐ 24,548 | 🐛 537 | 🌐 PowerShell | 📅 2026-06-13 - A command-line installer for Windows.

* [mRemoteNG](https://github.com/mRemoteNG/mRemoteNG) ⭐ 11,048 | 🐛 866 | 🌐 C# | 📅 2026-08-14 - The next generation of mRemote, open source, tabbed, multi-protocol, remote connections manager

* [gitignore.io](https://github.com/joeblau/gitignore.io) ⭐ 8,733 | 🐛 69 | 🌐 Swift | 📅 2024-12-23 - Create useful .gitignore files for your project <https://www.gitignore.io>.

* [letsencrypt-win-simple](https://github.com/Lone-Coder/letsencrypt-win-simple) ⭐ 5,775 | 🐛 43 | 🌐 C# | 📅 2026-06-09 - A Simple ACME Client for Windows.
...
* [docfx](https://github.com/dotnet/docfx) ⭐ 4,446 | 🐛 444 | 🌐 C# | 📅 2026-08-14 - Tools for building and publishing API documentation for .NET projects <http://dotnet.github.io/docfx>
...
* [System.CommandLine](https://github.com/dotnet/command-line-api) ⭐ 3,673 | 🐛 482 | 🌐 C# | 📅 2026-08-15 - System.CommandLine, a set of libraries for command line parsing, invocation, and rendering of terminal output.
...
* [NJsonSchema](https://github.com/RSuter/NJsonSchema) ⭐ 1,579 | 🐛 442 | 🌐 C# | 📅 2026-06-20 - NJsonSchema is a .NET library to read, generate and validate JSON Schema draft v4+ schemas.
...
* [sourcelink](https://github.com/dotnet/sourcelink) ⭐ 1,350 | 🐛 144 | 🌐 C# | 📅 2026-08-15 - SourceLink is a language- and source-control agnostic system for providing first-class source debugging experiences for binaries.
...
* [redux.NET](https://github.com/GuillaumeSalles/redux.NET) ⭐ 708 | 🐛 29 | 🌐 C# | 📅 2021-07-28 - Predictable state container for .NET apps. Inspired by <https://github.com/reactjs/redux> ⭐ 61,513 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-02.
* WebAssembly
  * [Blazor](https://github.com/SteveSanderson/Blazor) ⭐ 1,677 | 🐛 7 | 🌐 C# | 📅 2018-02-23 - UI framework running .NET in the browser via WebAssembly.
    * [Awesome Blazor](https://github.com/AdrienTorris/awesome-blazor) ⭐ 9,367 | 🐛 95 | 📅 2026-07-25 - Collection of awesome resources (samples, components, articles, videos and others) about Blazor.
...
* [ASP.NET Core Developer Roadmap](https://github.com/MoienTajik/AspNetCore-Developer-Roadmap) ⭐ 19,630 | 🐛 4 | 📅 2026-01-29 - Roadmap to becoming an ASP.NET Core developer in 2019.

## Starter Kits

* [bitwarden-core](https://github.com/bitwarden/core) ⭐ 19,846 | 🐛 232 | 🌐 C# | 📅 2026-08-15 - The core infrastructure backend (API, database, etc) <https://bitwarden.com>.
...
* Microservices & Service Mesh
  * [eShop](https://github.com/dotnet/eShop) ⭐ 10,775 | 🐛 183 | 🌐 C# | 📅 2026-08-07 - A reference .NET application implementing an eCommerce site.
...
* Monoliths
  * [MusicStore](https://github.com/dotnet/aspnetcore/tree/master/src/MusicStore) ⭐ 38,373 | 🐛 4,122 | 🌐 C# | 📅 2026-08-15 - Sample MusicStore application that uses MVC and Entity Framework.
...
* [awesome-copilot](https://github.com/github/awesome-copilot) ⭐ 37,860 | 🐛 52 | 🌐 Python | 📅 2026-08-14
* Stack Overflow
