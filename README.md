...
* [Finbuckle.MultiTenant](https://github.com/Finbuckle/Finbuckle.MultiTenant) ⭐ 1,618 | 🐛 31 | 🌐 C# | 📅 2026-08-20 - Finbuckle.MultiTenant is a .NET Standard library for multitenant support designed for ASP.NET 2.0+. It provides functionality for tenant resolution, per-tenant app configuration, and per-tenant data isolation.
...
* [BotSharp](https://github.com/SciSharp/BotSharp) ⭐ 3,098 | 🐛 48 | 🌐 C# | 📅 2026-08-21 - The Open Source AI Chatbot Platform Builder in 100% C# Running in .NET Core with Machine Learning algorithm.
...
* [ravendb](https://github.com/ayende/ravendb/tree/v4.0) ⭐ 296 | 🐛 21 | 🌐 C# | 📅 2026-08-24 - Linq enabled document database for .NET.
* [confluent-kafka-dotnet](https://github.com/confluentinc/confluent-kafka-dotnet) ⭐ 268 | 🐛 477 | 🌐 C# | 📅 2026-08-24 - Confluent's Apache Kafka .NET client.
...
* [nopCommerce](https://github.com/nopSolutions/nopCommerce) ⭐ 10,132 | 🐛 166 | 🌐 C# | 📅 2026-08-21 - Free open-source ecommerce shopping cart (ASP.NET MVC / ASP.NET Core MVC ) with a vast community and a market place full of new features, themes and plugins.
...
* [GrandNode](https://github.com/grandnode/grandnode) ⚠️ Archived - Multi-platform, free, open source ecommerce shopping cart based on ASP.NET Core 2.1 and MongoDB derived from [nopCommerce](https://github.com/nopSolutions/nopCommerce) ⭐ 10,132 | 🐛 166 | 🌐 C# | 📅 2026-08-21.
...
* [Sentry](https://github.com/getsentry/sentry-dotnet) ⭐ 770 | 🐛 320 | 🌐 C# | 📅 2026-08-24 - .NET SDK for Sentry, an Open-source error tracking that helps developers monitor and fix crashes in real time.
...
* [SimpleInjector](https://github.com/simpleinjector/SimpleInjector) ⭐ 1,263 | 🐛 31 | 🌐 C# | 📅 2026-08-23 - Easy, flexible, and fast Dependency Injection library that promotes best practice to steer developers towards the pit of success.
...
* [WaveFunctionCollapse](https://github.com/mxgmn/WaveFunctionCollapse) ⭐ 25,288 | 🐛 9 | 🌐 C# | 📅 2026-03-22 - itmap & tilemap generation from a single example with the help of ideas from quantum mechanics.
...
* [quartznet](https://github.com/quartznet/quartznet/) ⭐ 7,068 | 🐛 33 | 🌐 C# | 📅 2026-08-23 - Quartz Enterprise Scheduler .NET <http://www.quartz-scheduler.net>.
* [stateless](https://github.com/dotnet-state-machine/stateless) ⭐ 6,242 | 🐛 81 | 🌐 C# | 📅 2026-04-04 - Simple library for creating state machines in C# code.
...
* [docfx](https://github.com/dotnet/docfx) ⭐ 4,446 | 🐛 451 | 🌐 C# | 📅 2026-08-24 - Tools for building and publishing API documentation for .NET projects <http://dotnet.github.io/docfx>
...
* [Wexflow](https://github.com/aelassas/Wexflow) ⭐ 841 | 🐛 0 | 🌐 C# | 📅 2026-07-17 - A high performance, extensible, modular and cross-platform workflow engine.
