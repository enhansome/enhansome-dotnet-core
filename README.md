...
Inspired by [awesome](https://github.com/sindresorhus/awesome) ⭐ 498,768 | 🐛 105 | 📅 2026-08-21, [awesome-dotnet](https://github.com/quozd/awesome-dotnet) ⭐ 21,565 | 🐛 139 | 📅 2026-03-26,  [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,589 | 🐛 26 | 📅 2026-05-03, [frontend-dev-bookmarks](https://github.com/dypsilon/frontend-dev-bookmarks) ⭐ 47,410 | 🐛 133 | 📅 2024-05-21.

Contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/thangchung/awesome-dotnet-core/blob/master/contributing.md) ⭐ 21,364 | 🐛 212 | 🌐 C# | 📅 2026-02-27 pages first. We accept proprietary and commercial software too.

Thanks to all [contributors](https://github.com/thangchung/awesome-dotnet-core/graphs/contributors) ⭐ 21,364 | 🐛 212 | 🌐 C# | 📅 2026-02-27, you're awesome and wouldn't be possible without you! The goal is to build a categorized community-driven collection of very well-known resources.
...
* [OpenAPI Generator](https://github.com/OpenAPITools/openapi-generator) ⭐ 26,682 | 🐛 5,723 | 🌐 Java | 📅 2026-08-21 - OpenAPI Generator allows generation of API client libraries (e.g. C#, TypeScript, etc), server stubs (ASP.NET Core, NancyFx, etc), documentation and configuration automatically given an OpenAPI Spec (v2, v3).
...
* [Swashbuckle](https://github.com/domaindrivendev/Swashbuckle.AspNetCore) ⭐ 5,498 | 🐛 174 | 🌐 C# | 📅 2026-08-20 - Seamlessly adds a swagger to WebApi projects.
...
* [aspnet-api-versioning](https://github.com/Microsoft/aspnet-api-versioning) ⭐ 3,204 | 🐛 9 | 🌐 C# | 📅 2026-08-21 - set of libraries which add service API versioning to ASP.NET Web API, OData with ASP.NET Web API, and ASP.NET Core.
...
* [grpc](https://github.com/grpc/grpc/tree/master/src/csharp) ⭐ 45,240 | 🐛 1,383 | 🌐 C++ | 📅 2026-08-21 - Remote Procedure Calls (RPCs) provide a useful abstraction for building distributed applications and services. The libraries in this repository provide a concrete implementation of the gRPC protocol, layered over HTTP/2. These libraries enable communication between clients and servers using any combination of the supported languages.
* [ASP.NET MVC](https://github.com/dotnet/aspnetcore/tree/master/src/Mvc) ⭐ 38,390 | 🐛 4,106 | 🌐 C# | 📅 2026-08-22 - Model view controller framework for building dynamic web sites with clean separation of concerns, including the merged MVC, Web API, and Web Pages w/ Razor.
* [Abp vNext](https://github.com/abpframework/abp) ⭐ 14,411 | 🐛 321 | 🌐 C# | 📅 2026-08-21 - Abp vNext is the next generation of the open source [ASP.NET Boilerplate](https://github.com/aspnetboilerplate/aspnetboilerplate) ⭐ 12,001 | 🐛 63 | 🌐 C# | 📅 2026-08-20 framework. It's a complete architecture and strong infrastructure to create modern web applications!
...
* [orleans](https://github.com/dotnet/orleans) ⭐ 10,842 | 🐛 666 | 🌐 C# | 📅 2026-08-21 - Framework that provides a straight-forward approach to building distributed high-scale computing applications, without the need to learn and apply complex concurrency or other scaling patterns.
* [fission](https://github.com/fission/fission) ⭐ 8,910 | 🐛 49 | 🌐 Go | 📅 2026-08-22 - Fast Serverless Functions for Kubernetes.
* [MassTransit](https://github.com/MassTransit/MassTransit) ⭐ 7,798 | 🐛 1 | 🌐 C# | 📅 2026-06-04 - Distributed Application Framework for .NET.
* [ElectronNET](https://github.com/ElectronNET/Electron.NET) ⭐ 7,604 | 🐛 21 | 🌐 C# | 📅 2026-08-14 - Build cross platform desktop apps with ASP.NET NET Core.
...
* [opencvsharp](https://github.com/shimat/opencvsharp) ⭐ 6,071 | 🐛 8 | 🌐 C# | 📅 2026-08-21 - .NET Framework wrapper for OpenCV.
* [ServiceStack](https://github.com/ServiceStack/ServiceStack) ⭐ 5,499 | 🐛 35 | 🌐 C# | 📅 2026-08-22 - Thoughtfully architected, obscenely fast, thoroughly enjoyable web services for all <https://servicestack.net>.
...
* [ExcelDataReader](https://github.com/ExcelDataReader/ExcelDataReader) ⭐ 4,406 | 🐛 34 | 🌐 C# | 📅 2026-07-06 - Lightweight and fast library written in C# for reading Microsoft Excel files.
...
* [dotvvm](https://github.com/riganti/dotvvm) ⭐ 806 | 🐛 161 | 🌐 C# | 📅 2026-08-21 - Open source MVVM framework for Web Apps.
...
* [Halibut](https://github.com/OctopusDeploy/Halibut) ⭐ 24 | 🐛 52 | 🌐 C# | 📅 2026-08-21 - A secure communication stack for .NET using JSON-RPC over SSL.
...
* [CleanArchitecture (SPA)](https://github.com/JasonGT/CleanArchitecture) ⭐ 20,474 | 🐛 20 | 🌐 C# | 📅 2026-08-21 - Solution template for creating a Single Page App (SPA) with Angular 8 and ASP.NET Core 3 following the principles of Clean Architecture
* [CleanArchitecture](https://github.com/ardalis/CleanArchitecture) ⭐ 18,419 | 🐛 42 | 🌐 C# | 📅 2026-08-21 - A starting point for Clean Architecture with ASP.NET Core. Clean Architecture is just the latest in a series of names for the same loosely-coupled, dependency-inverted architecture. You will also find it named hexagonal, ports-and-adapters, or onion architecture.
* [.NET Boxed](https://github.com/Dotnet-Boxed/Templates) ⭐ 3,486 | 🐛 51 | 🌐 C# | 📅 2026-08-11 - Project templates with batteries included, providing the minimum amount of code required to get you going. Includes ASP.NET Core API and GraphQL Templates.
* [JavaScriptServices](https://github.com/aspnet/JavaScriptServices) ⚠️ Archived - Microsoft ASP.NET Core JavaScript Services.
* [Serenity](https://github.com/volkanceylan/Serenity) ⭐ 2,693 | 🐛 0 | 🌐 C# | 📅 2026-08-21 - Serenity is an ASP.NET MVC / TypeScript application platform designed to simplify and shorten development of data-centric business applications with a service based architecture.
* [kendo-ui-core](https://github.com/telerik/kendo-ui-core) ⭐ 2,583 | 🐛 696 | 🌐 JavaScript | 📅 2026-08-21 - An HTML5, jQuery-based widget library for building modern web apps. <http://www.telerik.com/kendo-ui>.
...
* [openiddict](https://github.com/openiddict/openiddict-core) ⭐ 5,234 | 🐛 6 | 🌐 C# | 📅 2026-08-14 - Easy-to-use OpenID Connect server for ASP.NET Core.
...
* [Auth0](https://github.com/auth0/auth0.net) ⭐ 361 | 🐛 9 | 🌐 C# | 📅 2026-08-19 - Hosted, enterprise-grade platform for modern identity.
...
* [BTCPayServer](https://github.com/btcpayserver/btcpayserver) ⭐ 7,715 | 🐛 85 | 🌐 C# | 📅 2026-08-07 - A cross platform, self-hosted server compatible with Bitpay API.
* [NEO](https://github.com/neo-project/neo) ⭐ 3,535 | 🐛 259 | 🌐 C# | 📅 2026-08-09 - Open Network For Smart Economy.
* [WalletWasabi](https://github.com/zkSNACKs/WalletWasabi) ⭐ 2,604 | 🐛 358 | 🌐 C# | 📅 2026-08-21 - Privacy focused, ZeroLink compliant Bitcoin wallet.
* [NBitcoin](https://github.com/MetacoSA/NBitcoin) ⭐ 1,941 | 🐛 116 | 🌐 C# | 📅 2026-08-12 - Comprehensive Bitcoin library for the .NET framework.
* [Nethermind](https://github.com/NethermindEth/nethermind) ⭐ 1,585 | 🐛 398 | 🌐 C# | 📅 2026-08-22 - .NET Core Ethereum client
...
* [Telegram.Bot](https://github.com/TelegramBots/Telegram.Bot) ⭐ 3,643 | 🐛 0 | 🌐 C# | 📅 2026-08-02 - C# Telegram Bot API library.
* [BotSharp](https://github.com/SciSharp/BotSharp) ⭐ 3,097 | 🐛 48 | 🌐 C# | 📅 2026-08-21 - The Open Source AI Chatbot Platform Builder in 100% C# Running in .NET Core with Machine Learning algorithm.
...
* [msbuild](https://github.com/Microsoft/msbuild) ⭐ 5,543 | 🐛 1,670 | 🌐 C# | 📅 2026-08-21 - The Microsoft Build Engine is a platform for building applications.
...
* [vsts-agent](https://github.com/Microsoft/vsts-agent/blob/master/README.md) ⭐ 1,909 | 🐛 220 | 🌐 C# | 📅 2026-08-21 - Visual Studio Team Services Build and Release Agent.
* [GitVersioning](https://github.com/AArnott/Nerdbank.GitVersioning) ⭐ 1,583 | 🐛 9 | 🌐 C# | 📅 2026-08-21 - Stamp your assemblies and NuGet packages with a version from a single, simple version.txt file and include git commit IDs for non-official builds.
...
* [GitInfo](https://github.com/kzu/GitInfo) ⭐ 650 | 🐛 2 | 🌐 Pascal | 📅 2026-08-21 - Git and SemVer Info from MSBuild, C# and VB.
...
* [Stack Exchange Redis](https://github.com/StackExchange/StackExchange.Redis) ⭐ 6,194 | 🐛 220 | 🌐 C# | 📅 2026-08-21 - High performance general purpose redis client for .NET languages (C# etc).
...
* [Orchard Core CMS](https://github.com/OrchardCMS/OrchardCore) ⭐ 8,161 | 🐛 847 | 🌐 C# | 📅 2026-08-22 - Open Source Content Management System built with ASP.NET Core on top of a Modular and Extensible Application Framework.
* [Umbraco](https://github.com/umbraco/umbraco-cms) ⭐ 5,228 | 🐛 497 | 🌐 C# | 📅 2026-08-21 - An extensible and friendly Open source ASP.NET Core CMS
...
* [Miniblog](https://github.com/madskristensen/Miniblog.Core) ⭐ 1,521 | 🐛 63 | 🌐 C# | 📅 2026-01-19 - An ASP.NET Core blogging engine.
...
* [awesome-static-analysis](https://github.com/mre/awesome-static-analysis) ⭐ 14,744 | 🐛 27 | 🌐 Rust | 📅 2026-06-10 - Curated list of static analysis tools, linters and code quality checkers for various programming languages.
* Code Analysis
  ...
  * [roslyn-analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,672 | 🐛 1,063 | 📅 2026-08-21 - .NET Compiler Platform ("Roslyn") Analyzers.
...
* Metrics
  * [BenchmarkDotNet](https://github.com/dotnet/BenchmarkDotNet) ⭐ 11,479 | 🐛 174 | 🌐 C# | 📅 2026-08-16 - Powerful .NET library for benchmarking.
  * [coverlet](https://github.com/tonerdo/coverlet) ⭐ 3,173 | 🐛 15 | 🌐 C# | 📅 2026-08-08 - Cross platform code coverage library for .NET Core.
...
* [sharpcompress](https://github.com/adamhathcock/sharpcompress) ⭐ 2,578 | 🐛 294 | 🌐 C# | 📅 2026-08-20 - Fully managed C# library to deal with many compression types and formats.
* [lz4net](https://github.com/MiloszKrajewski/K4os.Compression.LZ4) ⭐ 813 | 🐛 17 | 🌐 C# | 📅 2026-03-28 - Ultra fast compression algorithm for all .NET platforms.

### Compilers, Transpilers and Languages

* [roslyn](https://github.com/dotnet/roslyn) ⭐ 20,617 | 🐛 6,290 | 🌐 C# | 📅 2026-08-22 - The .NET Compiler Platform ("Roslyn") provides open-source C# and Visual Basic compilers with rich code analysis APIs.
* [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,144 | 🐛 169 | 🌐 F# | 📅 2026-08-19 - F# to JavaScript Compiler.
...
* [LiteDB](https://github.com/mbdavid/LiteDB) ⭐ 9,458 | 🐛 758 | 🌐 C# | 📅 2026-08-21 - .NET NoSQL Document Store in a single data file - <http://www.litedb.org>.
* [marten](https://github.com/JasperFx/marten) ⭐ 3,445 | 🐛 3 | 🌐 C# | 📅 2026-08-21 - Postgresql as a Document Database and Event Store for .NET Applications <http://jasperfx.github.io/marten>.
* [yessql](https://github.com/sebastienros/yessql) ⭐ 1,358 | 🐛 150 | 🌐 C# | 📅 2026-08-17 - .NET document database working on any RDBMS.
...
* [ravendb](https://github.com/ayende/ravendb/tree/v4.0) ⭐ 296 | 🐛 21 | 🌐 C# | 📅 2026-08-22 - Linq enabled document database for .NET.
* [confluent-kafka-dotnet](https://github.com/confluentinc/confluent-kafka-dotnet) ⭐ 268 | 🐛 477 | 🌐 C# | 📅 2026-08-21 - Confluent's Apache Kafka .NET client.
...
* [Mongo.Migration](https://github.com/SRoddis/Mongo.Migration) ⭐ 183 | 🐛 34 | 🌐 C# | 📅 2026-03-18 - Mongo.Migration is designed for the [MongoDB C# Driver](https://github.com/mongodb/mongo-csharp-driver) ⭐ 3,241 | 🐛 14 | 🌐 C# | 📅 2026-08-20 to migrate your documents easily and on-the-fly. No more downtime for schema-migrations. Just write small and simple migrations. [Link](https://github.com/SRoddis/Mongo.Migration) ⭐ 183 | 🐛 34 | 🌐 C# | 📅 2026-03-18
...
* [FluentDateTime](https://github.com/FluentDateTime/FluentDateTime) ⭐ 697 | 🐛 1 | 🌐 C# | 📅 2026-08-21 - Allows you to write cleaner DateTime expressions and operation. Partially inspired by Ruby DateTime Extensions.
...
* [Polly](https://github.com/App-vNext/Polly) ⭐ 14,230 | 🐛 5 | 🌐 C# | 📅 2026-08-21 - .NET 3.5 / 4.0 / 4.5 / PCL library that allows developers to express transient exception and fault handling policies such as Retry, Retry Forever, Wait and Retry or Circuit Breaker in a fluent manner
...
* [nopCommerce](https://github.com/nopSolutions/nopCommerce) ⭐ 10,130 | 🐛 165 | 🌐 C# | 📅 2026-08-21 - Free open-source ecommerce shopping cart (ASP.NET MVC / ASP.NET Core MVC ) with a vast community and a market place full of new features, themes and plugins.
...
* [GrandNode](https://github.com/grandnode/grandnode) ⚠️ Archived - Multi-platform, free, open source ecommerce shopping cart based on ASP.NET Core 2.1 and MongoDB derived from [nopCommerce](https://github.com/nopSolutions/nopCommerce) ⭐ 10,130 | 🐛 165 | 🌐 C# | 📅 2026-08-21.
...
* [Sentry](https://github.com/getsentry/sentry-dotnet) ⭐ 770 | 🐛 320 | 🌐 C# | 📅 2026-08-21 - .NET SDK for Sentry, an Open-source error tracking that helps developers monitor and fix crashes in real time.
...
* [ImageSharp](https://github.com/SixLabors/ImageSharp) ⭐ 8,033 | 🐛 19 | 🌐 C# | 📅 2026-08-22 - Cross-platform library for processing of image files written in C#.
* [QRCoder](https://github.com/codebude/QRCoder) ⭐ 5,152 | 🐛 29 | 🌐 C# | 📅 2026-07-23 - A pure C# Open Source QR Code implementation.
* [Magick.NET](https://github.com/dlemstra/Magick.NET) ⭐ 3,972 | 🐛 53 | 🌐 C# | 📅 2026-08-20 - The .NET library for ImageMagick.
...
* [Avalonia](https://github.com/AvaloniaUI/Avalonia) ⭐ 31,367 | 🐛 1,926 | 🌐 C# | 📅 2026-08-21 - A multi-platform .NET UI framework (formerly known as Perspex).
...
* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 189,216 | 🐛 20,112 | 🌐 TypeScript | 📅 2026-08-22 - New type of tool that combines the simplicity of a code editor with what developers need for their core edit-build-debug cycle. Code provides comprehensive editing and debugging support, an extensibility model, and lightweight integration with existing tools.
...
* [SimpleInjector](https://github.com/simpleinjector/SimpleInjector) ⭐ 1,263 | 🐛 31 | 🌐 C# | 📅 2026-07-02 - Easy, flexible, and fast Dependency Injection library that promotes best practice to steer developers towards the pit of success.
...
* [NLog](https://github.com/NLog/NLog) ⭐ 6,546 | 🐛 53 | 🌐 C# | 📅 2026-08-20 - Advanced .NET, Silverlight and Xamarin Logging with support for structured and non structured logging.
...
* [log4net](https://github.com/apache/logging-log4net) ⭐ 933 | 🐛 4 | 🌐 C# | 📅 2026-08-21 - log4net is a port of the excellent Apache log4j™ framework to the Microsoft® .NET runtime.
...
* [WaveFunctionCollapse](https://github.com/mxgmn/WaveFunctionCollapse) ⭐ 25,285 | 🐛 9 | 🌐 C# | 📅 2026-03-22 - itmap & tilemap generation from a single example with the help of ideas from quantum mechanics.
* [ML.NET](https://github.com/dotnet/machinelearning) ⭐ 9,349 | 🐛 1,009 | 🌐 C# | 📅 2026-08-17 - Cross-platform open-source machine learning framework which makes machine learning accessible to .NET developers <http://dot.net/ml>.
...
* [Papercut](https://github.com/ChangemakerStudios/Papercut) ⭐ 3,324 | 🐛 4 | 🌐 C# | 📅 2026-08-22 - Simple Desktop SMTP Server
...
* [AutoMapper](https://github.com/AutoMapper/AutoMapper) ⭐ 10,191 | 🐛 5 | 🌐 C# | 📅 2026-07-02 - Convention-based object-object mapper in .NET.
...
* [AngleSharp](https://github.com/AngleSharp/AngleSharp) ⭐ 5,529 | 🐛 7 | 🌐 C# | 📅 2026-08-21 - The ultimate angle brackets parser library. It parses HTML5, MathML, SVG and CSS to construct a DOM based on the official W3C specification. Comparable to beautifulsoup4 of python.
* [markdig](https://github.com/lunet-io/markdig) ⭐ 5,303 | 🐛 115 | 🌐 C# | 📅 2026-08-18 - Fast, powerfull, CommonMark compliant, extensible Markdown processor for .NET.
...
* [PuppeteerSharp](https://github.com/kblok/puppeteer-sharp) ⭐ 3,912 | 🐛 11 | 🌐 C# | 📅 2026-08-17 - Puppeteer Sharp is a .NET port of the official Node.JS Puppeteer API.
...
* [Downloader](https://github.com/bezzad/Downloader) ⭐ 1,704 | 🐛 0 | 🌐 C# | 📅 2026-08-16 - Downloader is a modern, fluent, asynchronous, testable and portable library for .NET. This is a multipart downloader with asynchronous progress events.
...
* [FastExpressionCompiler](https://github.com/dadhi/FastExpressionCompiler) ⭐ 1,372 | 🐛 23 | 🌐 C# | 📅 2026-08-19 - Fast ExpressionTree compiler to delegate.
...
* [CoordinateSharp](https://github.com/Tronald/CoordinateSharp) ⭐ 380 | 🐛 2 | 🌐 C# | 📅 2026-01-16 - A library that can quickly format and convert geographic coordinates as well as provide location based sun and moon information (sunset, sunrise, moon illumination, etc...).
...
* [EPPlus](https://github.com/EPPlusSoftware/EPPlus) ⭐ 2,030 | 🐛 89 | 🌐 C# | 📅 2026-08-21 - Create advanced Excel spreadsheets using .NET.
...
* [CosmosOS](https://github.com/CosmosOS/Cosmos) ⭐ 3,184 | 🐛 138 | 🌐 C# | 📅 2026-08-13 - Cosmos is an operating system "construction kit". Build your own OS using managed languages such as C#, VB.NET, and more!

### ORM

* [Dapper](https://github.com/StackExchange/Dapper) ⭐ 18,368 | 🐛 546 | 🌐 C# | 📅 2026-08-20 - Simple object mapper for .NET.
...
* [Entity Framework Core](https://github.com/aspnet/EntityFramework) ⭐ 14,773 | 🐛 2,370 | 🌐 C# | 📅 2026-08-22 - Familiar developer experience to previous versions of EF, including LINQ, POCO, and Code First support.
  ...
  * [EntityFramework-Plus](https://github.com/zzzprojects/EntityFramework-Plus) ⭐ 2,343 | 🐛 139 | 🌐 C# | 📅 2026-08-18 - Entity Framework Utilities | Bulk Operations | Batch Delete | Batch Update | Query Cache | Query Filter | Query Future | Query Include | Audit.
  ...
  * [LINQKit](https://github.com/scottksmith95/LINQKit) ⭐ 1,830 | 🐛 48 | 🌐 C# | 📅 2026-02-07 - A free set of extensions for LINQ to SQL and Entity Framework power users.
...
* [querybuilder](https://github.com/sqlkata/querybuilder) ⭐ 3,378 | 🐛 180 | 🌐 C# | 📅 2026-04-10 - SqlKata Query Builder is a powerful Sql Query Builder written in C#.
...
* [SqlKata](https://github.com/sqlkata/querybuilder) ⭐ 3,378 | 🐛 180 | 🌐 C# | 📅 2026-04-10 - Elegant Sql Query Builder, that supports complex queries, joins, sub queries, nested where conditions, vendor engine targets and more

### Queue and Messaging

* [MediatR](https://github.com/jbogard/MediatR) ⭐ 11,854 | 🐛 2 | 🌐 C# | 📅 2026-07-02 - Simple, unambitious mediator implementation in .NET.
* [EventStore](https://github.com/EventStore/EventStore) ⭐ 5,847 | 🐛 149 | 🌐 C# | 📅 2026-08-22 - The open-source, functional database with Complex Event Processing in JavaScript.
...
* [NServiceBus](https://github.com/particular/nservicebus) ⭐ 2,168 | 🐛 288 | 🌐 C# | 📅 2026-08-20 - NServiceBus is part of the [Particular Service Platform](https://particular.net/service-platform), which contains tools to build, monitor, and debug distributed systems.
...
* [HangfireIO](https://github.com/HangfireIO/Hangfire) ⭐ 10,125 | 🐛 945 | 🌐 C# | 📅 2026-07-20 - Easy way to perform fire-and-forget, delayed and recurring tasks inside ASP.NET apps <http://hangfire.io>.
* [quartznet](https://github.com/quartznet/quartznet/) ⭐ 7,069 | 🐛 23 | 🌐 C# | 📅 2026-08-22 - Quartz Enterprise Scheduler .NET <http://www.quartz-scheduler.net>.
...
* [AWS SDK](https://github.com/aws/aws-sdk-net) ⭐ 134 | 🐛 33 | 🌐 C# | 📅 2026-08-21 - The Amazon Web Services (AWS) .NET Core SDK components. Each AWS service has its own NuGet package.
...
* [CsvHelper](https://github.com/JoshClose/CsvHelper) ⭐ 5,209 | 🐛 353 | 🌐 C# | 📅 2025-06-27 - Library to help reading and writing CSV files.
* [protobuf-net](https://github.com/mgravell/protobuf-net/) ⭐ 4,969 | 🐛 538 | 🌐 C# | 📅 2026-08-22 - Protocol Buffers library for idiomatic .NET.
...
* [TinyCsvParser](https://github.com/bytefish/TinyCsvParser) ⭐ 405 | 🐛 0 | 🌐 C# | 📅 2026-07-16 - Easy to use, easy to extend and high-performance library for CSV parsing with .NET.
...
* MessagePack
  * [MessagePack-CSharp](https://github.com/neuecc/MessagePack-CSharp) ⭐ 6,772 | 🐛 146 | 🌐 C# | 📅 2026-08-20 - Extremely Fast MessagePack Serializer for C#(.NET, .NET Core, Unity, Xamarin).
...
* [fluid](https://github.com/sebastienros/fluid) ⭐ 1,771 | 🐛 31 | 🌐 C# | 📅 2026-08-21 - Open-source .NET template engine that is as close as possible to the Liquid template language.
...
* [Bogus](https://github.com/bchavez/Bogus) ⭐ 9,728 | 🐛 91 | 🌐 C# | 📅 2025-12-22 - Simple and sane fake data generator for C#. Based on and ported from the famed faker.js.
* [moq.netcore](https://github.com/Moq/moq4) ⭐ 6,402 | 🐛 20 | 🌐 C# | 📅 2026-08-21 - Most popular and friendly mocking framework for .NET.
* [xUnit.net](https://github.com/xunit/xunit) ⭐ 4,599 | 🐛 42 | 🌐 C# | 📅 2026-08-21 - A free, open source, community-focused unit testing tool for the .NET Framework.
* [FluentAssertions](https://github.com/fluentassertions/fluentassertions) ⭐ 3,816 | 🐛 69 | 🌐 C# | 📅 2026-08-21 - Set of .NET extension methods that allow you to more naturally specify the expected outcome of a TDD or BDD-style test.
* [shouldly](https://github.com/shouldly/shouldly) ⭐ 3,406 | 🐛 93 | 🌐 C# | 📅 2026-08-21 - Should testing for .NET - the way Asserting *Should* be! <http://shouldly.readthedocs.org/en/latest>
* [NSubstitute](https://github.com/nsubstitute/NSubstitute) ⭐ 2,969 | 🐛 110 | 🌐 C# | 📅 2026-08-17 - A friendly substitute for .NET mocking frameworks.
...
* [ShareX](https://github.com/ShareX/ShareX) ⭐ 39,238 | 🐛 662 | 🌐 C# | 📅 2026-08-22 - Free and open source program that lets you capture or record any area of your screen and share it with a single press of a key. It also allows uploading images, text or other types of files to over 80 supported destinations you can choose from. <https://getsharex.com>

* [scoop](https://github.com/lukesampson/scoop) ⭐ 24,576 | 🐛 538 | 🌐 PowerShell | 📅 2026-08-21 - A command-line installer for Windows.

* [mRemoteNG](https://github.com/mRemoteNG/mRemoteNG) ⭐ 11,064 | 🐛 864 | 🌐 C# | 📅 2026-08-21 - The next generation of mRemote, open source, tabbed, multi-protocol, remote connections manager

* [gitignore.io](https://github.com/joeblau/gitignore.io) ⭐ 8,735 | 🐛 68 | 🌐 Swift | 📅 2024-12-23 - Create useful .gitignore files for your project <https://www.gitignore.io>.

* [letsencrypt-win-simple](https://github.com/Lone-Coder/letsencrypt-win-simple) ⭐ 5,782 | 🐛 44 | 🌐 C# | 📅 2026-06-09 - A Simple ACME Client for Windows.
...
* [docfx](https://github.com/dotnet/docfx) ⭐ 4,446 | 🐛 451 | 🌐 C# | 📅 2026-08-21 - Tools for building and publishing API documentation for .NET projects <http://dotnet.github.io/docfx>

* [SharpZipLib](https://github.com/icsharpcode/SharpZipLib) ⭐ 3,927 | 🐛 118 | 🌐 C# | 📅 2024-09-03 - #ziplib is a Zip, GZip, Tar and BZip2 library written entirely in C# for the .NET platform.

* [System.CommandLine](https://github.com/dotnet/command-line-api) ⭐ 3,672 | 🐛 482 | 🌐 C# | 📅 2026-08-22 - System.CommandLine, a set of libraries for command line parsing, invocation, and rendering of terminal output.
...
* [sourcelink](https://github.com/dotnet/sourcelink) ⭐ 1,349 | 🐛 143 | 🌐 C# | 📅 2026-08-22 - SourceLink is a language- and source-control agnostic system for providing first-class source debugging experiences for binaries.
...
* WebAssembly
  * [Blazor](https://github.com/SteveSanderson/Blazor) ⭐ 1,677 | 🐛 7 | 🌐 C# | 📅 2018-02-23 - UI framework running .NET in the browser via WebAssembly.
    * [Awesome Blazor](https://github.com/AdrienTorris/awesome-blazor) ⭐ 9,371 | 🐛 96 | 📅 2026-07-25 - Collection of awesome resources (samples, components, articles, videos and others) about Blazor.
...
* [workflow-core](https://github.com/danielgerlag/workflow-core) ⭐ 5,916 | 🐛 217 | 🌐 C# | 📅 2026-08-22 - Lightweight workflow engine for .NET Standard.
...
* [bitwarden-core](https://github.com/bitwarden/core) ⭐ 19,911 | 🐛 220 | 🌐 C# | 📅 2026-08-21 - The core infrastructure backend (API, database, etc) <https://bitwarden.com>.
...
* Microservices & Service Mesh
  * [eShop](https://github.com/dotnet/eShop) ⭐ 10,788 | 🐛 186 | 🌐 C# | 📅 2026-08-18 - A reference .NET application implementing an eCommerce site.
...
* Monoliths
  * [MusicStore](https://github.com/dotnet/aspnetcore/tree/master/src/MusicStore) ⭐ 38,390 | 🐛 4,106 | 🌐 C# | 📅 2026-08-22 - Sample MusicStore application that uses MVC and Entity Framework.
...
* [awesome-copilot](https://github.com/github/awesome-copilot) ⭐ 38,112 | 🐛 76 | 🌐 Python | 📅 2026-08-21
* Stack Overflow
